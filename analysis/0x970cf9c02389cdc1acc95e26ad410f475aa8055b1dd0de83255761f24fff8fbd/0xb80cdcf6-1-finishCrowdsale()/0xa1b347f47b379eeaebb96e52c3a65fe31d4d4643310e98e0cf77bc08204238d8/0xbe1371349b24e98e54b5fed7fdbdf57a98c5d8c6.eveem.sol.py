...
#  addr = 0xBe1371349b24e98e54B5fEd7FdbdF57A98c5D8C6 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
# const = None
# payable = False
def unknown38d5630b(addr m_param1): # not payable
  ...
  if mstor259m[call.data[0 len calldata.size]m]m.field_256 and 2^mstor258m[callerm] != 0:
      return 0
