...
#  addr = 0xF0bb66DcDe19eb86dCb8eDdf857C10B137B6dBbb 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def unknown2e0e0349(addr m_param1): # not payable
  require caller == mstor0
  if mgameIDs_m[addr(m_param1)m]:
      revert with 0, 'game already registed'
  mstor5++
  mgameIDs_m[addr(m_param1)m] = mstor5 + 1
...
# const = None
# payable = False
def gameIDs_(address m_param1): # not payable
  return mgameIDs_m[m_param1m]
