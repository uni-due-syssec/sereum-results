...
#  addr = 0x3f26697b245b139306aD1c53AABFeC3159dCdBCF 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def unknown07b08870(uint256 m_param1): # not payable
  ...
  return addr(munknown07b08870m[m_param1m]m.field_0)
...
def unknown3c98d189(uint256 m_param1, array m_param2, array m_param3, array m_param4): # not payable
  ...
  if caller == mowner:
      require munknownd92cb69a <= 2
      require not munknownd92cb69a
      [94midx = 0
      mwhile [94midx < m_param2.lengthm:
          require [94midx < m_param2.length
          mem[0] = mem[(32 * [94midx) + 140 len 20]
          mem[32] = 23
          if mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
          ...
          require [94midx < m_param3.length
          [94m_368 = mem[(32 * [94midx) + (32 * m_param2.length) + 160]
          require [94midx < mem[(32 * m_param3.length) + (32 * m_param2.length) + 160]
          [94m_375 = mem[(32 * [94midx) + (32 * m_param3.length) + (32 * m_param2.length) + 192]
          mem[0] = 'RiskProvider'
          mem[32] = 4
          ...
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 292] = [94m_368
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 324] = [94m_375
          require ext_code.size(munknown2156e6c6m['RiskProvider'm])
          call munknown2156e6c6m['RiskProvider'm].hasRisk(address sender, address receiver, address tokenAddress, uint256 amount, uint256 rate) with:
               gas gas_remaining wei
              args addr(this.address), munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m], 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, [94m_368, [94m_375
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = ext_call.return_data[0]
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
      ...
      if ext_call.return_data[0]:
          ...
          mwhile [94midx < m_param2.lengthm:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  mem[0] = addr([94m_1371)
                  mem[32] = 21
                  mamountsm[addr([94m_1371)m] = ext_call.return_data[0]
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1371)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1371)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1371)
                          mem[0] = addr([94m_1371)
                          mem[32] = 22
                          mstor22m[addr([94m_1371)m] = 1
              [94midx = [94midx + 1
              mcontinue 
          return 1
      ...
      if not m_param2.length:
          ...
          require return_data.size >= 32
          [94m_1374 = mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0
          ...
          [94midx = 0
          mwhile [94midx < m_param2.lengthm:
              require [94midx < mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1374 + 224]
              if mem[(32 * [94midx) + (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1374 + 256] > 0:
                  require [94midx < mem[96]
                  mem[0] = mem[(32 * [94midx) + 140 len 20]
                  mem[32] = 23
                  if not mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
                      require [94midx < mem[96]
                      mstor23m[mem[(32 * [94midx) + 140 len 20]m] = 1
                      require [94midx < mem[96]
                      mem[0] = mem[(32 * [94midx) + 140 len 20]
                      mem[32] = 21
                      if mamountsm[mem[(32 * [94midx) + 140 len 20]m] > 0:
                          ...
                          mem[0] = 24
                          addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = mem[(32 * [94midx) + 140 len 20]
                          require [94midx < mem[96]
          ...
          mwhile [94midx < [94m_1687m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  mem[0] = addr([94m_1703)
                  mem[32] = 21
                  mamountsm[addr([94m_1703)m] = ext_call.return_data[0]
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1703)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1703)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1703)
                          mem[0] = addr([94m_1703)
                          mem[32] = 22
                          mstor22m[addr([94m_1703)m] = 1
              [94midx = [94midx + 1
              mcontinue 
      else:
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 224 len 32 * m_param2.length] = code.data[24526 len 32 * m_param2.length]
          mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
          mem[32] = 4
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224] = 0x674f23ba00000000000000000000000000000000000000000000000000000000
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 228] = 32
          ...
          mem[64] = (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + ceil32(return_data.size) + 224
          require return_data.size >= 32
          [94m_1375 = mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 <= 4294967296
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 32 <= return_data.size
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 224] <= 4294967296 and mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + (32 * mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 224]) + 32 <= return_data.size
          [94midx = 0
          mwhile [94midx < m_param2.lengthm:
              require [94midx < mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1375 + 224]
              if mem[(32 * [94midx) + (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1375 + 256] > 0:
                  require [94midx < mem[96]
                  mem[0] = mem[(32 * [94midx) + 140 len 20]
                  mem[32] = 23
                  if not mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
          ...
          mwhile [94midx < [94m_1688m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  mem[0] = addr([94m_1706)
                  mem[32] = 21
                  mamountsm[addr([94m_1706)m] = ext_call.return_data[0]
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1706)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1706)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1706)
                          mem[0] = addr([94m_1706)
                          mem[32] = 22
                          mstor22m[addr([94m_1706)m] = 1
              [94midx = [94midx + 1
              mcontinue 
  else:
      ...
      mwhile [94midx < m_param2.lengthm:
          ...
          require ext_call.return_data[0] <= 18
          require [94midx < m_param3.length
          [94m_373 = mem[(32 * [94midx) + (32 * m_param2.length) + 160]
          require [94midx < mem[(32 * m_param3.length) + (32 * m_param2.length) + 160]
          [94m_376 = mem[(32 * [94midx) + (32 * m_param3.length) + (32 * m_param2.length) + 192]
          mem[0] = 'RiskProvider'
          mem[32] = 4
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 196] = this.address
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 228] = munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m]
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 260] = 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 292] = [94m_373
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 324] = [94m_376
          require ext_code.size(munknown2156e6c6m['RiskProvider'm])
          call munknown2156e6c6m['RiskProvider'm].hasRisk(address sender, address receiver, address tokenAddress, uint256 amount, uint256 rate) with:
               gas gas_remaining wei
              args addr(this.address), munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m], 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, [94m_373, [94m_376
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = ext_call.return_data[0]
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
      ...
      if ext_call.return_data[0]:
          ...
          mwhile [94midx < m_param2.lengthm:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  mem[0] = addr([94m_1376)
                  mem[32] = 21
                  mamountsm[addr([94m_1376)m] = ext_call.return_data[0]
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1376)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1376)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1376)
                          mem[0] = addr([94m_1376)
                          mem[32] = 22
                          mstor22m[addr([94m_1376)m] = 1
              [94midx = [94midx + 1
              mcontinue 
          return 1
      mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = m_param2.length
      if not m_param2.length:
          ...
          mem[64] = (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + ceil32(return_data.size) + 224
          require return_data.size >= 32
          [94m_1379 = mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 <= 4294967296
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 32 <= return_data.size
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 224] <= 4294967296 and mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + (32 * mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 224]) + 32 <= return_data.size
          [94midx = 0
          mwhile [94midx < m_param2.lengthm:
              require [94midx < mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1379 + 224]
              if mem[(32 * [94midx) + (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1379 + 256] > 0:
                  require [94midx < mem[96]
                  mem[0] = mem[(32 * [94midx) + 140 len 20]
                  mem[32] = 23
                  if not mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
          ...
          mwhile [94midx < [94m_1689m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  mem[0] = addr([94m_1709)
                  mem[32] = 21
                  mamountsm[addr([94m_1709)m] = ext_call.return_data[0]
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1709)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1709)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1709)
                          mem[0] = addr([94m_1709)
                          mem[32] = 22
                          mstor22m[addr([94m_1709)m] = 1
              [94midx = [94midx + 1
              mcontinue 
      else:
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 224 len 32 * m_param2.length] = code.data[24526 len 32 * m_param2.length]
          ...
          mem[64] = (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + ceil32(return_data.size) + 224
          require return_data.size >= 32
          [94m_1380 = mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 <= 4294967296
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 32 <= return_data.size
          require mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 224] <= 4294967296 and mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + (32 * mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224 len 4], 0 + 224]) + 32 <= return_data.size
          [94midx = 0
          mwhile [94midx < m_param2.lengthm:
              require [94midx < mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1380 + 224]
              if mem[(32 * [94midx) + (32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + [94m_1380 + 256] > 0:
                  require [94midx < mem[96]
                  mem[0] = mem[(32 * [94midx) + 140 len 20]
                  mem[32] = 23
                  if not mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
          ...
          mwhile [94midx < [94m_1690m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  mem[0] = addr([94m_1712)
                  mem[32] = 21
                  mamountsm[addr([94m_1712)m] = ext_call.return_data[0]
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1712)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1712)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1712)
                          mem[0] = addr([94m_1712)
                          mem[32] = 22
                          mstor22m[addr([94m_1712)m] = 1
              [94midx = [94midx + 1
              mcontinue 
  return 0
...
def tokens(uint256 m_param1): # not payable
  ...
  return addr(mtokensm[m_param1m]m.field_0)
...
def tokensWithAmount(): # not payable
  ...
  mwhile [94midx < mtokensm.lengthm:
      mem[0] = addr(mtokensm[[94midxm]m.field_0)
      mem[32] = 23
      if mstor23m[addr(mstor9m[[94midxm]m.field_0)m]:
          [94midx = [94midx + 1
          [94ms = [94ms
          mcontinue 
      ...
      mem[0] = addr(mtokensm[[94midxm]m.field_0)
      mem[32] = 21
      if mamountsm[addr(mstor9m[[94midxm]m.field_0)m] <= 0:
          [94midx = [94midx + 1
          [94ms = [94ms
          mcontinue 
      [94midx = [94midx + 1
      ...
      mcontinue 
  if [94ms:
      mem[128 len 32 * [94ms] = code.data[24526 len 32 * [94ms]
  [94midx = 0
  [94mt = 0
  mwhile [94midx < mtokensm.lengthm:
      mem[0] = addr(mtokensm[[94midxm]m.field_0)
      ...
      mem[0] = 9
      require [94mt < [94ms
      mem[(32 * [94mt) + 128] = addr(mtokensm[[94midxm]m.field_0)
      [94midx = [94midx + 1
      [94mt = [94mt + 1
      mcontinue 
  ...
  if caller == mowner:
      ...
      mwhile [94midx < m_param2.lengthm:
          ...
          if mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
              ...
              require [94midx < m_param3.length
              [94m_414 = mem[(32 * [94midx) + (32 * m_param2.length) + 160]
              mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
              mem[32] = 4
              require ext_code.size(mem[(32 * [94midx) + 140 len 20])
              ...
              mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 228] = [94m_414
              require ext_code.size(addr([94m_404))
              call addr([94m_404).approve(address spender, uint256 value) with:
                   gas gas_remaining wei
                  args munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m], [94m_414
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
          [94midx = [94midx + 1
          mcontinue 
          ...
          mwhile [94midx < m_param2.lengthm:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1373)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1373)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1373)
                          mem[0] = addr([94m_1373)
                          mem[32] = 22
                          mstor22m[addr([94m_1373)m] = 1
              [94midx = [94midx + 1
              mcontinue 
          return 1
      mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = m_param2.length
          ...
          mwhile [94midx < [94m_1689m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1705)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1705)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1705)
                          mem[0] = addr([94m_1705)
                          mem[32] = 22
                          mstor22m[addr([94m_1705)m] = 1
              [94midx = [94midx + 1
              mcontinue 
      else:
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 224 len 32 * m_param2.length] = code.data[24526 len 32 * m_param2.length]
          ...
          mwhile [94midx < [94m_1690m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1708)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1708)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1708)
                          mem[0] = addr([94m_1708)
                          mem[32] = 22
                          mstor22m[addr([94m_1708)m] = 1
              [94midx = [94midx + 1
              mcontinue 
  else:
      require ext_code.size(munknown2156e6c6m[0xef57686974656c69737450726f76696465720000000000000000000000000000m])
      ...
      mwhile [94midx < m_param2.lengthm:
          ...
          if mstor23m[mem[(32 * [94midx) + 140 len 20]m]:
              ...
              require [94midx < m_param3.length
              [94m_420 = mem[(32 * [94midx) + (32 * m_param2.length) + 160]
              mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
              mem[32] = 4
              require ext_code.size(mem[(32 * [94midx) + 140 len 20])
              call mem[(32 * [94midx) + 140 len 20].approve(address spender, uint256 value) with:
              ...
              mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = 0x95ea7b300000000000000000000000000000000000000000000000000000000
              mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 196] = munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m]
              mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 228] = [94m_420
              require ext_code.size(addr([94m_407))
              call addr([94m_407).approve(address spender, uint256 value) with:
                   gas gas_remaining wei
                  args munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m], [94m_420
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
          [94midx = [94midx + 1
          mcontinue 
          ...
          mwhile [94midx < m_param2.lengthm:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1378)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1378)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1378)
                          mem[0] = addr([94m_1378)
                          mem[32] = 22
                          mstor22m[addr([94m_1378)m] = 1
              [94midx = [94midx + 1
              mcontinue 
          return 1
      mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = m_param2.length
          ...
          mwhile [94midx < [94m_1691m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1711)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1711)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1711)
                          mem[0] = addr([94m_1711)
                          mem[32] = 22
                          mstor22m[addr([94m_1711)m] = 1
              [94midx = [94midx + 1
              mcontinue 
      else:
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 224 len 32 * m_param2.length] = code.data[24526 len 32 * m_param2.length]
          ...
          mwhile [94midx < [94m_1692m:
              ...
              if mem[(32 * [94midx) + 140 len 20]:
                  ...
                  if 0 < ext_call.return_data[0]:
                      mem[0] = addr([94m_1714)
                      mem[32] = 22
                      if not mstor22m[addr([94m_1714)m]:
                          mtokensm.length++
                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1714)
                          mem[0] = addr([94m_1714)
                          mem[32] = 22
                          mstor22m[addr([94m_1714)m] = 1
              [94midx = [94midx + 1
              mcontinue 
  return 0
  ...
  if 0 == mtotalSupply:
      ...
      if mstatus != 3:
          ...
          mwhile [94midx < mtokensm.lengthm:
              ...
              require [94midx < mtokensm.length
              mem[0] = 9
              require ext_code.size(addr(mtokensm[[94midxm]m.field_0))
              call addr(mtokensm[[94midxm]m.field_0).decimals() with:
                   gas gas_remaining wei
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              require return_data.size >= 32
              ...
              require ext_code.size(addr(mtokensm[[94midxm]m.field_0))
              call addr(mtokensm[[94midxm]m.field_0).balanceOf(address owner) with:
                   gas gas_remaining wei
                  args this.address
              ...
              call munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m].getPrice(address sourceAddress, address destAddress, uint256 amount, bytes32 exchangeId) with:
                   gas gas_remaining wei
                  args addr(mtokensm[[94midxm]m.field_0), 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, 10^ext_call.return_data[0], 0
          ...
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
          if ext_call.return_data[0] != m_value:
              munknown36724ef4 = 1
          else:
              require ext_code.size(munknown2156e6c6m[0x576974686472617750726f7669646572000000000000000000000000000000m])
              ...
              if munknown07b08870m.length != 0:
                  ...
                  mem[132] = caller
                  mem[100] = 64
                  mem[164] = munknown07b08870m.length
                  if not munknown07b08870m.length:
                      require ext_code.size(munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m])
                      call munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m].0x8f99506a with:
                           gas gas_remaining wei
                          args 64, caller, munknown07b08870m.length
                      if not ext_call.success:
                          revert with ext_call.return_data[0 len return_data.size]
                      ...
                      [94midx = 0
                      mwhile [94midx < munknown07b08870m.lengthm:
                          mstor19m.length++
                          mem[0] = 19
                          addr(mstor19m[mstor19m.lengthm]m.field_0) = addr(munknown07b08870m[[94midxm]m.field_0)
                          require [94midx < mem[[94m_762 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_762 + 128]:
                              [94midx = [94midx + 1
                              mcontinue 
                          require [94midx < munknown07b08870m.length
                          mem[ceil32(return_data.size) + 100] = addr(munknown07b08870m[[94midxm]m.field_0)
                          mem[ceil32(return_data.size) + 132] = caller
                          require ext_code.size(munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m])
                          call munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m].withdraw(address receiver, address token) with:
                               gas gas_remaining wei
                              args addr(munknown07b08870m[[94midxm]m.field_0), caller
                          ...
                          require ext_code.size(addr(munknown07b08870m[[94midxm]m.field_0))
                          call addr(munknown07b08870m[[94midxm]m.field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                          ...
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                              mcontinue 
                          require munknown07b08870m.length - 1 < munknown07b08870m.length
                          require [94midx < munknown07b08870m.length
                          addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                          require munknown07b08870m.length - 1 < mem[[94m_762 + 96]
                          require [94midx < mem[[94m_762 + 96]
                          mem[[94m_762 + (32 * [94midx) + 128] = mem[(32 * munknown07b08870m.length - 1) + [94m_762 + 128]
                          require munknown07b08870m.length - 1 < munknown07b08870m.length
                          mem[0] = 24
                          addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                          munknown07b08870m.length--
                          if munknown07b08870m.length > munknown07b08870m.length - 1:
                              mem[0] = 24
                              [94ms = munknown07b08870m.length + sha3(24) - 1
                              mwhile sha3(24) + munknown07b08870m.length > [94msm:
                                  mstor[[94msm] = 0
                                  [94ms = [94ms + 1
                                  mcontinue 
                          [94midx = [94midx
                          mcontinue 
                      if not mstor19m.length:
                          [94midx = 0
                          mwhile [94midx < mstor19m.lengthm:
                              require [94midx < mstor19m.length
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < mstor19m.length
                                  [94m_1903 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                  require ext_code.size(addr([94m_1903))
                                  call addr([94m_1903).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * mstor19m.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                      revert with ext_call.return_data[0 len return_data.size]
                                  require return_data.size >= 32
                                  mem[0] = addr([94m_1903)
                                  mem[32] = 21
                                  mamountsm[addr([94m_1903)m] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_1903)
                                      mem[32] = 22
                                      if not mstor22m[addr([94m_1903)m]:
                                          mtokensm.length++
                                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_1903)
                                          mem[0] = addr([94m_1903)
                                          mem[32] = 22
                                          mstor22m[addr([94m_1903)m] = 1
                              [94midx = [94midx + 1
                              mcontinue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(mstor19m.field_0)
                          [94midx = ceil32(return_data.size) + 128
                          [94ms = 0
                          mwhile ceil32(return_data.size) + (32 * mstor19m.length) + 96 > [94midxm:
                              mem[[94midx + 32] = addr(mstor19m[[94msm]m.field_256)
                              [94midx = [94midx + 32
                              [94ms = [94ms + 1
                              mcontinue 
                          [94midx = 0
                          mwhile [94midx < mstor19m.lengthm:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  ...
                                  mem[0] = addr([94m_2949)
                                  mem[32] = 21
                                  mamountsm[addr([94m_2949)m] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2949)
                                      mem[32] = 22
                                      if not mstor22m[addr([94m_2949)m]:
                                          mtokensm.length++
                                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_2949)
                                          mem[0] = addr([94m_2949)
                                          mem[32] = 22
                                          mstor22m[addr([94m_2949)m] = 1
                              [94midx = [94midx + 1
                              mcontinue 
                  else:
                      mem[0] = 24
                      mem[196] = addr(munknown07b08870m.field_0)
                      [94midx = 196
                      [94ms = 0
                      mwhile (32 * munknown07b08870m.length) + 196 > [94midx + 32m:
                          mem[[94midx + 32] = addr(munknown07b08870m[[94msm]m.field_256)
                          [94midx = [94midx + 32
                          [94ms = [94ms + 1
                          mcontinue 
                      require ext_code.size(munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m])
                      call munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m].0x8f99506a with:
                           gas gas_remaining wei
                          args Array(len=munknown07b08870m.length, data=mem[196 len 32 * munknown07b08870m.length]), caller
                      if not ext_call.success:
                          revert with ext_call.return_data[0 len return_data.size]
                      mem[96 len return_data.size] = ext_call.return_data[0 len return_data.size]
                      mem[64] = ceil32(return_data.size) + 96
                      require return_data.size >= 32
                      [94m_1895 = mem[96 len 4], 0
                      require mem[96 len 4], 0 <= 4294967296
                      require mem[96 len 4], 0 + 32 <= return_data.size
                      require mem[mem[96 len 4], 0 + 96] <= 4294967296 and mem[96 len 4], 0 + (32 * mem[mem[96 len 4], 0 + 96]) + 32 <= return_data.size
                      [94midx = 0
                      mwhile [94midx < munknown07b08870m.lengthm:
                          ...
                          mem[0] = 19
                          addr(mstor19m[mstor19m.lengthm]m.field_0) = addr(munknown07b08870m[[94midxm]m.field_0)
                          require [94midx < mem[[94m_1895 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1895 + 128]:
                              [94midx = [94midx + 1
                              mcontinue 
                          require [94midx < munknown07b08870m.length
                          mem[ceil32(return_data.size) + 100] = addr(munknown07b08870m[[94midxm]m.field_0)
                          ...
                          mem[0] = 24
                          require [94midx < mem[[94m_1895 + 96]
                          [94m_2380 = mem[(32 * [94midx) + [94m_1895 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          mem[ceil32(return_data.size) + 132] = [94m_2380
                          require ext_code.size(addr(munknown07b08870m[[94midxm]m.field_0))
                          call addr(munknown07b08870m[[94midxm]m.field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                          ...
                          require [94midx < munknown07b08870m.length
                          addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                          require munknown07b08870m.length - 1 < mem[[94m_1895 + 96]
                          require [94midx < mem[[94m_1895 + 96]
                          mem[[94m_1895 + (32 * [94midx) + 128] = mem[(32 * munknown07b08870m.length - 1) + [94m_1895 + 128]
                          require munknown07b08870m.length - 1 < munknown07b08870m.length
                          mem[0] = 24
                          addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                          munknown07b08870m.length--
                      ...
                      if not mstor19m.length:
                          ...
                          mwhile [94midx < mstor19m.lengthm:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < mstor19m.length
                                  [94m_2953 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                  ...
                                  mem[0] = addr([94m_2953)
                                  mem[32] = 21
                                  mamountsm[addr([94m_2953)m] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2953)
                                      mem[32] = 22
                                      if not mstor22m[addr([94m_2953)m]:
                                          mtokensm.length++
                                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_2953)
                                          mem[0] = addr([94m_2953)
                                          mem[32] = 22
                                          mstor22m[addr([94m_2953)m] = 1
                              [94midx = [94midx + 1
                              mcontinue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(mstor19m.field_0)
                          ...
                          mwhile [94midx < mstor19m.lengthm:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < mstor19m.length
                                  [94m_4163 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                  ...
                                  mem[0] = addr([94m_4163)
                                  mem[32] = 21
                                  mamountsm[addr([94m_4163)m] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_4163)
                                      mem[32] = 22
                                      if not mstor22m[addr([94m_4163)m]:
                                          mtokensm.length++
                                          addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_4163)
                                          mem[0] = addr([94m_4163)
                                          mem[32] = 22
                                          mstor22m[addr([94m_4163)m] = 1
                              [94midx = [94midx + 1
                              mcontinue 
                  mstor19m.length = 0
                  [94midx = 0
                  mwhile mstor19m.length > [94midxm:
                      mstor19m[[94midxm]m.field_0 = 0
                      [94midx = [94midx + 1
                      mcontinue 
              require ext_code.size(munknown2156e6c6m[0x576974686472617750726f7669646572000000000000000000000000000000m])
              ...
              if ext_call.return_data[32]:
                  ...
                  if ext_call.return_data[0] > 0:
                      ...
                      if not ext_call.success:
                          revert with ext_call.return_data[0 len return_data.size]
                  if mbalanceOfm[callerm] <= 0:
                      require munknown81d62bf5m.length - 1 < munknown81d62bf5m.length
                      require munknown1c2a0e5cm[callerm] - 1 < munknown81d62bf5m.length
                      addr(munknown81d62bf5m[mstor26m[callerm]m]m.field_0) = addr(munknown81d62bf5m[munknown81d62bf5m.lengthm]m.field_0)
                      require munknown81d62bf5m.length - 1 < munknown81d62bf5m.length
                      munknown1c2a0e5cm[addr(mstor27m[mstor27m.lengthm]m.field_0)m] = munknown1c2a0e5cm[callerm]
                      munknown81d62bf5m.length--
                      if munknown81d62bf5m.length > munknown81d62bf5m.length - 1:
                          [94midx = munknown81d62bf5m.length - 1
                          mwhile munknown81d62bf5m.length > [94midxm:
                              munknown81d62bf5m[[94midxm]m.field_0 = 0
                              [94midx = [94midx + 1
                              mcontinue 
                      munknown1c2a0e5cm[callerm] = 0
              require ext_code.size(munknown2156e6c6m[0x576974686472617750726f7669646572000000000000000000000000000000m])
      ...
      if not eth.balance(this.address) - maccumulatedFee:
                  ...
                  if munknown07b08870m.length != 0:
                      ...
                      if not munknown07b08870m.length:
                          ...
                          mwhile [94midx < munknown07b08870m.lengthm:
                              ...
                              require [94midx < munknown07b08870m.length
                              addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                              require munknown07b08870m.length - 1 < mem[[94m_1499 + 96]
                              require [94midx < mem[[94m_1499 + 96]
                              mem[[94m_1499 + (32 * [94midx) + 128] = mem[(32 * munknown07b08870m.length - 1) + [94m_1499 + 128]
                              require munknown07b08870m.length - 1 < munknown07b08870m.length
                              mem[0] = 24
                              addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                              munknown07b08870m.length--
                          ...
                          if not mstor19m.length:
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      ...
                                      mem[0] = addr([94m_2321)
                                      mem[32] = 21
                                      mamountsm[addr([94m_2321)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_2321)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_2321)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_2321)
                                              mem[0] = addr([94m_2321)
                                              mem[32] = 22
                                              mstor22m[addr([94m_2321)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                          else:
                              mem[ceil32(return_data.size) + 128] = addr(mstor19m.field_0)
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      ...
                                      mem[0] = addr([94m_3621)
                                      mem[32] = 21
                                      mamountsm[addr([94m_3621)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_3621)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_3621)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_3621)
                                              mem[0] = addr([94m_3621)
                                              mem[32] = 22
                                              mstor22m[addr([94m_3621)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                      else:
                          mem[0] = 24
                          ...
                          mwhile [94midx < munknown07b08870m.lengthm:
                              ...
                              mem[0] = 19
                              addr(mstor19m[mstor19m.lengthm]m.field_0) = addr(munknown07b08870m[[94midxm]m.field_0)
                              require [94midx < mem[[94m_2313 + 96]
                              if 0 == mem[(32 * [94midx) + [94m_2313 + 128]:
                                  [94midx = [94midx + 1
                                  mcontinue 
                              require [94midx < munknown07b08870m.length
                              mem[ceil32(return_data.size) + 100] = addr(munknown07b08870m[[94midxm]m.field_0)
                              ...
                              mem[0] = 24
                              require [94midx < mem[[94m_2313 + 96]
                              [94m_3031 = mem[(32 * [94midx) + [94m_2313 + 128]
                              mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                              mem[ceil32(return_data.size) + 100] = caller
                              mem[ceil32(return_data.size) + 132] = [94m_3031
                              require ext_code.size(addr(munknown07b08870m[[94midxm]m.field_0))
                              call addr(munknown07b08870m[[94midxm]m.field_0).transfer(address to, uint256 value) with:
                                   gas gas_remaining wei
                              ...
                              require [94midx < munknown07b08870m.length
                              addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                              require munknown07b08870m.length - 1 < mem[[94m_2313 + 96]
                              require [94midx < mem[[94m_2313 + 96]
                              mem[[94m_2313 + (32 * [94midx) + 128] = mem[(32 * munknown07b08870m.length - 1) + [94m_2313 + 128]
                              require munknown07b08870m.length - 1 < munknown07b08870m.length
                              mem[0] = 24
                              addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                              munknown07b08870m.length--
                          ...
                          if not mstor19m.length:
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      require [94midx < mstor19m.length
                                      [94m_3625 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                      mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                      ...
                                      mem[0] = addr([94m_3625)
                                      mem[32] = 21
                                      mamountsm[addr([94m_3625)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_3625)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_3625)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_3625)
                                              mem[0] = addr([94m_3625)
                                              mem[32] = 22
                                              mstor22m[addr([94m_3625)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                          else:
                              mem[ceil32(return_data.size) + 128] = addr(mstor19m.field_0)
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      require [94midx < mstor19m.length
                                      [94m_4701 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                      mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                      ...
                                      mem[0] = addr([94m_4701)
                                      mem[32] = 21
                                      mamountsm[addr([94m_4701)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_4701)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_4701)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_4701)
                                              mem[0] = addr([94m_4701)
                                              mem[32] = 22
                                              mstor22m[addr([94m_4701)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                      mstor19m.length = 0
                      [94midx = 0
          ...
          require mtotalSupply
          mem[196] = m_value
          mem[228] = (eth.balance(this.address) * 10^mdecimals) - (maccumulatedFee * 10^mdecimals) / mtotalSupply
          require ext_code.size(munknown2156e6c6m['RiskProvider'm])
          call munknown2156e6c6m['RiskProvider'm].hasRisk(address sender, address receiver, address tokenAddress, uint256 amount, uint256 rate) with:
               gas gas_remaining wei
                  ...
                  if munknown07b08870m.length != 0:
                      ...
                      if not munknown07b08870m.length:
                          ...
                          mwhile [94midx < munknown07b08870m.lengthm:
                              ...
                              require [94midx < munknown07b08870m.length
                              addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                              require munknown07b08870m.length - 1 < mem[[94m_1498 + 96]
                              require [94midx < mem[[94m_1498 + 96]
                              mem[[94m_1498 + (32 * [94midx) + 128] = mem[(32 * munknown07b08870m.length - 1) + [94m_1498 + 128]
                              require munknown07b08870m.length - 1 < munknown07b08870m.length
                              mem[0] = 24
                              addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                              munknown07b08870m.length--
                          ...
                          if not mstor19m.length:
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      ...
                                      mem[0] = addr([94m_2317)
                                      mem[32] = 21
                                      mamountsm[addr([94m_2317)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_2317)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_2317)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_2317)
                                              mem[0] = addr([94m_2317)
                                              mem[32] = 22
                                              mstor22m[addr([94m_2317)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                          else:
                              mem[ceil32(return_data.size) + 128] = addr(mstor19m.field_0)
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      ...
                                      mem[0] = addr([94m_3611)
                                      mem[32] = 21
                                      mamountsm[addr([94m_3611)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_3611)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_3611)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_3611)
                                              mem[0] = addr([94m_3611)
                                              mem[32] = 22
                                              mstor22m[addr([94m_3611)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                      else:
                          mem[0] = 24
                          ...
                          mwhile [94midx < munknown07b08870m.lengthm:
                              ...
                              mem[0] = 19
                              addr(mstor19m[mstor19m.lengthm]m.field_0) = addr(munknown07b08870m[[94midxm]m.field_0)
                              require [94midx < mem[[94m_2311 + 96]
                              if 0 == mem[(32 * [94midx) + [94m_2311 + 128]:
                                  [94midx = [94midx + 1
                                  mcontinue 
                              require [94midx < munknown07b08870m.length
                              mem[ceil32(return_data.size) + 100] = addr(munknown07b08870m[[94midxm]m.field_0)
                              ...
                              mem[0] = 24
                              require [94midx < mem[[94m_2311 + 96]
                              [94m_3027 = mem[(32 * [94midx) + [94m_2311 + 128]
                              mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                              mem[ceil32(return_data.size) + 100] = caller
                              mem[ceil32(return_data.size) + 132] = [94m_3027
                              require ext_code.size(addr(munknown07b08870m[[94midxm]m.field_0))
                              call addr(munknown07b08870m[[94midxm]m.field_0).transfer(address to, uint256 value) with:
                                   gas gas_remaining wei
                              ...
                              require [94midx < munknown07b08870m.length
                              addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                              require munknown07b08870m.length - 1 < mem[[94m_2311 + 96]
                              require [94midx < mem[[94m_2311 + 96]
                              mem[[94m_2311 + (32 * [94midx) + 128] = mem[(32 * munknown07b08870m.length - 1) + [94m_2311 + 128]
                              require munknown07b08870m.length - 1 < munknown07b08870m.length
                              mem[0] = 24
                              addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                              munknown07b08870m.length--
                          ...
                          if not mstor19m.length:
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      require [94midx < mstor19m.length
                                      [94m_3615 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                      mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                      ...
                                      mem[0] = addr([94m_3615)
                                      mem[32] = 21
                                      mamountsm[addr([94m_3615)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_3615)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_3615)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_3615)
                                              mem[0] = addr([94m_3615)
                                              mem[32] = 22
                                              mstor22m[addr([94m_3615)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                          else:
                              mem[ceil32(return_data.size) + 128] = addr(mstor19m.field_0)
                              ...
                              mwhile [94midx < mstor19m.lengthm:
                                  ...
                                  if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                      require [94midx < mstor19m.length
                                      [94m_4693 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                      mem[ceil32(return_data.size) + (32 * mstor19m.length) + 132] = this.address
                                      ...
                                      mem[0] = addr([94m_4693)
                                      mem[32] = 21
                                      mamountsm[addr([94m_4693)m] = ext_call.return_data[0]
                                      if 0 < ext_call.return_data[0]:
                                          mem[0] = addr([94m_4693)
                                          mem[32] = 22
                                          if not mstor22m[addr([94m_4693)m]:
                                              mtokensm.length++
                                              addr(mtokensm[mtokensm.lengthm]m.field_0) = addr([94m_4693)
                                              mem[0] = addr([94m_4693)
                                              mem[32] = 22
                                              mstor22m[addr([94m_4693)m] = 1
                                  [94midx = [94midx + 1
                                  mcontinue 
                      mstor19m.length = 0
                      [94midx = 0
...
def unknown81d62bf5(uint256 m_param1): # not payable
  ...
  return addr(munknown81d62bf5m[m_param1m]m.field_0)
...
def unknown85450abf(): # not payable
  ...
  mwhile (32 * munknown81d62bf5m.length) + 96 > [94midxm:
      mem[[94midx + 32] = addr(munknown81d62bf5m[[94msm]m.field_256)
      [94midx = [94midx + 32
      [94ms = [94ms + 1
      mcontinue 
  mem[(32 * munknown81d62bf5m.length) + 192 len floor32(munknown81d62bf5m.length)] = mem[128 len floor32(munknown81d62bf5m.length)]
...
def unknown8a97d732(addr m_param1): # not payable
  return bool(mstor23m[m_param1m])
...
def getTokens(): # not payable
  ...
  mwhile [94midx < mtokensm.lengthm:
      ...
      mem[32] = 21
      require [94midx < mtokensm.length
      mem[(32 * [94midx) + 128] = mamountsm[addr(mstor9m[[94midxm]m.field_0)m]
      [94midx = [94midx + 1
      mcontinue 
  if mtokensm.length:
      ...
      mwhile (64 * mtokensm.length) + 128 > [94midxm:
          mem[[94midx + 32] = addr(mtokensm[[94msm]m.field_256)
          [94midx = [94midx + 32
          [94ms = [94ms + 1
          mcontinue 
  ...
  if not ext_call.success:
      ...
      if not ext_call.success:
          ...
          if munknown1c2a0e5cm[callerm]:
                  ...
                  if call.value:
                      ...
                      if mtotalSupply != 0:
                          ...
                          mwhile [94midx < mtokensm.lengthm:
                              mem[0] = addr(mtokensm[[94midxm]m.field_0)
                              mem[32] = 23
                              if not mstor23m[addr(mstor9m[[94midxm]m.field_0)m]:
                                  require [94midx < mtokensm.length
                                  mem[0] = 9
                                  require ext_code.size(addr(mtokensm[[94midxm]m.field_0))
                                  call addr(mtokensm[[94midxm]m.field_0).decimals() with:
              ...
              munknown81d62bf5m.length++
              mstor3AD8m[mstor27m.lengthm] = caller
