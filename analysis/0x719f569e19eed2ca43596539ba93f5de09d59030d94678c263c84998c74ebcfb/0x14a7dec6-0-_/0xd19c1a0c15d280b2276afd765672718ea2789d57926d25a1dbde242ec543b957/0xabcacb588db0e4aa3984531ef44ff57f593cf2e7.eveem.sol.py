...
#  addr = 0xAbCAcb588Db0e4Aa3984531eF44fF57f593Cf2e7 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {'0xda54fcc4': 'unknownda54fcc4(?)', '0xff534a34': 'unknownff534a34(?)'} 
...
def unknown0dd4b27e(uint256 m_param1, addr m_param2, uint256 m_param3, uint256 m_param4, uint256 m_param5, uint256 m_param6, addr m_param7, uint8 m_param8, uint8 m_param9): # not payable
  require ext_code.size(addr(code.data[11639 len 32]))
  call addr(code.data[11639 len 32]).addressOf(bytes32 name) with:
  ...
  if ext_call.return_data[12 len 20] == caller:
      ...
      if ext_call.return_data[0] < m_param3:
          ...
          munknown1065cf73m[mstor4m.length + 1m]m.field_0 = mstor4m.length
...
def register(): # not payable
  if mstor0 == caller:
      require ext_code.size(code.data[11639 len 32])
      call code.data[11639 len 32].register(bytes32 name) with:
           gas gas_remaining - 50 wei
          args 'offerbook'
      require ext_call.success
...
def unknownc815729d(uint256 m_param1) payable: 
      ...
      if munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_1280 != caller:
          ...
          if not munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_2472:
              ...
              call addr(ext_call.return_data[0]).getBalance(address addressToCheck) with:
                  ...
                  args caller
              require ext_call.success
              if ext_call.return_data[0] < (munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_768 * munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_512) + (munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_768 * munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_2048):
  ...
  if munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_2472:
      if call.value < (munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_768 * munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_512) + (munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_768 * munknown1065cf73m[munknown1065cf73m[m_param1m]m.field_0m]m.field_2048):
          return 0
  else:
      require ext_code.size(addr(code.data[11639 len 32]))
      call addr(code.data[11639 len 32]).addressOf(bytes32 name) with:
  ...
  require ext_call.success
  require ext_code.size(code.data[11639 len 32])
  call code.data[11639 len 32].addressOf(bytes32 name) with:
       gas gas_remaining - 50 wei
      args 0x637573746f6469616e0000000000000000000000000000000000000000000000
  require ext_call.success
