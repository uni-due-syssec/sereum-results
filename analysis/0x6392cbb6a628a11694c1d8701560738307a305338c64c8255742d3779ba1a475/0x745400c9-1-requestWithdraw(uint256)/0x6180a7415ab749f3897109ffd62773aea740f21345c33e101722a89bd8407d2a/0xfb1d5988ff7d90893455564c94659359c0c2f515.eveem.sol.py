...
#  addr = 0xFB1d5988ff7D90893455564c94659359c0c2f515 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def storage:
    ...
    stor2481041784956016742021570618494952475758789857281704946240779902470294861374
...
def unknown3c98d189(uint256 _param1, array _param2, array _param3, array _param4): # not payable
  ...
  if caller == owner:
      ...
      if not _param2.length:
          ...
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 224 len 32 * _param2.length] = code.data[24331 len 32 * _param2.length]
          mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
          mem[32] = 4
          mem[(32 * _param4.length) + (32 * _param3.length) + (64 * _param2.length) + 224] = 0x674f23ba00000000000000000000000000000000000000000000000000000000
          mem[(32 * _param4.length) + (32 * _param3.length) + (64 * _param2.length) + 228] = 32
      ...
      while [94midx < _param2.length:
          ...
          if stor23[mem[(32 * [94midx) + 140 len 20]]:
              ...
              continue 
          require [94midx < _param3.length
          [94m_335 = mem[(32 * [94midx) + (32 * _param2.length) + 160]
          require [94midx < mem[(32 * _param3.length) + (32 * _param2.length) + 160]
          [94m_340 = mem[(32 * [94midx) + (32 * _param3.length) + (32 * _param2.length) + 192]
          mem[0] = 'RiskProvider'
          mem[32] = 4
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 196] = this.address
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 228] = unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000]
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 260] = 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 292] = [94m_335
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 324] = [94m_340
          require ext_code.size(unknown2156e6c6['RiskProvider'])
          call unknown2156e6c6['RiskProvider'].hasRisk(address sender, address receiver, address tokenAddress, uint256 amount, uint256 rate) with:
               gas gas_remaining wei
              args addr(this.address), unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000], 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, [94m_335, [94m_340
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 192] = ext_call.return_data[0]
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
...
def panic(): # not payable
  ...
  while [94midx < tokens.length:
      ...
      mem[100] = owner
      mem[132] = amounts[addr(stor9[[94midx].field_0)]
      require ext_code.size(addr(tokens[[94midx].field_0))
      call addr(tokens[[94midx].field_0).transfer(address to, uint256 value) with:
           gas gas_remaining wei
          args owner, amounts[addr(stor9[[94midx].field_0)]
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      [94midx = [94midx + 1
      continue 
...
def tokensWithAmount(): # not payable
  ...
  while [94midx < tokens.length:
      ...
      continue 
  if [94ms:
      mem[128 len 32 * [94ms] = code.data[24331 len 32 * [94ms]
  [94midx = 0
  [94mt = 0
  while [94midx < tokens.length:
      mem[0] = addr(tokens[[94midx].field_0)
  ...
  if caller == owner:
      ...
      while [94midx < _param2.length:
          ...
          if stor23[mem[(32 * [94midx) + 140 len 20]]:
              ...
              require [94midx < _param3.length
              [94m_419 = mem[(32 * [94midx) + (32 * _param2.length) + 160]
              mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
              mem[32] = 4
              ...
              mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 228] = [94m_419
              require ext_code.size(addr([94m_406))
              call addr([94m_406).approve(address spender, uint256 value) with:
                   gas gas_remaining wei
                  args unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000], [94m_419
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
          [94midx = [94midx + 1
          continue 
      ...
      while [94midx < _param2.length:
          ...
          if stor23[mem[(32 * [94midx) + 140 len 20]]:
              ...
              require [94midx < _param3.length
              [94m_426 = mem[(32 * [94midx) + (32 * _param2.length) + 160]
              mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
              mem[32] = 4
              require ext_code.size(mem[(32 * [94midx) + 140 len 20])
              call mem[(32 * [94midx) + 140 len 20].approve(address spender, uint256 value) with:
              ...
              mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 192] = 0x95ea7b300000000000000000000000000000000000000000000000000000000
              mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 196] = unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000]
              mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 228] = [94m_426
              require ext_code.size(addr([94m_411))
              call addr([94m_411).approve(address spender, uint256 value) with:
                   gas gas_remaining wei
                  args unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000], [94m_426
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
          [94midx = [94midx + 1
          continue 
  ...
  if 0 == totalSupply:
      ...
      if status == 3:
          ...
          while [94midx < tokens.length:
              mem[0] = addr(tokens[[94midx].field_0)
              mem[32] = 20
              if not amounts[addr(stor9[[94midx].field_0)]:
                  [94midx = [94midx + 1
                  [94ms = amounts[addr(stor9[[94midx].field_0)]
                  continue 
              require [94midx < tokens.length
              mem[0] = 9
              mem[132] = addr(tokens[[94midx].field_0)
              mem[164] = amounts[addr(stor9[[94midx].field_0)]
              mem[196] = 0
              require ext_code.size(unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000])
              call unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000].getPrice(address sourceAddress, address destAddress, uint256 amount, bytes32 exchangeId) with:
                   gas gas_remaining wei
                  args 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, addr(tokens[[94midx].field_0), amounts[addr(stor9[[94midx].field_0)], 0
              ...
              if not amounts[addr(stor9[[94midx].field_0)]:
                  ...
                  if 10^18 * amounts[addr(stor9[[94midx].field_0)] / amounts[addr(stor9[[94midx].field_0)] == 10^18:
                      if ext_call.return_data[0]:
                          if 10^18 * amounts[addr(stor9[[94midx].field_0)] / ext_call.return_data[0] >= 0:
                              [94midx = [94midx + 1
                              [94ms = amounts[addr(stor9[[94midx].field_0)]
                              continue 
              revert
          ...
          if unknown07b08870.length != 0:
              ...
              if not unknown07b08870.length:
                  ...
                  while [94midx < unknown07b08870.length:
                      ...
                      require [94midx < mem[[94m_498 + 96]
                      if 0 == mem[(32 * [94midx) + [94m_498 + 128]:
                          [94midx = [94midx + 1
                          continue 
                      ...
                      mem[0] = 22
                      require [94midx < mem[[94m_498 + 96]
                      [94m_978 = mem[(32 * [94midx) + [94m_498 + 128]
                      ...
                      mem[ceil32(return_data.size) + 132] = [94m_978
                      ...
                      require unknown07b08870.length - 1 < mem[[94m_498 + 96]
                      require [94midx < mem[[94m_498 + 96]
                      mem[[94m_498 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_498 + 128]
                      require unknown07b08870.length - 1 < unknown07b08870.length
                      mem[0] = 22
                  ...
                  if not stor18.length:
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                              require [94midx < stor18.length
                              [94m_1336 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                              require ext_code.size(addr([94m_1336))
                              call addr([94m_1336).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              ...
                              mem[0] = addr([94m_1336)
                              mem[32] = 20
                              amounts[addr([94m_1336)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_1336)
                                  mem[32] = 21
                                  if not stor21[addr([94m_1336)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_1336)
                                      mem[0] = addr([94m_1336)
                                      mem[32] = 21
                                      stor21[addr([94m_1336)] = 1
                          [94midx = [94midx + 1
                          continue 
                  else:
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                              require [94midx < stor18.length
                              [94m_2125 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                              require ext_code.size(addr([94m_2125))
                              call addr([94m_2125).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                              if not ext_call.success:
                              ...
                              mem[0] = addr([94m_2125)
                              mem[32] = 20
                              amounts[addr([94m_2125)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_2125)
                                  mem[32] = 21
                                  if not stor21[addr([94m_2125)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_2125)
                                      mem[0] = addr([94m_2125)
                                      mem[32] = 21
                                      stor21[addr([94m_2125)] = 1
                          [94midx = [94midx + 1
                          continue 
              else:
                  mem[0] = 22
                  ...
                  mem[64] = mem[64] + ceil32(return_data.size)
                  require return_data.size >= 32
                  [94m_1324 = mem[[94m_1312]
                  require mem[[94m_1312] <= 4294967296
                  require mem[[94m_1312] + 32 <= return_data.size
                  require mem[[94m_1312 + mem[[94m_1312]] <= 4294967296 and mem[[94m_1312] + (32 * mem[[94m_1312 + mem[[94m_1312]]) + 32 <= return_data.size
                  [94midx = 0
                  while [94midx < unknown07b08870.length:
                      stor18.length++
                      mem[0] = 18
                      addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                      require [94midx < mem[[94m_1312 + [94m_1324]
                      if 0 == mem[(32 * [94midx) + [94m_1312 + [94m_1324 + 32]:
                          [94midx = [94midx + 1
                          continue 
                      require [94midx < unknown07b08870.length
                      ...
                      mem[0] = 22
                      require [94midx < mem[[94m_1312 + [94m_1324]
                      [94m_1721 = mem[(32 * [94midx) + [94m_1312 + [94m_1324 + 32]
                      mem[mem[64]] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                      mem[mem[64] + 4] = caller
                      mem[mem[64] + 36] = [94m_1721
                      require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                      call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                           gas gas_remaining wei
                          args caller, [94m_1721
                      if not ext_call.success:
                          revert with ext_call.return_data[0 len return_data.size]
                      if ext_call.return_data[0]:
                          [94midx = [94midx + 1
                      ...
                      mem[0] = 22
                      addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                      require unknown07b08870.length - 1 < mem[[94m_1312 + [94m_1324]
                      require [94midx < mem[[94m_1312 + [94m_1324]
                      mem[[94m_1312 + [94m_1324 + (32 * [94midx) + 32] = mem[(32 * unknown07b08870.length - 1) + [94m_1312 + [94m_1324 + 32]
                      require unknown07b08870.length - 1 < unknown07b08870.length
                      mem[0] = 22
                      addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                      unknown07b08870.length--
                  ...
                  mem[[94m_1633] = stor18.length
                  if not stor18.length:
                      [94midx = 0
                      while [94midx < stor18.length:
                          require [94midx < mem[[94m_1633]
                          if mem[(32 * [94midx) + [94m_1633 + 44 len 20]:
                              require [94midx < mem[[94m_1633]
                              [94m_2129 = mem[[94m_1633 + (32 * [94midx) + 32]
                              mem[mem[64] + 4] = this.address
                              require ext_code.size(addr([94m_2129))
                              call addr([94m_2129).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              mem[mem[64]] = ext_call.return_data[0]
                              if not ext_call.success:
                              ...
                              mem[0] = addr([94m_2129)
                              mem[32] = 20
                              amounts[addr([94m_2129)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_2129)
                                  mem[32] = 21
                                  if not stor21[addr([94m_2129)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_2129)
                                      mem[0] = addr([94m_2129)
                                      mem[32] = 21
                                      stor21[addr([94m_2129)] = 1
                          [94midx = [94midx + 1
                          continue 
                  else:
                      mem[0] = 18
                      mem[[94m_1633 + 32] = addr(stor18.field_0)
                      [94midx = [94m_1633 + 32
                      [94ms = 0
                      while [94m_1633 + (32 * stor18.length) > [94midx:
                          mem[[94midx + 32] = addr(stor18[[94ms].field_256)
                          [94midx = [94midx + 32
                          [94ms = [94ms + 1
                          continue 
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + [94m_1633 + 44 len 20]:
                              require [94midx < mem[[94m_1633]
                              [94m_3002 = mem[[94m_1633 + (32 * [94midx) + 32]
                              mem[mem[64] + 4] = this.address
                              require ext_code.size(addr([94m_3002))
                              call addr([94m_3002).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              mem[mem[64]] = ext_call.return_data[0]
                              if not ext_call.success:
                              ...
                              mem[0] = addr([94m_3002)
                              mem[32] = 20
                              amounts[addr([94m_3002)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_3002)
                                  mem[32] = 21
                                  if not stor21[addr([94m_3002)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_3002)
                                      mem[0] = addr([94m_3002)
                                      mem[32] = 21
                                      stor21[addr([94m_3002)] = 1
                          [94midx = [94midx + 1
                          continue 
              stor18.length = 0
              [94midx = 0
              ...
              if unknown07b08870.length != 0:
                  ...
                  if not unknown07b08870.length:
                      ...
                      while [94midx < unknown07b08870.length:
                          ...
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1010 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1010 + 128]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1010 + 96]
                          [94m_1392 = mem[(32 * [94midx) + [94m_1010 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          mem[ceil32(return_data.size) + 132] = [94m_1392
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_1392
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          require [94midx < unknown07b08870.length
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1010 + 96]
                          require [94midx < mem[[94m_1010 + 96]
                          mem[[94m_1010 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1010 + 128]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      if not stor18.length:
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_1654 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_1654))
                                  call addr([94m_1654).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_1654)
                                  mem[32] = 20
                                  amounts[addr([94m_1654)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_1654)
                                      mem[32] = 21
                                      if not stor21[addr([94m_1654)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_1654)
                                          mem[0] = addr([94m_1654)
                                          mem[32] = 21
                                          stor21[addr([94m_1654)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_2615 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_2615))
                                  call addr([94m_2615).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2615)
                                  mem[32] = 20
                                  amounts[addr([94m_2615)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2615)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2615)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2615)
                                          mem[0] = addr([94m_2615)
                                          mem[32] = 21
                                          stor21[addr([94m_2615)] = 1
                              [94midx = [94midx + 1
                              continue 
                  else:
                      mem[0] = 22
                      ...
                      mem[64] = mem[64] + ceil32(return_data.size)
                      require return_data.size >= 32
                      [94m_1646 = mem[[94m_1637]
                      require mem[[94m_1637] <= 4294967296
                      require mem[[94m_1637] + 32 <= return_data.size
                      require mem[[94m_1637 + mem[[94m_1637]] <= 4294967296 and mem[[94m_1637] + (32 * mem[[94m_1637 + mem[[94m_1637]]) + 32 <= return_data.size
                      [94midx = 0
                      while [94midx < unknown07b08870.length:
                          stor18.length++
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1637 + [94m_1646]
                          if 0 == mem[(32 * [94midx) + [94m_1637 + [94m_1646 + 32]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[mem[64] + 4] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1637 + [94m_1646]
                          [94m_2205 = mem[(32 * [94midx) + [94m_1637 + [94m_1646 + 32]
                          mem[mem[64]] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[mem[64] + 4] = caller
                          mem[mem[64] + 36] = [94m_2205
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_2205
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          mem[0] = 22
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1637 + [94m_1646]
                          require [94midx < mem[[94m_1637 + [94m_1646]
                          mem[[94m_1637 + [94m_1646 + (32 * [94midx) + 32] = mem[(32 * unknown07b08870.length - 1) + [94m_1637 + [94m_1646 + 32]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      [94m_2087 = mem[64]
                      mem[64] = mem[64] + (32 * stor18.length) + 32
                      mem[[94m_2087] = stor18.length
                      if not stor18.length:
                          [94midx = 0
                          while [94midx < stor18.length:
                              require [94midx < mem[[94m_2087]
                              if mem[(32 * [94midx) + [94m_2087 + 44 len 20]:
                                  require [94midx < mem[[94m_2087]
                                  [94m_2619 = mem[[94m_2087 + (32 * [94midx) + 32]
                                  mem[mem[64] + 4] = this.address
                                  require ext_code.size(addr([94m_2619))
                                  call addr([94m_2619).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[mem[64]] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2619)
                                  mem[32] = 20
                                  amounts[addr([94m_2619)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2619)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2619)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2619)
                                          mem[0] = addr([94m_2619)
                                          mem[32] = 21
                                          stor21[addr([94m_2619)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[0] = 18
                          mem[[94m_2087 + 32] = addr(stor18.field_0)
                          [94midx = [94m_2087 + 32
                          [94ms = 0
                          while [94m_2087 + (32 * stor18.length) > [94midx:
                              mem[[94midx + 32] = addr(stor18[[94ms].field_256)
                              [94midx = [94midx + 32
                              [94ms = [94ms + 1
                              continue 
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + [94m_2087 + 44 len 20]:
                                  require [94midx < mem[[94m_2087]
                                  [94m_3409 = mem[[94m_2087 + (32 * [94midx) + 32]
                                  mem[mem[64] + 4] = this.address
                                  require ext_code.size(addr([94m_3409))
                                  call addr([94m_3409).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[mem[64]] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_3409)
                                  mem[32] = 20
                                  amounts[addr([94m_3409)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_3409)
                                      mem[32] = 21
                                      if not stor21[addr([94m_3409)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_3409)
                                          mem[0] = addr([94m_3409)
                                          mem[32] = 21
                                          stor21[addr([94m_3409)] = 1
                              [94midx = [94midx + 1
                              continue 
                  stor18.length = 0
                  [94midx = 0
              ...
              if unknown07b08870.length != 0:
                  ...
                  if not unknown07b08870.length:
                      ...
                      while [94midx < unknown07b08870.length:
                          ...
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1009 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1009 + 128]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1009 + 96]
                          [94m_1390 = mem[(32 * [94midx) + [94m_1009 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          mem[ceil32(return_data.size) + 132] = [94m_1390
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_1390
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          require [94midx < unknown07b08870.length
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1009 + 96]
                          require [94midx < mem[[94m_1009 + 96]
                          mem[[94m_1009 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1009 + 128]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      if not stor18.length:
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_1650 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_1650))
                                  call addr([94m_1650).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_1650)
                                  mem[32] = 20
                                  amounts[addr([94m_1650)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_1650)
                                      mem[32] = 21
                                      if not stor21[addr([94m_1650)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_1650)
                                          mem[0] = addr([94m_1650)
                                          mem[32] = 21
                                          stor21[addr([94m_1650)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_2603 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_2603))
                                  call addr([94m_2603).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2603)
                                  mem[32] = 20
                                  amounts[addr([94m_2603)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2603)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2603)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2603)
                                          mem[0] = addr([94m_2603)
                                          mem[32] = 21
                                          stor21[addr([94m_2603)] = 1
                              [94midx = [94midx + 1
                              continue 
                  else:
                      mem[0] = 22
                      ...
                      mem[64] = mem[64] + ceil32(return_data.size)
                      require return_data.size >= 32
                      [94m_1644 = mem[[94m_1635]
                      require mem[[94m_1635] <= 4294967296
                      require mem[[94m_1635] + 32 <= return_data.size
                      require mem[[94m_1635 + mem[[94m_1635]] <= 4294967296 and mem[[94m_1635] + (32 * mem[[94m_1635 + mem[[94m_1635]]) + 32 <= return_data.size
                      [94midx = 0
                      while [94midx < unknown07b08870.length:
                          stor18.length++
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1635 + [94m_1644]
                          if 0 == mem[(32 * [94midx) + [94m_1635 + [94m_1644 + 32]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[mem[64] + 4] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1635 + [94m_1644]
                          [94m_2201 = mem[(32 * [94midx) + [94m_1635 + [94m_1644 + 32]
                          mem[mem[64]] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[mem[64] + 4] = caller
                          mem[mem[64] + 36] = [94m_2201
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_2201
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          mem[0] = 22
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1635 + [94m_1644]
                          require [94midx < mem[[94m_1635 + [94m_1644]
                          mem[[94m_1635 + [94m_1644 + (32 * [94midx) + 32] = mem[(32 * unknown07b08870.length - 1) + [94m_1635 + [94m_1644 + 32]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      [94m_2086 = mem[64]
                      mem[64] = mem[64] + (32 * stor18.length) + 32
                      mem[[94m_2086] = stor18.length
                      if not stor18.length:
                          [94midx = 0
                          while [94midx < stor18.length:
                              require [94midx < mem[[94m_2086]
                              if mem[(32 * [94midx) + [94m_2086 + 44 len 20]:
                                  require [94midx < mem[[94m_2086]
                                  [94m_2607 = mem[[94m_2086 + (32 * [94midx) + 32]
                                  mem[mem[64] + 4] = this.address
                                  require ext_code.size(addr([94m_2607))
                                  call addr([94m_2607).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[mem[64]] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2607)
                                  mem[32] = 20
                                  amounts[addr([94m_2607)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2607)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2607)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2607)
                                          mem[0] = addr([94m_2607)
                                          mem[32] = 21
                                          stor21[addr([94m_2607)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[0] = 18
                          mem[[94m_2086 + 32] = addr(stor18.field_0)
                          [94midx = [94m_2086 + 32
                          [94ms = 0
                          while [94m_2086 + (32 * stor18.length) > [94midx:
                              mem[[94midx + 32] = addr(stor18[[94ms].field_256)
                              [94midx = [94midx + 32
                              [94ms = [94ms + 1
                              continue 
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + [94m_2086 + 44 len 20]:
                                  require [94midx < mem[[94m_2086]
                                  [94m_3397 = mem[[94m_2086 + (32 * [94midx) + 32]
                                  mem[mem[64] + 4] = this.address
                                  require ext_code.size(addr([94m_3397))
                                  call addr([94m_3397).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[mem[64]] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_3397)
                                  mem[32] = 20
                                  amounts[addr([94m_3397)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_3397)
                                      mem[32] = 21
                                      if not stor21[addr([94m_3397)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_3397)
                                          mem[0] = addr([94m_3397)
                                          mem[32] = 21
                                          stor21[addr([94m_3397)] = 1
                              [94midx = [94midx + 1
                              continue 
                  stor18.length = 0
                  [94midx = 0
                  ...
                  if call.value:
                      ...
                      if totalSupply != 0:
                          ...
                          while [94midx < tokens.length:
                              mem[0] = addr(tokens[[94midx].field_0)
                              mem[32] = 20
                              if amounts[addr(stor9[[94midx].field_0)]:
                                  require [94midx < tokens.length
                                  mem[0] = 9
                                  mem[132] = addr(tokens[[94midx].field_0)
                                  mem[164] = amounts[addr(stor9[[94midx].field_0)]
                                  ...
                                  if not ext_call.success:
                                      ...
                                      if ext_call.return_data[0]:
                                          if amounts[addr(stor9[[94midx].field_0)]:
                                              require 10^18 * amounts[addr(stor9[[94midx].field_0)] / amounts[addr(stor9[[94midx].field_0)] == 10^18
                                              require ext_call.return_data[0]
                                              require 10^18 * amounts[addr(stor9[[94midx].field_0)] / ext_call.return_data[0] >= 0
                                              [94midx = [94midx + 1
                                              [94ms = amounts[addr(stor9[[94midx].field_0)]
                                              continue 
                                          else:
