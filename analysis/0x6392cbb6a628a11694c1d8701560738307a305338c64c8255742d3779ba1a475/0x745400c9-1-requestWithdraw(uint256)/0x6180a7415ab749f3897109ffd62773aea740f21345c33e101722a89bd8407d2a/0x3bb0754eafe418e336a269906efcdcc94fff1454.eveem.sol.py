...
def unknown01d16cec(): # not payable
  ...
  munknowna91fbf9am.length = m('cd', 4).length
  if not m('cd', 4).length:
      [94midx = 0
      mwhile munknowna91fbf9am.length > [94midxm:
          munknowna91fbf9am[[94midxm]m.field_0 = 0
          [94midx = [94midx + 1
          mcontinue 
  else:
      [94ms = 0
      [94midx = cd[4] + 36
      mwhile cd[4] + (32 * m('cd', 4).length) + 36 > [94midxm:
          munknowna91fbf9am[[94msm]m.field_0 = addr(cd[[94midx])
          [94ms = [94ms + 1
          [94midx = [94midx + 32
          mcontinue 
      [94midx = Mask(251, 0, (32 * m('cd', 4).length) + 31) >> 5
      mwhile munknowna91fbf9am.length > [94midxm:
          munknowna91fbf9am[[94midxm]m.field_0 = 0
          [94midx = [94midx + 1
          mcontinue 
...
def unknown334f5401(addr m_param1, addr m_param2, uint256 m_param3, uint256 m_param4, addr m_param5) payable: 
  [94midx = 0
  mwhile [94midx < munknowna91fbf9am.lengthm:
      mem[0] = 7
      if munknowna91fbf9am[[94midxm]m.field_0 == m_param2:
...
def buyToken(address m_token, uint256 m_amount, uint256 m_minimumRate, address m_depositAddress) payable: 
  ...
  mwhile [94midx < munknowna91fbf9am.lengthm:
      mem[0] = 7
      if munknowna91fbf9am[[94midxm]m.field_0 == m_token:
          revert with 0, 'broken token'
      [94midx = [94midx + 1
      mcontinue 
...
# const = None
# payable = False
def unknowna91fbf9a(uint256 m_param1): # not payable
  require m_param1 < munknowna91fbf9am.length
  return munknowna91fbf9am[m_param1m]m.field_0
...
def getPrice(address m_sourceAddress, address m_destAddress, uint256 m_amount): # not payable
  ...
  mwhile [94midx < munknowna91fbf9am.lengthm:
      mem[0] = 7
      if munknowna91fbf9am[[94midxm]m.field_0 != m_destAddress:
          [94midx = [94midx + 1
          mcontinue 
      else:
          return 0
...
def unknowne13f20c8(): # not payable
  if not munknowna91fbf9am.length:
      mem[(32 * munknowna91fbf9am.length) + 128] = 32
      mem[(32 * munknowna91fbf9am.length) + 160] = munknowna91fbf9am.length
      mem[(32 * munknowna91fbf9am.length) + 192 len floor32(munknowna91fbf9am.length)] = mem[128 len floor32(munknowna91fbf9am.length)]
      return memory
        from (32 * munknowna91fbf9am.length) + 128
         [93mlen (96 * munknowna91fbf9am.length) + 64
  mem[128] = addr(munknowna91fbf9am.field_0)
  [94midx = 128
  [94ms = 0
  mwhile (32 * munknowna91fbf9am.length) + 96 > [94midxm:
      mem[[94midx + 32] = munknowna91fbf9am[[94msm]m.field_256
      [94midx = [94midx + 32
      [94ms = [94ms + 1
      mcontinue 
  mem[(32 * munknowna91fbf9am.length) + 192 len floor32(munknowna91fbf9am.length)] = mem[128 len floor32(munknowna91fbf9am.length)]
  return Array(len=munknowna91fbf9am.length, data=mem[128 len floor32(munknowna91fbf9am.length)], mem[(32 * munknowna91fbf9am.length) + floor32(munknowna91fbf9am.length) + 192 len (32 * munknowna91fbf9am.length) - floor32(munknowna91fbf9am.length)]), 
