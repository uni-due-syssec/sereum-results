...
# const = None
# payable = False
def unknown6b5878c0(addr m_param1): # not payable
  require calldata.size - 4 >= 32
  ...
  if uint8(munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0) == 1:
      return mroundsm[2 * uint64(uint64(mstor27m[addr(m_param1)m]m[mstor27m[addr(m_param1)m]m.field_0m]m.field_0))m]m.field_256, 
...
def unknowna8e14f65(addr m_param1, uint256 m_param2): # not payable
  ...
  require uint8(mroundsm[uint64(mstor27m[addr(m_param1)m]m[m_param2m]m.field_144)m]m.field_224) <= 2
  if uint8(mroundsm[uint64(mstor27m[addr(m_param1)m]m[m_param2m]m.field_144)m]m.field_224) != 2:
      return 0
  return 1
