...
#  addr = 0xaf5EBD8A4deFE573B414Ccd935Ea49572FaD8b16 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def unknown4b15908c(uint8 _param1, uint256 _param2, uint256 _param3, uint256 _param4, uint256 _param5): # not payable
  ...
  if ext_call.return_data[12 len 20] != caller:
      revert with 0, '13'
  require _param1 <= 4
  uint8(unknown97d6958d[_param2].field_192) = _param1
  uint32(unknown97d6958d[_param2].field_64) = uint32(('signextend', 3, ('sdiv', ('param', '_param3'), 10000000000)))
  uint16(unknown97d6958d[_param2].field_128) = uint16(('signextend', 1, ('sdiv', ('param', '_param5'), 10000000000000)))
  uint16(unknown97d6958d[_param2].field_144) = uint16(block.timestamp / 10^13)
  Mask(112, 0, unknown97d6958d[_param2].field_144) = 0
  Mask(96, 0, unknown97d6958d[_param2].field_160) = 0
  [94midx = 0
...
def unknown4d12f044(uint256 _param1): # not payable
  require uint8(unknown97d6958d[_param1].field_192) <= 4
  return 10^13 * uint16(unknown97d6958d[_param1].field_0), 
         10^13 * uint16(unknown97d6958d[_param1].field_176),
         10^13 * uint16(unknown97d6958d[_param1].field_144)
...
# const = None
# payable = False
def unknown7010dc40(uint32 _param1, uint256 _param2): # not payable
  if owner != caller:
      revert with 0, '1'
  if not _param2:
      revert with 0, '18'
  ...
  call addr(ext_call.return_data[0]).0x8ba002fc with:
       gas gas_remaining wei
      args this.address, _param1 << 224, _param2
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  ...
  if not ext_call.return_data[0]:
      ...
      return 0
  addr(unknown97d6958d[stor3].field_0) = addr(0xffffffffffffff00ffffffffffffffffffffffffffffffffffffffff00000000 and uint32(_param1) << 96 or Mask(128, 128, unknown97d6958d[stor3].field_0) or Mask(96, 0, unknown97d6958d[stor3].field_0))
  uint32(unknown97d6958d[stor3].field_0) = uint32(('signextend', 3, ('sdiv', ('param', '_param2'), 10000000000)))
  uint128(unknown97d6958d[stor3].field_32) = 0
  uint16(unknown97d6958d[stor3].field_160) = uint16(block.timestamp / 10^13)
  Mask(80, 0, unknown97d6958d[stor3].field_176) = Mask(80, 176, 0xffffffffffffff00ffffffffffffffffffffffffffffffffffffffff00000000 and uint32(_param1) << 96 or Mask(128, 128, unknown97d6958d[stor3].field_0) or Mask(96, 0, unknown97d6958d[stor3].field_0)) >> 176
  unknowne5091753.length++
...
def unknown740a2ab3(uint256 _param1): # not payable
  require uint8(unknown97d6958d[_param1].field_192) <= 4
  require uint8(unknown97d6958d[_param1].field_192) <= 4
  return uint32(unknown97d6958d[_param1].field_0), 
         10^10 * ('signextend', 3, ('signextend', 3, ('signextend', 3, ('signextend', 3, ('field', 0, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2)))))))),
         10^10 * ('signextend', 3, ('signextend', 3, ('signextend', 3, ('signextend', 3, ('type', 224, ('field', 32, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2))))))))),
         10^10 * ('signextend', 3, ('signextend', 3, ('signextend', 3, ('signextend', 3, ('type', 192, ('field', 64, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2))))))))),
         uint8(unknown97d6958d[_param1].field_0),
         10^13 * ('signextend', 1, ('signextend', 1, ('signextend', 1, ('signextend', 1, ('type', 128, ('field', 128, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2)))))))))
...
def unknown76ea9b4e(uint256 _param1): # not payable
  if owner != caller:
      revert with 0, '1'
  require uint8(unknown97d6958d[_param1].field_192) <= 4
  if uint8(unknown97d6958d[_param1].field_192) != 2:
      revert with 0, '21'
  uint8(unknown97d6958d[_param1].field_192) = 3
...
def unknown8b2dbfab(array _param1, array _param2, uint256 _param3): # not payable
  ...
  call addr(ext_call.return_data[0]).0x8ba002fc with:
       gas gas_remaining wei
      args this.address, ext_call.return_data[0] << 224, _param3
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 64
  if not ext_call.return_data[0]:
      log 0xc39f0786: ext_call.return_data[32]
      return 0
  addr(unknown97d6958d[stor3].field_0) = addr(0xffffffffffffff00ffffffffffffffffffffffffffffffffffffffff00000000 and uint32(ext_call.return_data[0]) << 96 or Mask(128, 128, unknown97d6958d[stor3].field_0) or Mask(96, 0, unknown97d6958d[stor3].field_0))
  uint32(unknown97d6958d[stor3].field_0) = uint32(('signextend', 3, ('sdiv', ('param', '_param3'), 10000000000)))
  uint128(unknown97d6958d[stor3].field_32) = 0
  uint16(unknown97d6958d[stor3].field_160) = uint16(block.timestamp / 10^13)
  Mask(80, 0, unknown97d6958d[stor3].field_176) = Mask(80, 176, 0xffffffffffffff00ffffffffffffffffffffffffffffffffffffffff00000000 and uint32(ext_call.return_data[0]) << 96 or Mask(128, 128, unknown97d6958d[stor3].field_0) or Mask(96, 0, unknown97d6958d[stor3].field_0)) >> 176
  unknowne5091753.length++
  unknowne5091753[unknowne5091753.length] = unknown47b922db
  unknown47b922db++
  return unknowne5091753.length
...
def CancelOrder(uint256 _id): # not payable
  if owner != caller:
      revert with 0, '1'
  require uint8(unknown97d6958d[_id].field_192) <= 4
  if uint8(unknown97d6958d[_id].field_192):
      revert with 0, '20'
  uint8(unknown97d6958d[_id].field_192) = 1
  uint32(unknown97d6958d[_id].field_64) = 0
  uint16(unknown97d6958d[_id].field_128) = 0
  uint16(unknown97d6958d[_id].field_144) = uint16(block.timestamp / 10^13)
  Mask(112, 0, unknown97d6958d[_id].field_144) = 0
  Mask(96, 0, unknown97d6958d[_id].field_160) = 0
  [94midx = 0
  while [94midx < unknowne5091753.length:
      mem[0] = 4
...
def unknown97d6958d(uint256 _param1): # not payable
  require uint8(unknown97d6958d[_param1].field_192) <= 4
  return ('signextend', 3, ('signextend', 3, ('signextend', 3, ('field', 0, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2))))))), 
         ('signextend', 3, ('signextend', 3, ('signextend', 3, ('type', 224, ('field', 32, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2)))))))),
         ('signextend', 3, ('signextend', 3, ('signextend', 3, ('type', 192, ('field', 64, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2)))))))),
         uint32(unknown97d6958d[_param1].field_0),
         ('signextend', 1, ('signextend', 1, ('signextend', 1, ('type', 128, ('field', 128, ('stor', ('map', ('param', '_param1'), ('name', 'unknown97d6958d', 2)))))))),
         uint16(unknown97d6958d[_param1].field_0),
         uint16(unknown97d6958d[_param1].field_0),
         uint16(unknown97d6958d[_param1].field_0),
         uint8(unknown97d6958d[_param1].field_192)
...
# const = None
# payable = False
def unknownb8310f49(uint32 _param1): # not payable
  mem[64] = 384
  [94ms = 96
  [94midx = 0
  [94ms = 0
  while [94midx < unknowne5091753.length:
      ...
      [94m_17 = mem[64]
      mem[64] = mem[64] + 288
      mem[[94m_17] = ('signextend', 3, ('signextend', 3, ('signextend', 3, ('field', 0, ('stor', ('map', ('stor', ('array', ('var', 0), ('name', 'stor4', 4))), ('name', 'unknown97d6958d', 2)))))))
      mem[[94m_17 + 32] = ('signextend', 3, ('signextend', 3, ('signextend', 3, ('type', 224, ('field', 32, ('stor', ('map', ('stor', ('array', ('var', 0), ('name', 'stor4', 4))), ('name', 'unknown97d6958d', 2))))))))
      mem[[94m_17 + 64] = ('signextend', 3, ('signextend', 3, ('signextend', 3, ('type', 192, ('field', 64, ('stor', ('map', ('stor', ('array', ('var', 0), ('name', 'stor4', 4))), ('name', 'unknown97d6958d', 2))))))))
      mem[[94m_17 + 96] = uint32(unknown97d6958d[stor4[[94midx]].field_96)
      mem[[94m_17 + 128] = ('signextend', 1, ('signextend', 1, ('signextend', 1, ('type', 128, ('field', 128, ('stor', ('map', ('stor', ('array', ('var', 0), ('name', 'stor4', 4))), ('name', 'unknown97d6958d', 2))))))))
      mem[[94m_17 + 160] = uint16(unknown97d6958d[stor4[[94midx]].field_144)
      mem[[94m_17 + 192] = uint16(unknown97d6958d[stor4[[94midx]].field_160)
      mem[[94m_17 + 224] = uint16(unknown97d6958d[stor4[[94midx]].field_176)
      require uint8(unknown97d6958d[stor4[[94midx]].field_192) <= 4
      mem[[94m_17 + 256] = uint8(unknown97d6958d[stor4[[94midx]].field_192)
      if uint32(unknown97d6958d[stor4[[94midx]].field_96) != _param1:
          [94ms = [94m_17
          [94midx = [94midx + 1
          [94ms = [94ms
          continue 
      mem[mem[64] + 4] = ('signextend', 3, ('signextend', 3, ('signextend', 3, ('signextend', 3, ('field', 0, ('stor', ('map', ('stor', ('array', ('var', 0), ('name', 'stor4', 4))), ('name', 'unknown97d6958d', 2))))))))
      ...
      [93mdelegate 0xfe6134fa39466e8788ec310c2c1f3c2128c988be.abs(int256 val) with:
           gas gas_remaining wei
          args ('signextend', 3, ('signextend', 3, ('signextend', 3, ('signextend', 3, ('field', 0, ('stor', ('map', ('stor', ('array', ('var', 0), ('name', 'stor4', 4))), ('name', 'unknown97d6958d', 2))))))))
...
def unknownedc29637(uint256 _param1, uint256 _param2, uint256 _param3): # not payable
  ...
  if ext_call.return_data[12 len 20] != caller:
      revert with 0, '13'
  uint32(unknown97d6958d[_param1].field_32) = uint32(('signextend', 3, ('sdiv', ('param', '_param2'), 10000000000)))
  uint16(unknown97d6958d[_param1].field_176) = uint16(block.timestamp / 10^13)
  uint8(unknown97d6958d[_param1].field_192) = 2
  uint64(unknown97d6958d[_param1].field_192) = 0
  uint64(unknown97d6958d[_param1].field_192) = 0
  unknown97d6958d[_param1].field_256 % 1 = 0
  unknown97d6958d[_param1].field_256 % 1 = 0
  require ext_code.size(exchangeAddress)
  call exchangeAddress.0x2d8815c8 with:
     value _param3 wei
