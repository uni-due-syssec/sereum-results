...
#  addr = 0xeaF69021dCa44cC97070e74CA0b98880A2b17c16 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def upgradeTo(string _version, address _implementation): # not payable
  ...
  mem[ceil32(_version.length) + floor32(_version.length) + -(_version.length % 32) + 192 len _version.length % 32] = mem[-(_version.length % 32) + floor32(_version.length) + 160 len _version.length % 32]
