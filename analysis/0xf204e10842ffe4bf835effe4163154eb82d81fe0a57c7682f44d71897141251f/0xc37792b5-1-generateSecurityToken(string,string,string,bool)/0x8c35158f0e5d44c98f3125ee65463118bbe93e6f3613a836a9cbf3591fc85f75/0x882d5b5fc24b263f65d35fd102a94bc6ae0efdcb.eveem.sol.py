...
#  addr = 0x882d5b5fC24b263f65d35fD102A94BC6aE0efDCb 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
# const = None
# payable = False
def unknown50610f60(addr _param1): # not payable
  if owner[0x2016836a56b71f0d02689e69e326f4f4c1b9057164ef592671cf0d37c8040] != caller:
      revert with 0, 'sender must be owner'
  if not _param1:
      revert with 0, 32, 15, 0xf2496e76616c6964206164647265737300000000000000000000000000000000
  owner[0x56214915f470bc027680848613f0a4a305721ab60e22e18015b9c830b355cd] = _param1
...
def getSecurityTokenAddress(string _symbol): # not payable
  ...
  mem[64] = mem[64] + 64
  mem[[94m_41] = 21
  mem[[94m_41 + 32] = 0xb17469636b6572546f5365637572697479546f6b656e00000000000000000000
  [94m_45 = mem[64]
  mem[mem[64] + 32 len 0] = None
  mem[mem[64] + 32 len 21] = 0xb17469636b6572546f5365637572697479546f6b65
  [94m_78 = mem[96]
  ...
  mem[0] = sha3(mem[mem[64] len [94m_78 + [94m_45 + [94m_106 + -mem[64] + 53])
  mem[mem[64]] = owner[mem[0]]
  return owner[mem[0]]
