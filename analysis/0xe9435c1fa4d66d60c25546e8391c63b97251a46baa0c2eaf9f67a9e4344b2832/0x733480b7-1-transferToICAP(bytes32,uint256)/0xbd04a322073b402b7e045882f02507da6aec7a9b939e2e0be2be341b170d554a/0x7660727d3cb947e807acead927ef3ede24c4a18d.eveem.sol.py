...
def unknown1a9237de(uint256 _param1) payable: 
  ...
  return bool(uint8(stor4[ext_call.return_data[12 len 20]]))
...
def transferToICAP(bytes32 _icap, uint256 _value) payable: 
  if 0 == call.value:
      ...
      if ext_call.success:
          ...
          if uint8(stor4[ext_call.return_data[12 len 20]]):
              if caller == tx.origin:
...
def unknown8bbbbfd3(uint256 _param1) payable: 
  uint256(stor4[caller]) = _param1 or Mask(248, 8, uint256(stor4[caller]))
  return 1
...
def unknownbe9b42d2(addr _param1) payable: 
  return bool(uint8(stor4[addr(_param1)]))
...
def unknownf2ee5968(uint256 _param1) payable: 
  return bool(uint8(stor4[_param1]))
...
def unknownf77b8d7a(uint256 _param1) payable: 
  ...
  if addr(unknownaa46f961Address):
      return 0
  uint256(stor5) = _param1 or Mask(96, 160, uint256(stor5))
  return 1
