...
# const = None
# payable = False
def unknowna5b4e966(addr m_param1, bool m_param2): # not payable
  if not mstor0m[callerm]:
      require 0x825d5d0df3b2d59f69cc673f041ca91a296b8183 == caller
  addr(mstor1m.field_0) = m_param1
  Mask(96, 0, mstor1m.field_160) = Mask(96, 0, m_param2)
...
# const = None
# payable = False
def unknownadf48490(addr m_param1, bool m_param2): # not payable
  if not mstor0m[callerm]:
      require 0x825d5d0df3b2d59f69cc673f041ca91a296b8183 == caller
  mstor0m[addr(m_param1)m] = uint8(m_param2)
...
def _fallback() payable: # default function
  if not addr(mstor1m.field_0):
      require not uint256(mstor1m.field_0)
      stop
  [93mdelegate addr(mstor1m.field_0) with:
