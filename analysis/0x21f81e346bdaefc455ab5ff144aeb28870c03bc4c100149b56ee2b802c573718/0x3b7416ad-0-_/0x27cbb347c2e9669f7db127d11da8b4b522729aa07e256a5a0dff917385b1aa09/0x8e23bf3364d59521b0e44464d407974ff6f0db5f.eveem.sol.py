...
#  addr = 0x8E23bf3364D59521B0e44464d407974FF6f0dB5F 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def unknown7141f423(uint8 m_param1, uint32 m_param2, uint8 m_param3, array m_param4, array m_param5, bool m_param6) payable: 
  ...
  if not m_param6:
      ...
      if m_param4.length:
          ...
          call mmarketAddress.0x1974884f with:
               gas gas_remaining - 710 wei
              args caller, m_param6, Array(len=m_param4.length, data=call.data[m_param4 + 36 len floor32(m_param4.length)], mem[([94m_msize + 132) + (32 * m_param4.length) + floor32(m_param4.length) + 196 len (32 * m_param4.length) + (32 * mem[[94m_msize + 132]) + -floor32(m_param4.length) + 32]), (32 * m_param4.length) + 160
          require ext_call.success
