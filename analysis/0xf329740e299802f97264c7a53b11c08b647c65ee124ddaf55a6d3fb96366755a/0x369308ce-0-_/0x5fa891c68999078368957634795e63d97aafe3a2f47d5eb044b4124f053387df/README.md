# transaction 0x5fa891c68999078368957634795e63d97aafe3a2f47d5eb044b4124f053387df

[etherscan.io/tx](https://etherscan.io/tx/0x5fa891c68999078368957634795e63d97aafe3a2f47d5eb044b4124f053387df)
...
* called functions:
    * fsig: 313ce567, ether: 0 wei, count: 13
        ...
        * `decimals()`
    * fsig: 70a08231, ether: 0 wei, count: 48
    ...
    * fsig: 23b872dd, ether: 0 wei, count: 6
...
* called functions:
    ...
    * `getOffer(uint256)`, fsig: 4579268a, ether: 0 wei, count: 12
...
* contract didn't send ether
* received 0.4737601429029794 ether (473760142902979412 wei)
    * from 0x240fe85447a878f51a74a5dc0b644b4a72587839; 0 wei
    * from 0x14094949152eddbfcd073717200da82fed8dc960; 473760142902979412 wei
...
* called functions:
    ...
    * fsig: 23b872dd, ether: 0 wei, count: 2
        * `transferFrom(address,address,uint256)`
        * `gasprice_bit_ether(int128)`
    * `deposit()`, fsig: d0e30db0, ether: 473760142902979412 wei, count: 1
...
* contract didn't send ether
* received 0.9454640642486263 ether (945464064248626243 wei)
    * from 0x240fe85447a878f51a74a5dc0b644b4a72587839; 0 wei
    * from 0x14094949152eddbfcd073717200da82fed8dc960; 945464064248626243 wei
...
* called functions:
    ...
    * `fallback`, fsig: , ether: 945464064248626243 wei, count: 2
...
### Contract at 0x240fe85447a878f51a74a5dc0b644b4a72587839

* [etherscan](https://etherscan.io/address/0x240fe85447a878f51a74a5dc0b644b4a72587839)
* [contract-library](https://contract-library.com/contracts/Ethereum/240fe85447a878f51a74a5dc0b644b4a72587839)
* sent 1.0423397904398264 ether (1042339790439826243 wei)
    * to 0xf20dab577269dc26429079d5796f204c2f90229e; 96875726191200000 wei
    * to 0x9ae49c0d7f8f9ef4b864e004fe86ac8294e20950; 0 wei
    * to 0xb87304fbd18e669b932695d77cefdee0e8e7a6f1; 0 wei
    * to 0x57f8160e1c59d16c01bbe181fd94db4e56b60495; 473760142902979412 wei
    ...
    * to 0x5d154c145db2ca90b8ab5e8fe3e716afa4ab7ff0; 471703921345646831 wei
...
* received 0.028112657610602904 ether (28112657610602902 wei)
    * from 0xf20dab577269dc26429079d5796f204c2f90229e; 28112657610602902 wei
* called functions:
    * `fallback`, fsig: , ether: 28112657610602902 wei, count: 1
...
* sent 1.8909281284972526 ether (1890928128497252486 wei)
    * to 0x9ae49c0d7f8f9ef4b864e004fe86ac8294e20950; 945464064248626243 wei
    * to 0x57f8160e1c59d16c01bbe181fd94db4e56b60495; 471703921345646831 wei
    * to 0x21433dec9cb634a23c6a4bbcce08c83f5ac2ec18; 0 wei
    ...
    * to 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2; 473760142902979412 wei
    * to 0x52166528fcc12681af996e409ee3a421a4e128a3; 0 wei
...
* contract didn't send ether
* received 0.9454640642486263 ether (945464064248626243 wei)
    * from 0x14094949152eddbfcd073717200da82fed8dc960; 471703921345646831 wei
    * from 0x240fe85447a878f51a74a5dc0b644b4a72587839; 473760142902979412 wei
* called functions:
    * `getConversionRate(address,address,uint256,uint256)`, fsig: 7cd44272, ether: 0 wei, count: 6
    * `fallback`, fsig: , ether: 471703921345646831 wei, count: 1
    * `trade(address,uint256,address,address,uint256,bool)`, fsig: 6cf69811, ether: 473760142902979412 wei, count: 2
...
* contract didn't send ether
* received 0.47170392134564687 ether (471703921345646831 wei)
    * from 0x14094949152eddbfcd073717200da82fed8dc960; 0 wei
    * from 0x240fe85447a878f51a74a5dc0b644b4a72587839; 471703921345646831 wei
* called functions:
    * `getConversionRate(address,address,uint256,uint256)`, fsig: 7cd44272, ether: 0 wei, count: 6
    * `trade(address,uint256,address,address,uint256,bool)`, fsig: 6cf69811, ether: 471703921345646831 wei, count: 2
...
* called functions:
    ...
    * `buyVolumes(address,address)`, fsig: b8beafd6, ether: 0 wei, count: 6
    * `sellVolumesCurrent(address,address)`, fsig: b64c4905, ether: 0 wei, count: 6
...
* didn't receive any ether
* called functions:
    * `getEthToTokenInputPrice(uint256)`, fsig: cd7724c3, ether: 0 wei, count: 6
    * `getTokenToEthInputPrice(uint256)`, fsig: 95b68fe7, ether: 0 wei, count: 6
...
* didn't receive any ether
* called functions:
    * `getFirstOrder()`, fsig: a3fb5917, ether: 0 wei, count: 2
...
* didn't receive any ether
* called functions:
    * `kncPerEthRatePrecision()`, fsig: 30125416, ether: 0 wei, count: 3
...
* contract didn't send ether
* received 0.0687630685805971 ether (68763068580597098 wei)
    * from 0xf20dab577269dc26429079d5796f204c2f90229e; 68763068580597098 wei
* called functions:
    * `fallback`, fsig: , ether: 68763068580597098 wei, count: 1
...
* didn't receive any ether
* called functions:
    * `fallback`, fsig: , ether: 0 wei, count: 26
...
* sent 0.0968757261912 ether (96875726191200000 wei)
    * to 0x818e6fecd516ecc3849daf6845e3ec868087b755; 0 wei
    * to 0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359; 0 wei
    * to 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2; 0 wei
    * to 0x6d20ea6fe6d67363684e22f1485712cfdccf177a; 0 wei
    * to 0x14094949152eddbfcd073717200da82fed8dc960; 0 wei
    * to 0xadff3ada12ed0f8a87e31e5a04dfd2ee054e1118; 68763068580597098 wei
    * to 0x240fe85447a878f51a74a5dc0b644b4a72587839; 28112657610602902 wei
* received 0.0968757261912 ether (96875726191200000 wei)
    * from 0x1cf226e9413addaf22412a2e182f9c0de44af002; 0 wei
    * from 0x240fe85447a878f51a74a5dc0b644b4a72587839; 96875726191200000 wei
* called functions:
    ...
    * `fallback`, fsig: , ether: 96875726191200000 wei, count: 1
