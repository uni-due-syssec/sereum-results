...
#  addr = 0x826a3E8c9eDa6ac613820Ac9E62f8579495Cd262 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {'0x3ad97167': 'unknown3ad97167(?)'} 
...
def storage:
    ...
    # storage address 
...
# const = None
# payable = True
def unknownbc6cb1d9(addr _param1, addr _param2, addr _param3, uint256 _param4, uint256 _param5) payable: 
  ...
  if _param1 == _param2:
      if not _param4:
          return 0
      if _param5 * _param4 / _param4 == _param5:
          return (_param5 * _param4 / 100 * 10^18)
  else:
      require ext_code.size(oracle[addr(_param3)])
      static call oracle[addr(_param3)].0x6599aa0 with:
              gas gas_remaining wei
             args addr(_param2), addr(_param1), -1
      ...
      if not _param4:
          if ext_call.return_data[0]:
              if not 0 / ext_call.return_data[0]:
                  return 0
              if _param5 * 0 / ext_call.return_data[0] / 0 / ext_call.return_data[0] == _param5:
                  return (_param5 * 0 / ext_call.return_data[0] / 100 * 10^18)
      else:
          if ext_call.return_data[32] * _param4 / _param4 == ext_call.return_data[32]:
              if ext_call.return_data[0]:
                  if not ext_call.return_data[32] * _param4 / ext_call.return_data[0]:
                      return 0
                  if _param5 * ext_call.return_data[32] * _param4 / ext_call.return_data[0] / ext_call.return_data[32] * _param4 / ext_call.return_data[0] == _param5:
                      return (_param5 * ext_call.return_data[32] * _param4 / ext_call.return_data[0] / 100 * 10^18)
  revert
...
def initialize(address _sender) payable: 
  ...
  stor39[Mask(32, 224, ('name', 'storFE74', 722451036002241573226410228405555561871897501043851714567111811126951904489942890102866865452079247429323756652345794710893848681538931))] = _sender
  stor39[Mask(32, 224, ('name', 'stor2967', 33088650053044380572303764676551563603271914284397562960608823521969740999305597751209961058839020842085210901366461635376146275973046168097127544118))] = _sender
  stor39[Mask(32, 224, ('name', 'stor2967', 117554499645942628486616874046308736385877385038920198766170314965392792939247392239937784664780037498358293656232985177139990670488886))] = _sender
...
# const = None
# payable = True
def unknownf3d75a9c(addr _param1, addr _param2, addr _param3, uint256 _param4, uint256 _param5) payable: 
  require calldata.size - 4 >=′ 160
  if not _param5:
      return 0
  if _param1 == _param2:
      if not _param4:
          ...
          if 100 * 10^18 * _param4 / _param4 == 100 * 10^18:
              if _param5:
                  return (100 * 10^18 * _param4 / _param5)
  else:
      require ext_code.size(oracle[addr(_param3)])
      static call oracle[addr(_param3)].0x6599aa0 with:
              gas gas_remaining wei
      ...
      if not _param4:
          if _param5:
              if not 0 / _param5:
                  ...
                  if ext_call.return_data[0] * 0 / _param5 / 0 / _param5 == ext_call.return_data[0]:
                      if ext_call.return_data[32]:
                          return (ext_call.return_data[0] * 0 / _param5 / ext_call.return_data[32])
      else:
          if 100 * 10^18 * _param4 / _param4 == 100 * 10^18:
              if _param5:
                  if not 100 * 10^18 * _param4 / _param5:
                      if ext_call.return_data[32]:
                          return (0 / ext_call.return_data[32])
                  else:
                      if ext_call.return_data[0] * 100 * 10^18 * _param4 / _param5 / 100 * 10^18 * _param4 / _param5 == ext_call.return_data[0]:
                          if ext_call.return_data[32]:
                              return (ext_call.return_data[0] * 100 * 10^18 * _param4 / _param5 / ext_call.return_data[32])
  revert
