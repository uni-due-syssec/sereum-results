...
#  addr = 0xFeC50e1E7Ec3A262195a8801335393289059ba26 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def tokensWithAmount(): # not payable
  if tokens.length:
      mem[128 len 32 * tokens.length] = code.data[23501 len 32 * tokens.length]
  [94midx = 0
  [94ms = 0
  while [94midx < tokens.length:
      mem[0] = 9
  ...
  if [94ms:
      mem[(32 * tokens.length) + 160 len 32 * [94ms] = code.data[23501 len 32 * [94ms]
  [94midx = 0
  [94mt = 0
  while [94midx < tokens.length:
      require [94midx < tokens.length
