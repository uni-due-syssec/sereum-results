...
def substring(string _str, uint256 _startIndex, uint256 _endIndex): # not payable
  ...
  mem[ceil32(_str.length) + 160 len 32 * _endIndex - _startIndex] = code.data[7591 len 32 * _endIndex - _startIndex]
  [94midx = _startIndex
  while [94midx < _endIndex:
      require [94midx < mem[96]
      require [94midx - _startIndex < mem[ceil32(_str.length) + 128]
...
def unknown4112987c(array _param1, array _param2, array _param3): # not payable
  ...
  if _param1.length + _param2.length + _param3.length:
      mem[ceil32(_param1.length) + ceil32(_param2.length) + ceil32(_param3.length) + 288 len 32 * _param1.length + _param2.length + _param3.length] = code.data[7591 len 32 * _param1.length + _param2.length + _param3.length]
  [94midx = 0
  [94ms = 0
  while [94midx < _param1.length:
      require [94midx < _param1.length
  ...
  while [94midx < 0:
      ...
      [94ms = [94ms + 1
      continue 
  mem[ceil32(_param1.length) + ceil32(_param2.length) + ceil32(_param3.length) + floor32(_param1.length + _param2.length + _param3.length + 31) + 352 len floor32(_param1.length + _param2.length + _param3.length + 31)] = mem[ceil32(_param1.length) + ceil32(_param2.length) + ceil32(_param3.length) + 288 len floor32(_param1.length + _param2.length + _param3.length + 31)]
  return Array(len=_param1.length + _param2.length + _param3.length, data=mem[ceil32(_param1.length) + ceil32(_param2.length) + ceil32(_param3.length) + floor32(_param1.length + _param2.length + _param3.length + 31) + 352 len _param1.length + _param2.length + _param3.length]), 
...
def unknownff74927b(array _param1, array _param2): # not payable
  ...
  if not _param1.length + _param2.length:
      ...
      while [94midx < mem[ceil32(_param1.length) + ceil32(_param2.length) + 192]:
          ...
          [94ms = [94ms + 1
          continue 
      [94m_234 = mem[ceil32(_param1.length) + ceil32(_param2.length) + 224]
      [94midx = 0
      [94ms = _param1.length + mem[ceil32(_param1.length) + 128] + mem[ceil32(_param1.length) + ceil32(_param2.length) + 192]
      while [94midx < [94m_234:
  ...
  mem[ceil32(_param1.length) + ceil32(_param2.length) + 288 len 32 * _param1.length + _param2.length] = code.data[7591 len 32 * _param1.length + _param2.length]
  [94midx = 0
  [94ms = 0
  while [94midx < _param1.length:
      require [94midx < _param1.length
