...
#  addr = 0x8A511e355e4233F0ab14CdDbc1dD60a80a349f8B 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def substring(string m_str, uint256 m_startIndex, uint256 m_endIndex): # not payable
  ...
  mem[ceil32(m_str.length) + 160 len 32 * m_endIndex - m_startIndex] = code.data[7591 len 32 * m_endIndex - m_startIndex]
  [94midx = m_startIndex
  mwhile [94midx < m_endIndexm:
      require [94midx < mem[96]
      require [94midx - m_startIndex < mem[ceil32(m_str.length) + 128]
  ...
  return 32, mem[mem[64] + 32 len floor32([94m_32) + 64]
...
def unknown4112987c(array m_param1, array m_param2, array m_param3): # not payable
  ...
  if m_param1.length + m_param2.length + m_param3.length:
      mem[ceil32(m_param1.length) + ceil32(m_param2.length) + ceil32(m_param3.length) + 288 len 32 * m_param1.length + m_param2.length + m_param3.length] = code.data[7591 len 32 * m_param1.length + m_param2.length + m_param3.length]
  [94midx = 0
  [94ms = 0
  mwhile [94midx < m_param1.lengthm:
      require [94midx < m_param1.length
  ...
  mwhile [94midx < m_param2.lengthm:
      ...
      mcontinue 
  [94midx = 0
  [94ms = m_param1.length + m_param2.length
  mwhile [94midx < m_param3.lengthm:
      ...
      mcontinue 
  [94midx = 0
  [94ms = m_param1.length + m_param2.length + m_param3.length
  mwhile [94midx < 0m:
      require [94midx < 0
      require [94ms < m_param1.length + m_param2.length + m_param3.length
  ...
  mwhile [94midx < 0m:
      ...
      [94ms = [94ms + 1
      mcontinue 
  mem[ceil32(m_param1.length) + ceil32(m_param2.length) + ceil32(m_param3.length) + floor32(m_param1.length + m_param2.length + m_param3.length + 31) + 352 len floor32(m_param1.length + m_param2.length + m_param3.length + 31)] = mem[ceil32(m_param1.length) + ceil32(m_param2.length) + ceil32(m_param3.length) + 288 len floor32(m_param1.length + m_param2.length + m_param3.length + 31)]
  return Array(len=m_param1.length + m_param2.length + m_param3.length, data=mem[ceil32(m_param1.length) + ceil32(m_param2.length) + ceil32(m_param3.length) + floor32(m_param1.length + m_param2.length + m_param3.length + 31) + 352 len m_param1.length + m_param2.length + m_param3.length]), 
...
# const = None
# payable = False
def unknown44525ace(uint8 m_param1, uint256 m_param2): # not payable
  if m_param1 != 2:
      if m_param1 != 3:
          if m_param1 != 4:
              if m_param1 != 5:
                  if m_param2 <=′ 0:
                      return (-100000 * -m_param2 + 99999 /′ 100000)
                  return (100000 * m_param2 + 99999 /′ 100000)
          else:
              if m_param1 != 5:
                  if m_param2 <=′ 0:
                      return (-100 * -m_param2 + 99 /′ 100)
                  return (100 * m_param2 + 99 /′ 100)
      else:
          if m_param1 != 4:
              if m_param1 != 5:
                  if m_param2 <=′ 0:
                      return (-1000 * -m_param2 + 999 /′ 1000)
                  return (1000 * m_param2 + 999 /′ 1000)
          else:
              if m_param1 != 5:
                  if m_param2 <=′ 0:
      ...
      if m_param1 != 3:
          if m_param1 != 4:
              if m_param1 != 5:
                  if m_param2 <=′ 0:
                      return (-10000 * -m_param2 + 9999 /′ 10000)
                  return (10000 * m_param2 + 9999 /′ 10000)
          else:
              if m_param1 != 5:
                  if m_param2 <=′ 0:
...
def unknown997bc6c9(uint256 m_param1): # not payable
  ...
  if m_param1 <′ 0:
      ...
      if m_param1 >=′ 0:
          ...
          if [94ms:
              mem[128 len 32 * [94ms] = code.data[7591 len 32 * [94ms]
          [94mt = [94ms - 1
          [94midx = -m_param1
          mwhile [94midxm:
              require [94mt < mem[96]
          ...
          if [94ms + 1:
              mem[128 len 32 * [94ms + 1] = code.data[7591 len 32 * [94ms + 1]
          [94mt = [94ms
          [94midx = -m_param1
          mwhile [94midxm:
              require [94mt < mem[96]
...
def unknownff74927b(array m_param1, array m_param2): # not payable
  ...
  if not m_param1.length + m_param2.length:
      ...
      mwhile [94midx < mem[ceil32(m_param1.length) + ceil32(m_param2.length) + 192]m:
          ...
          [94ms = [94ms + 1
          mcontinue 
      [94m_234 = mem[ceil32(m_param1.length) + ceil32(m_param2.length) + 224]
      [94midx = 0
      [94ms = m_param1.length + mem[ceil32(m_param1.length) + 128] + mem[ceil32(m_param1.length) + ceil32(m_param2.length) + 192]
      ...
      return 32, mem[mem[64] + 32 len floor32([94m_244) + 64]
  mem[ceil32(m_param1.length) + ceil32(m_param2.length) + 288 len 32 * m_param1.length + m_param2.length] = code.data[7591 len 32 * m_param1.length + m_param2.length]
  [94midx = 0
  [94ms = 0
  mwhile [94midx < m_param1.lengthm:
      require [94midx < m_param1.length
  ...
  mwhile [94midx < mem[ceil32(m_param1.length) + ceil32(m_param2.length) + 192]m:
      ...
      mcontinue 
  [94midx = 0
  [94ms = m_param1.length + mem[ceil32(m_param1.length) + 128] + [94m_205
