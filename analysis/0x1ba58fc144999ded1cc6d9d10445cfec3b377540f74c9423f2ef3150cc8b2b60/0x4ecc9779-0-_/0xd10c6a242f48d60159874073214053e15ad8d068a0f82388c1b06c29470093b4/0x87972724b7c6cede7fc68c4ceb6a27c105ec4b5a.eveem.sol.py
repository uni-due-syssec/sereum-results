...
#  addr = 0x87972724b7C6CedE7fC68C4CeB6a27C105eC4B5a 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def storage:
    ...
    unknownd0817501
    # storage address 24
    unknownda0eac05 # mask: a s
    # storage address 25
    unknown916df7e4 # mask: a s
    # storage address 26
    ...
    # storage address 33
    unknownefde7d9b
    # storage address 97569884605916225051403212656556507955018248777258318895762758024193532305078
    stor97569884605916225051403212656556507955018248777258318895762758024193532305078
    # storage address 97569884605916225051403212656556507955018248777258318895762758024193532305079
    stor97569884605916225051403212656556507955018248777258318895762758024193532305079
    # storage address 97569884605916225051403212656556507955018248777258318895762758024193532305080
    stor97569884605916225051403212656556507955018248777258318895762758024193532305080
    # storage address 97569884605916225051403212656556507955018248777258318895762758024193532305081
    stor97569884605916225051403212656556507955018248777258318895762758024193532305081
    # storage address 97569884605916225051403212656556507955018248777258318895762758024193532305082
    stor97569884605916225051403212656556507955018248777258318895762758024193532305082
# hash = 0x12065fe0
# getter = None
...
# hash = 0x34e61612
# getter = ['storage', 160, 0, ['sha3', ['data', ['cd', 36], ['sha3', ['data', ['cd', 4], 15]]]]]
# const = None
# payable = False
...
def unknown4ecc9779(uint256 _param1, uint256 _param2) payable: 
  ...
  require ext_code.size(unknownfaa9efe3[stor13[_param1].field_0])
  call unknownfaa9efe3[stor13[_param1].field_0].0xef98ffb5 with:
  ...
  if ext_call.return_data[0] > unknownb3fa871a[stor13[_param1].field_0]:
      revert with 0, 'pool not enough'
  unknownb3fa871a[stor13[_param1].field_0] -= ext_call.return_data[0]
  call caller with:
     value ext_call.return_data[0] wei
       gas 2300 * is_zero(value) wei
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require tokenPrice[stor13[_param1].field_0]
  ...
  if ext_call.return_data[64]:
      call unknownee483063[_param1].field_0.0xd5078158 with:
           gas gas_remaining wei
          args caller, unknowne57fb80e[stor13[_param1].field_0], call.value * 10^decimals * unknown8215c67f[stor13[_param1].field_0] / 10000 / tokenPrice[stor13[_param1].field_0]
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      unknownee483063.length++
      unknownee483063[unknownee483063.length].field_0 = unknownee483063[_param1].field_0
      storD7B6[stor13.length] = caller
      storD7B6[stor13.length] = call.value
      storD7B6[stor13.length] = block.timestamp
      storD7B6[stor13.length] = 0
      storD7B6[stor13.length] = 1
      log 0x1e4558e8: unknownee483063.length + 1, call.value, block.timestamp, unknownee483063[_param1].field_0, caller
      unknown98f5d445[stor13[_param1].field_0][caller] = call.value
      unknown17ff16e2[stor13[_param1].field_0][caller] += call.value
      unknownf3d2135c[stor13[_param1].field_0] += unknown8be11840[stor13[_param1].field_0] * call.value / 10000
      require ext_code.size(unknownfaa9efe3[stor13[_param1].field_0])
      call unknownfaa9efe3[stor13[_param1].field_0].0x13de5b49 with:
           gas gas_remaining wei
          args unknownee483063[_param1].field_0, caller, call.value
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      unknownb3fa871a[stor13[_param1].field_0] += call.value
  call unknownee483063[_param1].field_0.0xd5078158 with:
       gas gas_remaining wei
      args caller, unknowne57fb80e[stor13[_param1].field_0], ext_call.return_data[0] * 10^decimals * unknown8b8edd03[stor13[_param1].field_0] / 10000 / tokenPrice[stor13[_param1].field_0]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  log 0x63ba7464: _param1, ext_call.return_data[0], block.timestamp, unknownee483063[_param1].field_0, caller
  unknowne4fed460[stor13[_param1].field_0][caller] += ext_call.return_data[0]
...
def unknown4fab3bad(addr _param1, addr _param2): # not payable
  return unknownea21a85d[addr(_param1)][addr(_param2)], 
         ...
         bool(stor29[addr(_param1)][addr(_param2)])
...
# hash = 0x5bab7bae
# getter = ['bool', ['storage', 8, 0, ['sha3', ['data', ['cd', 36], ['sha3', ['data', ['cd', 4], 29]]]]]]
# const = None
# payable = False
def unknown5bab7bae(addr _param1, addr _param2): # not payable
  return bool(stor29[_param1][_param2])
...
def unknown66f7900f(addr _param1) payable: 
  if bool(stor7[addr(_param1)]) != 1:
      revert with 0, 'ilegal token'
  if call.value < unknown916df7e4:
      revert with 0, 'msg value is not right'
  if call.value > unknowne2603c30:
      revert with 0, 'msg value is not right'
  if eth.balance(this.address) > unknownda0eac05:
  ...
  call _param1.0xd5078158 with:
       gas gas_remaining wei
      args caller, unknowne57fb80e[addr(_param1)], call.value * 10^decimals * unknown8215c67f[addr(_param1)] / 10000 / tokenPrice[addr(_param1)]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  unknownee483063.length++
  unknownee483063[unknownee483063.length].field_0 = _param1
  storD7B6[stor13.length] = caller
  storD7B6[stor13.length] = call.value
  storD7B6[stor13.length] = block.timestamp
  storD7B6[stor13.length] = 0
  storD7B6[stor13.length] = 1
  log 0x1e4558e8: unknownee483063.length + 1, call.value, block.timestamp, _param1, caller
  unknown98f5d445[addr(_param1)][caller] = call.value
  unknown17ff16e2[addr(_param1)][caller] += call.value
  unknownf3d2135c[addr(_param1)] += unknown8be11840[addr(_param1)] * call.value / 10000
  require ext_code.size(unknownfaa9efe3[addr(_param1)])
  call unknownfaa9efe3[addr(_param1)].0x13de5b49 with:
       gas gas_remaining wei
      args addr(_param1), caller, call.value
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  unknownb3fa871a[addr(_param1)] += call.value
...
def unknown67565017(addr _param1, addr _param2) payable: 
  ...
  call _param2.0xd5078158 with:
       gas gas_remaining wei
      args caller, unknowne57fb80e[addr(_param2)], call.value * 10^decimals * unknown8215c67f[addr(_param2)] / 10000 / tokenPrice[addr(_param2)]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  unknownee483063.length++
  unknownee483063[unknownee483063.length].field_0 = _param2
  storD7B6[stor13.length] = caller
  storD7B6[stor13.length] = call.value
  storD7B6[stor13.length] = block.timestamp
  storD7B6[stor13.length] = 0
  storD7B6[stor13.length] = 1
  log 0x1e4558e8: unknownee483063.length + 1, call.value, block.timestamp, _param2, caller
  unknown98f5d445[addr(_param2)][caller] = call.value
  unknown17ff16e2[addr(_param2)][caller] += call.value
  unknownf3d2135c[addr(_param2)] += unknown8be11840[addr(_param2)] * call.value / 10000
  require ext_code.size(unknownfaa9efe3[addr(_param2)])
  call unknownfaa9efe3[addr(_param2)].0x13de5b49 with:
       gas gas_remaining wei
      args addr(_param2), caller, call.value
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  unknownb3fa871a[addr(_param2)] += call.value
...
def unknown6a6d42b3(addr _param1, uint256 _param2): # not payable
  ...
  if bool(stor29[addr(_param1)][caller]) != 1:
...
def unknown78f5baa9(uint256 _param1, uint256 _param2, uint256 _param3): # not payable
  ...
  if unknownf51efd7a[caller] < unknown585c5b83[mem[207 len 15]]:
      revert with 0, 'permission deny'
  unknownda0eac05 = _param1
  unknown916df7e4 = _param2
  unknowne2603c30 = _param3
...
def unknown838eea99(uint256 _param1, addr _param2): # not payable
  ...
  call _param2.0xd5078158 with:
       gas gas_remaining wei
      args caller, unknowne57fb80e[addr(_param2)], _param1 * 10^decimals * unknown8b8edd03[addr(_param2)] / 10000 / tokenPrice[addr(_param2)]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
...
# const = None
# payable = False
def unknown916df7e4(): # not payable
  return unknown916df7e4


# hash = 0x98f5d445
# getter = ['storage', 256, 0, ['sha3', ['data', ['cd', 36], ['sha3', ['data', ['cd', 4], 21]]]]]
# const = None
# payable = False
...
# const = None
# payable = False
def unknownda0eac05(): # not payable
  return unknownda0eac05
...
# const = None
# payable = False
def unknowndc160e92(addr _param1, bool _param2, uint256 _param3, addr _param4, addr _param5, uint256 _param6, uint256 _param7, uint256 _param8, uint256 _param9): # not payable
  mem[207 len 0] = None
...
def unknownedfb2ff3(addr _param1, addr _param2, bool _param3): # not payable
  ...
  if unknownf51efd7a[caller] < unknown585c5b83[mem[211 len 19]]:
      revert with 0, 'permission deny'
  stor29[addr(_param1)][addr(_param2)] = uint8(_param3)
...
# hash = 0xf3d2135c
# getter = ['storage', 256, 0, ['sha3', ['data', ['cd', 4], 31]]]
# const = None
# payable = False
