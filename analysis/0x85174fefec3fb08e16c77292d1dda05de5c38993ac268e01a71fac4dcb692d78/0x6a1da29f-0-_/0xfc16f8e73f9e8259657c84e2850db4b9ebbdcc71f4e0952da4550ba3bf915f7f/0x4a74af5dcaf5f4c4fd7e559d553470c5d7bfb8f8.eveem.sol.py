...
#  addr = 0x4A74Af5dCaf5F4C4FD7e559D553470c5D7BFb8f8 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def cancel(address m_tag): # not payable
  require ext_code.size(0x5783623404442da4448c7f166ca724436b2bd14c)
  [93mdelegate 0x5783623404442da4448c7f166ca724436b2bd14c.0xe0c703dc with:
...
def unknown5a0cf9f3(addr m_param1) payable: 
  require ext_code.size(0x5783623404442da4448c7f166ca724436b2bd14c)
  [93mdelegate 0x5783623404442da4448c7f166ca724436b2bd14c.0x29f2e907 with:
       gas gas_remaining - 710 wei
...
def unknown79599f96(): # not payable
  require ext_code.size(0x5783623404442da4448c7f166ca724436b2bd14c)
  [93mdelegate 0x5783623404442da4448c7f166ca724436b2bd14c.0xd30d447d with:
       gas gas_remaining - 710 wei
      args 0
  require delegate.return_code
...
def unknown7e102b2a(bool m_param1): # not payable
  require ext_code.size(0x5783623404442da4448c7f166ca724436b2bd14c)
  [93mdelegate 0x5783623404442da4448c7f166ca724436b2bd14c.0xf5471307 with:
       gas gas_remaining - 710 wei
      args 0, m_param1
  require delegate.return_code
...
def unknownb82a0978(addr m_param1, uint256 m_param2): # not payable
  require ext_code.size(0x5783623404442da4448c7f166ca724436b2bd14c)
  [93mdelegate 0x5783623404442da4448c7f166ca724436b2bd14c.0xfe7a0fb9 with:
       gas gas_remaining - 710 wei
...
def unknownd9a96852(addr m_param1, uint32 m_param2): # not payable
  require ext_code.size(0x5783623404442da4448c7f166ca724436b2bd14c)
  [93mdelegate 0x5783623404442da4448c7f166ca724436b2bd14c.0xa8b7983 with:
       gas gas_remaining - 710 wei
