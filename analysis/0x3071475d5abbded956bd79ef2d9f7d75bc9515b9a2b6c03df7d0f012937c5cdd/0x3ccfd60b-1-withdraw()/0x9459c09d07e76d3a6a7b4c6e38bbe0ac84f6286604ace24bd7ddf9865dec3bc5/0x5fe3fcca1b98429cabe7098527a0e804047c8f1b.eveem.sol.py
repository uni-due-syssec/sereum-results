...
#  addr = 0x5fE3fCcA1b98429CaBE7098527A0E804047C8f1b 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def tokensWithAmount(): # not payable
  if tokens.length:
      mem[128 len 32 * tokens.length] = code.data[22653 len 32 * tokens.length]
  [94midx = 0
  [94ms = 0
  ...
  if [94ms:
      mem[(32 * tokens.length) + 160 len 32 * [94ms] = code.data[22653 len 32 * [94ms]
  [94midx = 0
  [94mt = 0
  while [94midx < tokens.length:
      require [94midx < tokens.length
