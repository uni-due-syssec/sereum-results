...
# const = None
# payable = False
def unknown27600936(bool _param1): # not payable
  require calldata.size - 4 >= 32
  require stor12[caller]
  stor10 = Mask(248, 0, _param1)
...
def unknown97bbb5bc(uint256 _param1): # not payable
  ...
  return unknown97bbb5bc[_param1]
...
def unknowne2c2f4ac(uint256 _param1): # not payable
  require calldata.size - 4 >= 32
  require _param1 < unknowne2c2f4ac.length
  return unknowne2c2f4ac[_param1]
