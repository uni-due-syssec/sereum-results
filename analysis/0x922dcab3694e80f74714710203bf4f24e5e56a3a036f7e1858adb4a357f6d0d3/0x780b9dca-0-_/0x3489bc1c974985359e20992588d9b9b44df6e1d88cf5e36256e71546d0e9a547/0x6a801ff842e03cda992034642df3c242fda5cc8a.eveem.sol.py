...
def unknown67988182(addr m_param1, uint256 m_param2): # not payable
  ...
  require uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136))m]m.field_0) <= 5
  if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136))m]m.field_0) == 5:
  ...
  static call mdistributorAddress.0x1cdb3a4e with:
          gas gas_remaining wei
         args addr(this.address), mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136))m]m.field_256, addr(m_param1), 192, 256, 1, 1, mem[836], 1, mem[900]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  ...
  if uint8(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_0) == 1:
      require uint64(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_136) < mroundsm.length
      require uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136))m]m.field_8) <= 2
      if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136))m]m.field_8) != 2:
          require m_param2 < munknown264be753m[addr(m_param1)m]m.field_0
      ...
      require uint8(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_0) <= 5
      require m_param2 < munknown264be753m[addr(m_param1)m]m.field_0
      if uint8(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_0) != uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136))m]m.field_0):
          if not uint8(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_216):
              require uint128(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_8) + munknown7952ea9d >= munknown7952ea9d
              munknown7952ea9d += uint128(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_8)
          munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_208 % 281474976710656 = 1
...
def getBet(address m_player, uint256 m_game): # not payable
  ...
  if uint8(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0) == 1:
      if uint64(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_136) < mroundsm.length:
          if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_8) <= 2:
              if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_8) != 2:
                  if uint8(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0) <= 5:
                      if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_0) <= 5:
                          return uint64(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0), 
                                 ...
                                 uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_0),
                                 0
              else:
                  if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_0) <= 5:
                      if uint8(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0) <= 5:
                          if uint8(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0) != uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_0):
                              if uint8(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0) <= 5:
                                  if uint8(mroundsm[2 * uint64(uint64(mstor29m[addr(m_player)m]m[m_gamem]m.field_136))m]m.field_0) <= 5:
                                      return uint64(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0), 
                                             uint8(munknown264be753m[addr(m_player)m]m[m_gamem]m.field_0),
...
def unknowna8e14f65(addr m_param1, uint256 m_param2): # not payable
  ...
  require m_param2 < munknown264be753m[addr(m_param1)m]m.field_0
  require uint64(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_136) < mroundsm.length
  require uint8(mroundsm[uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136)m]m.field_8) <= 2
  if uint8(mroundsm[uint64(mstor29m[addr(m_param1)m]m[m_param2m]m.field_136)m]m.field_8) != 2:
      return 0
  return 1
...
def unknownf25b7675(addr m_param1): # not payable
  ...
  if uint8(munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0) == 1:
      return mroundsm[2 * uint64(uint64(mstor29m[addr(m_param1)m]m[mstor29m[addr(m_param1)m]m.field_0m]m.field_0))m]m.field_256, 
