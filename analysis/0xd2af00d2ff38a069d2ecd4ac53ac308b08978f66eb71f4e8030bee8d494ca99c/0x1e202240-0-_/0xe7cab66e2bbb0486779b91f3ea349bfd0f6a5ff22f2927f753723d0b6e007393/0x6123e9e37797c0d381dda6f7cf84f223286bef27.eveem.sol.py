...
#  addr = 0x6123E9E37797c0D381dDa6f7cf84F223286bEf27 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {'0x8b851665': 'unknown8b851665(?)'} 
...
def storage:
    ...
    # storage address 40
    stor40
    # storage address 
    # storage address 
    # storage address 
# hash = 0x093983bd
...
# const = None
# payable = True
def unknownbc6cb1d9(addr m_param1, addr m_param2, addr m_param3, uint256 m_param4, uint256 m_param5) payable: 
  ...
  if m_param1 == m_param2:
      if not m_param4:
          return 0
      if m_param5 * m_param4 / m_param4 == m_param5:
          return (m_param5 * m_param4 / 100 * 10^18)
  else:
      require ext_code.size(moraclem[addr(m_param3)m])
      static call moraclem[addr(m_param3)m].0x6599aa0 with:
              gas gas_remaining wei
             args addr(m_param2), addr(m_param1), -1
      ...
      if not m_param4:
          if ext_call.return_data[0]:
              if not 0 / ext_call.return_data[0]:
                  return 0
              if m_param5 * 0 / ext_call.return_data[0] / 0 / ext_call.return_data[0] == m_param5:
                  return (m_param5 * 0 / ext_call.return_data[0] / 100 * 10^18)
      else:
          if ext_call.return_data[32] * m_param4 / m_param4 == ext_call.return_data[32]:
              if ext_call.return_data[0]:
                  if not ext_call.return_data[32] * m_param4 / ext_call.return_data[0]:
                      return 0
                  if m_param5 * ext_call.return_data[32] * m_param4 / ext_call.return_data[0] / ext_call.return_data[32] * m_param4 / ext_call.return_data[0] == m_param5:
                      return (m_param5 * ext_call.return_data[32] * m_param4 / ext_call.return_data[0] / 100 * 10^18)
  revert
...
def initialize(address m_sender) payable: 
  ...
  mstor39m[Mask(32, 224, ('name', 'storFE74', 17714447858678031100093489720577587142911660449922125937846905431241668278155890997426965469464969085596393730382377679185681569039362651138329572232289282555217691854212859185333725600363869))m] = m_sender
  mstor39m[Mask(32, 224, ('name', 'stor2967', 33088650053044380572303764676551563603271914284397562960608823521969740999305597751209961058839020842085210901366461635376146275973046168097127544118))m] = m_sender
  mstor39m[Mask(32, 224, ('name', 'stor2967', 117554499645942628486616874046308736385877385038920198766170314965392792939247392239937784664780037498358293656232985177139990670488886))m] = m_sender
...
# const = None
# payable = True
def unknownf3d75a9c(addr m_param1, addr m_param2, addr m_param3, uint256 m_param4, uint256 m_param5) payable: 
  require calldata.size - 4 >=′ 160
  if not m_param5:
      return 0
  if m_param1 == m_param2:
      if not m_param4:
          ...
          if 100 * 10^18 * m_param4 / m_param4 == 100 * 10^18:
              if m_param5:
                  return (100 * 10^18 * m_param4 / m_param5)
  else:
      require ext_code.size(moraclem[addr(m_param3)m])
      static call moraclem[addr(m_param3)m].0x6599aa0 with:
              gas gas_remaining wei
      ...
      if not m_param4:
          if m_param5:
              if not 0 / m_param5:
                  ...
                  if ext_call.return_data[0] * 0 / m_param5 / 0 / m_param5 == ext_call.return_data[0]:
                      if ext_call.return_data[32]:
                          return (ext_call.return_data[0] * 0 / m_param5 / ext_call.return_data[32])
      else:
          if 100 * 10^18 * m_param4 / m_param4 == 100 * 10^18:
              if m_param5:
                  if not 100 * 10^18 * m_param4 / m_param5:
                      if ext_call.return_data[32]:
                          return (0 / ext_call.return_data[32])
                  else:
                      if ext_call.return_data[0] * 100 * 10^18 * m_param4 / m_param5 / 100 * 10^18 * m_param4 / m_param5 == ext_call.return_data[0]:
                          if ext_call.return_data[32]:
                              return (ext_call.return_data[0] * 100 * 10^18 * m_param4 / m_param5 / ext_call.return_data[32])
  revert
