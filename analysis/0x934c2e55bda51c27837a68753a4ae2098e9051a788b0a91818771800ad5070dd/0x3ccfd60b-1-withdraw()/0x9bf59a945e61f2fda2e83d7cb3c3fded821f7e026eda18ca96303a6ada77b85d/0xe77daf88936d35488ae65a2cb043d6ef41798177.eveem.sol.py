...
#  addr = 0xE77DaF88936d35488ae65A2CB043D6ef41798177 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def unknown38a1ff63(array _param1, array _param2): # not payable
  require caller == owner
  mem[(32 * _param2.length) + (32 * _param1.length) + 260 len floor32(_param1.length)] = call.data[_param1 + 36 len floor32(_param1.length)]
  mem[(64 * _param1.length) + (32 * _param2.length) + 260] = _param2.length
  mem[(64 * _param1.length) + (32 * _param2.length) + 292 len floor32(_param2.length)] = call.data[_param2 + 36 len floor32(_param2.length)]
  ...
  call unknown2156e6c6[0x4c6f636b657250726f76696465720000000000000000000000000000000000].0x38a1ff63 with:
       gas gas_remaining wei
      args Array(len=_param1.length, data=call.data[_param1 + 36 len floor32(_param1.length)], mem[(32 * _param2.length) + (32 * _param1.length) + floor32(_param1.length) + 260 len (32 * _param2.length) + (32 * _param1.length) + -floor32(_param1.length) + 32]), (32 * _param1.length) + 96
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
...
def tokensWithAmount(): # not payable
  if tokens.length:
      mem[128 len 32 * tokens.length] = code.data[23182 len 32 * tokens.length]
  [94midx = 0
  [94ms = 0
  ...
  if [94ms:
      mem[(32 * tokens.length) + 160 len 32 * [94ms] = code.data[23182 len 32 * [94ms]
  [94midx = 0
  [94mt = 0
  while [94midx < tokens.length:
      require [94midx < tokens.length
...
def requestWithdraw(uint256 _value): # not payable
  ...
  if status == 3:
      ...
      while [94midx < tokens.length:
          mem[0] = 9
          require ext_code.size(tokens[[94midx].field_0)
          call tokens[[94midx].field_0.decimals() with:
               gas gas_remaining wei
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
          ...
          call unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000].getPrice(address sourceAddress, address destAddress, uint256 amount, bytes32 exchangeId) with:
               gas gas_remaining wei
              args tokens[[94midx].field_0, 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, 10^ext_call.return_data[0], 0
...
def unknown7a1ac61e(addr _param1, uint256 _param2, uint256 _param3) payable: 
  ...
  stor994C = 1
  stor8FA4 = 1
  mem[384] = 'MarketProvider'
  mem[416] = 0x45786368616e676550726f7669646572000000000000000000000000000000
  mem[448] = 0x526562616c616e636550726f76696465720000000000000000000000000000
  mem[480] = 0xef57686974656c69737450726f76696465720000000000000000000000000000
  mem[512] = 0x46656550726f76696465720000000000000000000000000000000000000000
  mem[544] = 0x5265696d6275727361626c6500000000000000000000000000000000000000
  mem[576] = 0x576974686472617750726f7669646572000000000000000000000000000000
  mem[608] = 0x4c6f636b657250726f76696465720000000000000000000000000000000000
  mem[640] = 0x5374657050726f766964657200000000000000000000000000000000000000
  [94midx = 0
  while [94midx < 9:
      [94m_46 = mem[(32 * [94midx) + 384]
      require caller == owner
      mem[676] = mem[(32 * [94midx) + 384]
      require ext_code.size(unknown5075edbfAddress)
      call unknown5075edbfAddress.0xf57ce488 with:
           gas gas_remaining wei
          args [94m_46
      ...
      if unknown2156e6c6[[94m_46] != addr(ext_call.return_data[0]):
          ...
          if not stor18[[94m_46]:
              ...
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              mem[672] = 0x95ea7b300000000000000000000000000000000000000000000000000000000
              mem[676] = unknown2156e6c6[[94m_46]
              mem[708] = -1
              require ext_code.size(addr(ext_call.return_data[0]))
              call addr(ext_call.return_data[0]).approve(address spender, uint256 value) with:
                   gas gas_remaining wei
  ...
  mem[800] = 3
  mem[864] = 0x526562616c616e636550726f76696465720000000000000000000000000000
  mem[896] = 0x576974686472617750726f7669646572000000000000000000000000000000
  mem[928] = 0x427579546f6b656e7300000000000000000000000000000000000000000000
  mem[960] = 0x4765744574680000000000000000000000000000000000000000000000000000
  mem[992] = 0xfdb880b900000000000000000000000000000000000000000000000000000000
  mem[996] = 64
  mem[1060] = 4
  mem[1092 len 0] = None
  mem[1028] = 224
  mem[1220] = ext_call.return_data[0]
  mem[1252 len floor32(ext_call.return_data[0])] = mem[704 len floor32(ext_call.return_data[0])]
  ...
  call unknown2156e6c6[0x5374657050726f766964657200000000000000000000000000000000000000].0xfdb880b9 with:
       gas gas_remaining wei
      args 64, 224, 4, mem[1092 len 128], ext_call.return_data[0], mem[1252 len 32 * ext_call.return_data[0]]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  status = 1
  require call.value + accumulatedFee >= accumulatedFee
  ...
  call unknown2156e6c6[0x4c6f636b657250726f76696465720000000000000000000000000000000000].0x38a1ff63 with:
       gas gas_remaining wei
      args 64, 224, 4, mem[1476 len 128], 4, mem[1636 len 128]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require caller == owner
...
def withdrawFee(uint256 _amount): # not payable
  ...
  if status != 3:
      ...
      if not ext_call.return_data[0]:
          ...
          require _amount + 10^17 <= accumulatedFee
          require _amount <= accumulatedFee
      ('le', ('param', '_amount'), ('stor', ('name', 'accumulatedFee', 21)))
      accumulatedFee -= _amount
      require ext_code.size(unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000])
      call unknown2156e6c6[0x45786368616e676550726f7669646572000000000000000000000000000000].MOT() with:
           gas gas_remaining wei
