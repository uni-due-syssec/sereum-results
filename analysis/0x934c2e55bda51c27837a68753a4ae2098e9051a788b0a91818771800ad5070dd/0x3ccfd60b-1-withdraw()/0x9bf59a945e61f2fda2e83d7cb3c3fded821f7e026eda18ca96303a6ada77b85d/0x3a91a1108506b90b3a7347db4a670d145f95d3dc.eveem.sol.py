...
def unknownd3927c15(): # not payable
  ...
  require eth.balance(caller) > 0
  require gas_remaining <= munknown21a244e5m[callerm]
  if not munknown21a244e5m[callerm] + -gas_remaining + 21000:
      require 0 <= eth.balance(caller)
      mstor14m[callerm] = 0
      munknown21a244e5m[callerm] = 0
      return 0
  require (21000 * block.gasprice) + (munknown21a244e5m[callerm] * block.gasprice) - (gas_remaining * block.gasprice) / munknown21a244e5m[callerm] + -gas_remaining + 21000 == block.gasprice
