...
#  addr = 0x13831a9DF5f6413E32D9E14A7C9DA6B6591d95B3 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {'0x1e270dc6': 'unknown1e270dc6(?)', '0x27dc297e': '__callback(bytes32 _myid, string _result)', '0x442a13a5': 'unknown442a13a5(?)', '0x5e51db47': 'unknown5e51db47(?)', '0x67988182': 'unknown67988182(?)', '0x8a6b114b': 'getBet(address _player, uint256 _game)', '0xc92025f5': 'unknownc92025f5(?)', '0xee6892ed': 'unknownee6892ed(?)'} 
...
def bets(address _param1, uint256 _param2): # not payable
  ...
  require unknown264be753[_param1][_param2].field_8 <= 4
  return unknown264be753[_param1][_param2].field_0, 
         unknown264be753[_param1][_param2].field_0,
         unknown264be753[_param1][_param2].field_0,
         unknown264be753[_param1][_param2].field_0,
         bool(unknown264be753[_param1][_param2].field_208),
         bool(unknown264be753[_param1][_param2].field_216),
         bool(unknown264be753[_param1][_param2].field_224)
...
def rounds(uint256 _param1): # not payable
  ...
  require rounds[_param1].field_224 <= 2
  return rounds[_param1].field_0, rounds[_param1].field_0, rounds[_param1].field_256
...
def unknowna8e14f65(addr _param1, uint256 _param2): # not payable
  ...
  require unknown264be753[addr(_param1)][_param2].field_144 < rounds.length
  require rounds[stor24[addr(_param1)][_param2].field_144].field_224 <= 2
  if rounds[stor24[addr(_param1)][_param2].field_144].field_224 != 2:
      return 0
  return 1
...
def unknownc4ea0bcd(uint256 _param1): # not payable
  require calldata.size - 4 >= 32
  require unknownc4ea0bcd[_param1] <= 3
...
def unknowne8967dbb(addr _param1, uint256 _param2): # not payable
  require calldata.size - 4 >= 64
  require _param2 < unknown264be753[addr(_param1)].field_0
  require unknown264be753[addr(_param1)][_param2].field_8 <= 4
  return unknown264be753[addr(_param1)][_param2].field_0, 
         bool(unknown264be753[addr(_param1)][_param2].field_216),
         bool(unknown264be753[addr(_param1)][_param2].field_208),
         bool(unknown264be753[addr(_param1)][_param2].field_224)
...
def unknownf25b7675(addr _param1): # not payable
  ...
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 <= 4
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 < rounds.length
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 <= 4
  if unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 == 1:
      return rounds[2 * uint64(stor24[addr(_param1)][stor24[addr(_param1)].field_0].field_0)].field_256, 
             unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0,
             unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 <= 4
  if not unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0:
      return rounds[2 * uint64(stor24[addr(_param1)][stor24[addr(_param1)].field_0].field_0)].field_256, 
             unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0,
             -unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 + 99
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 <= 4
  if unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 == 2:
      return rounds[2 * uint64(stor24[addr(_param1)][stor24[addr(_param1)].field_0].field_0)].field_256, 
             unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0,
             1
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 <= 4
  if unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 == 3:
      if unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0:
          return rounds[2 * uint64(stor24[addr(_param1)][stor24[addr(_param1)].field_0].field_0)].field_256, 
                 unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0,
                 50
      return rounds[2 * uint64(stor24[addr(_param1)][stor24[addr(_param1)].field_0].field_0)].field_256, 
             ...
             49
  require unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 <= 4
  if unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 != 4:
      return rounds[2 * uint64(stor24[addr(_param1)][stor24[addr(_param1)].field_0].field_0)].field_256, 
             unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0,
             0
  if unknown264be753[addr(_param1)][unknown264be753[addr(_param1)].field_0].field_0 != 2:
