...
def bets(address m_param1, uint256 m_param2): # not payable
  ...
  require munknown264be753m[m_param1m]m[m_param2m]m.field_8 <= 4
  return munknown264be753m[m_param1m]m[m_param2m]m.field_0, 
         ...
         bool(munknown264be753m[m_param1m]m[m_param2m]m.field_224)
...
def rounds(uint256 m_param1): # not payable
  ...
  require mroundsm[m_param1m]m.field_224 <= 2
...
def unknowna8e14f65(addr m_param1, uint256 m_param2): # not payable
  ...
  require munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_144 < mroundsm.length
  require mroundsm[mstor24m[addr(m_param1)m]m[m_param2m]m.field_144m]m.field_224 <= 2
  if mroundsm[mstor24m[addr(m_param1)m]m[m_param2m]m.field_144m]m.field_224 != 2:
      return 0
  return 1
...
def unknownc4ea0bcd(uint256 m_param1): # not payable
  require calldata.size - 4 >= 32
  require munknownc4ea0bcdm[m_param1m] <= 3
...
def unknowne8967dbb(addr m_param1, uint256 m_param2): # not payable
  require calldata.size - 4 >= 64
  require m_param2 < munknown264be753m[addr(m_param1)m]m.field_0
  require munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_8 <= 4
  return munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_0, 
         ...
         bool(munknown264be753m[addr(m_param1)m]m[m_param2m]m.field_224)
...
def unknownf25b7675(addr m_param1): # not payable
  ...
  require munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0 <= 4
  ...
  if munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0 == 1:
      return mroundsm[2 * uint64(mstor24m[addr(m_param1)m]m[mstor24m[addr(m_param1)m]m.field_0m]m.field_0)m]m.field_256, 
             munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0,
             munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0
  require munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0 <= 4
  if not munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0:
      return mroundsm[2 * uint64(mstor24m[addr(m_param1)m]m[mstor24m[addr(m_param1)m]m.field_0m]m.field_0)m]m.field_256, 
             munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0,
             -munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0 + 99
  require munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0 <= 4
  ...
  if munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0 == 3:
      if munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0:
          return mroundsm[2 * uint64(mstor24m[addr(m_param1)m]m[mstor24m[addr(m_param1)m]m.field_0m]m.field_0)m]m.field_256, 
                 munknown264be753m[addr(m_param1)m]m[munknown264be753m[addr(m_param1)m]m.field_0m]m.field_0,
                 50
      return mroundsm[2 * uint64(mstor24m[addr(m_param1)m]m[mstor24m[addr(m_param1)m]m.field_0m]m.field_0)m]m.field_256, 
