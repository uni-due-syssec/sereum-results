...
def unknown084a4faf() payable: 
  ...
  if ([94m_1558 * ext_call.return_data[0]) + ([94m_798 * ext_call.return_data[0]) <= ext_call.return_data[0]:
      ...
      mem[0] = mcurrentCycle
      mem[32] = 39
      munknown873426ffm[mstor8m] = [94m_2252 * ext_call.return_data[0]
      require ext_code.size(msettingsAddress)
      static call msettingsAddress.0xdd2f4ebd with:
              gas gas_remaining wei
      if not ext_call.success:
      ...
      mwhile [94midx < ext_call.return_data[0]m:
          ...
          [94ms = ext_call.return_data[0] + [94ms
          mcontinue 
      munknown9b1c8ec5m[mstor8m] = [94m_2777 * ext_call.return_data[0]
  else:
      require ext_code.size(mcasinoAddress)
      ...
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >= 32
      if ([94m_1558 * ext_call.return_data[0]) + ([94m_798 * ext_call.return_data[0]) - ext_call.return_data[0] <= ext_call.return_data[0] + munknownc18df55f:
          mem[0] = mcurrentCycle
          mem[32] = 38
          munknownf987d986m[mstor8m] = 0
          require ext_code.size(msettingsAddress)
          ...
          mwhile [94midx < ext_call.return_data[0]m:
              ...
              [94ms = ext_call.return_data[0] + [94ms
              mcontinue 
          munknown873426ffm[mstor8m] = [94m_2254 * ext_call.return_data[0]
          require ext_code.size(msettingsAddress)
          static call msettingsAddress.0xdd2f4ebd with:
                  gas gas_remaining wei
          if not ext_call.success:
          ...
          mwhile [94midx < ext_call.return_data[0]m:
              ...
              [94ms = ext_call.return_data[0] + [94ms
              mcontinue 
          munknown9b1c8ec5m[mstor8m] = [94m_2780 * ext_call.return_data[0]
      else:
          require ext_code.size(mcasinoAddress)
          ...
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
          if ([94m_1558 * ext_call.return_data[0]) + ([94m_798 * ext_call.return_data[0]) - (2 * ext_call.return_data[0]) - munknownc18df55f <= ext_call.return_data[0]:
              mem[0] = mcurrentCycle
              mem[32] = 38
              munknownf987d986m[mstor8m] = 0
              require ext_code.size(msettingsAddress)
              ...
              mem[0] = mcurrentCycle
              mem[32] = 39
              munknown873426ffm[mstor8m] = [94m_2256 * ext_call.return_data[0]
              require ext_code.size(msettingsAddress)
              static call msettingsAddress.0xdd2f4ebd with:
                      gas gas_remaining wei
              if not ext_call.success:
              ...
              mwhile [94midx < ext_call.return_data[0]m:
                  ...
                  [94ms = ext_call.return_data[0] + [94ms
                  mcontinue 
              munknown9b1c8ec5m[mstor8m] = [94m_2783 * ext_call.return_data[0]
          else:
              require ext_code.size(mcasinoAddress)
              static call mcasinoAddress.0x397425fb with:
                      gas gas_remaining wei
              ...
              mem[0] = mcurrentCycle
              mem[32] = 38
              munknownf987d986m[mstor8m] = ([94m_1558 * ext_call.return_data[0]) + ([94m_798 * ext_call.return_data[0]) - (3 * ext_call.return_data[0]) - munknownc18df55f
              require ext_code.size(msettingsAddress)
              static call msettingsAddress.0xdd2f4ebd with:
                      gas gas_remaining wei
              if not ext_call.success:
              ...
              mwhile [94midx < ext_call.return_data[0]m:
                  ...
                  [94ms = ext_call.return_data[0] + [94ms
                  mcontinue 
              munknown873426ffm[mstor8m] = [94m_2258 * ext_call.return_data[0]
              require ext_code.size(msettingsAddress)
              static call msettingsAddress.0xdd2f4ebd with:
                      gas gas_remaining wei
              if not ext_call.success:
              ...
              mwhile [94midx < ext_call.return_data[0]m:
                  ...
                  [94ms = ext_call.return_data[0] + [94ms
                  mcontinue 
              munknown9b1c8ec5m[mstor8m] = [94m_2786 * ext_call.return_data[0]
  require ext_code.size(mcasinoAddress)
  static call mcasinoAddress.0x610fe551 with:
          gas gas_remaining wei
  if not ext_call.success:
  ...
  if not mcurrentCycle:
      ...
      if munknownf987d986m[mstor8m] <= munknownf987d986m[mstor8 - 1m]:
          call mcasinoAddress.0x5815caa with:
               gas gas_remaining wei
              args munknown0a6554e9Address, 0 / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) - munknown7a49f350m[mstor8m] + munknown9f9de645m[mstor8m] * munknown8e7c820cm[mstor7m] / 100
      else:
          call mcasinoAddress.0x5815caa with:
               gas gas_remaining wei
...
def unknown4068ed2b(addr m_param1) payable: 
  ...
  if ([94m_309 * ext_call.return_data[0]) + ([94m_181 * ext_call.return_data[0]) <= ext_call.return_data[0]:
      if not mcurrentCycle:
          if mcurrentStage < 11:
              if (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked:
                  return (0 / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked * munknown8e7c820cm[mstor7m] / 100)
      else:
          if 0 <= munknownf987d986m[mstor8 - 1m]:
              return 0
          if mcurrentStage < 11:
              if (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked:
                  return (-1 * munknownf987d986m[mstor8 - 1m] * munknowna5b39cfbm[addr(m_param1)m] / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked * munknown8e7c820cm[mstor7m] / 100)
  else:
      require ext_code.size(mcasinoAddress)
      static call mcasinoAddress.0x236e5e4c with:
              gas gas_remaining wei
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >= 32
      if ([94m_309 * ext_call.return_data[0]) + ([94m_181 * ext_call.return_data[0]) - ext_call.return_data[0] <= ext_call.return_data[0] + munknownc18df55f:
          if not mcurrentCycle:
              if mcurrentStage < 11:
                  if (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked:
                      return (0 / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked * munknown8e7c820cm[mstor7m] / 100)
          ...
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
          if ([94m_309 * ext_call.return_data[0]) + ([94m_181 * ext_call.return_data[0]) - (2 * ext_call.return_data[0]) - munknownc18df55f <= ext_call.return_data[0]:
              if not mcurrentCycle:
                  if mcurrentStage < 11:
                      if (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked:
                          return (0 / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked * munknown8e7c820cm[mstor7m] / 100)
              ...
              if not mcurrentCycle:
                  if mcurrentStage < 11:
                      if (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked:
                          return (([94m_309 * ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) + ([94m_181 * ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (munknownc18df55f * munknowna5b39cfbm[addr(m_param1)m]) - (ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked * munknown8e7c820cm[mstor7m] / 100)
              else:
                  if ([94m_309 * ext_call.return_data[0]) + ([94m_181 * ext_call.return_data[0]) - (3 * ext_call.return_data[0]) - munknownc18df55f <= munknownf987d986m[mstor8 - 1m]:
                      return 0
                  if mcurrentStage < 11:
                      if (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked:
                          return (([94m_309 * ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) + ([94m_181 * ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (munknownc18df55f * munknowna5b39cfbm[addr(m_param1)m]) - (ext_call.return_data[0] * munknowna5b39cfbm[addr(m_param1)m]) - (munknownf987d986m[mstor8 - 1m] * munknowna5b39cfbm[addr(m_param1)m]) / (ext_call.return_data[0] * munknown8e7c820cm[mstor7m] / 100) + mtotalStaked * munknown8e7c820cm[mstor7m] / 100)
  revert
...
def unknown48d7d9eb() payable: 
  ...
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  if ([94m_198 * ext_call.return_data[0]) + ([94m_118 * ext_call.return_data[0]) - ext_call.return_data[0] <= ext_call.return_data[0] + munknownc18df55f:
      return 0
  require ext_code.size(mcasinoAddress)
  static call mcasinoAddress.0x397425fb with:
          gas gas_remaining wei
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  if ([94m_198 * ext_call.return_data[0]) + ([94m_118 * ext_call.return_data[0]) - (2 * ext_call.return_data[0]) - munknownc18df55f <= ext_call.return_data[0]:
      return 0
  require ext_code.size(mcasinoAddress)
  static call mcasinoAddress.0x397425fb with:
          gas gas_remaining wei
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  return (([94m_198 * ext_call.return_data[0]) + ([94m_118 * ext_call.return_data[0]) - (3 * ext_call.return_data[0]) - munknownc18df55f)
...
def unknownbc105ab5(addr m_param1) payable: 
  ...
  if ([94m_230 * ext_call.return_data[0]) + ([94m_142 * ext_call.return_data[0]) <= ext_call.return_data[0]:
      ...
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >= 32
      if ([94m_230 * ext_call.return_data[0]) + ([94m_142 * ext_call.return_data[0]) - ext_call.return_data[0] <= ext_call.return_data[0] + munknownc18df55f:
          require 0 > ext_call.return_data[0] * ext_call.return_data[0]
      else:
          require ext_code.size(mcasinoAddress)
          static call mcasinoAddress.0x397425fb with:
          ...
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >= 32
          if ([94m_230 * ext_call.return_data[0]) + ([94m_142 * ext_call.return_data[0]) - (2 * ext_call.return_data[0]) - munknownc18df55f <= ext_call.return_data[0]:
              require 0 > ext_call.return_data[0] * ext_call.return_data[0]
          else:
              require ext_code.size(mcasinoAddress)
              static call mcasinoAddress.0x397425fb with:
              ...
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              require return_data.size >= 32
              require ([94m_230 * ext_call.return_data[0]) + ([94m_142 * ext_call.return_data[0]) - (3 * ext_call.return_data[0]) - munknownc18df55f > ext_call.return_data[0] * ext_call.return_data[0]
  call m_param1 with:
...
# const = None
# payable = True
def unknownd82cead8(uint256 m_param1) payable: 
  require calldata.size - 4 >= 32
  if not m_param1:
      return mstor6736
...
# const = None
# payable = True
def unknownf987d986(uint256 m_param1) payable: 
  require calldata.size - 4 >= 32
