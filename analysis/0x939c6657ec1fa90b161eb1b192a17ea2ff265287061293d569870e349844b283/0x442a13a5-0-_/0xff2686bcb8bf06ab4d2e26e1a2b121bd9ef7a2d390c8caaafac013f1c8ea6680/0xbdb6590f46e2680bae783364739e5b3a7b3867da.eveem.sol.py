...
def unknown3c8bccd9(uint256 _param1): # not payable
  ...
  if not _param1:
      return 0
  require 2 * ext_call.return_data[0] * _param1 / _param1 == 2 * ext_call.return_data[0]
  return (2 * ext_call.return_data[0] * _param1 / 100000)
...
def unknown440277e8(addr _param1): # not payable
  ...
  mem[64] = 224
  require ext_code.size(addr(unknown264be753[addr(_param1)][stor26[addr(_param1)]].field_0))
  static call addr(unknown264be753[addr(_param1)][stor26[addr(_param1)]].field_0).0xe8967dbb with:
          gas gas_remaining wei
         args addr(_param1), unknown264be753[addr(_param1)][stor26[addr(_param1)]].field_256
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
...
def unknownac53df0b(uint256 _param1): # not payable
  ...
  if not ext_call.return_data[0]:
      if not _param1:
          return 0
      require 100000 * _param1 / _param1 == 100000
      return (100000 * _param1 / 100000)
  require 2 * ext_call.return_data[0] / ext_call.return_data[0] == 2
  if not _param1:
      return 0
  require (100000 * _param1) - (2 * ext_call.return_data[0] * _param1) / _param1 == -(2 * ext_call.return_data[0]) + 100000
  return ((100000 * _param1) - (2 * ext_call.return_data[0] * _param1) / 100000)
...
def unknownc2853b66(addr _param1): # not payable
  require calldata.size - 4 >= 32
  require ext_code.size(settingsAddress)
  static call settingsAddress.0xe2c2f4ac with:
          gas gas_remaining wei
         args unknown14c84f3a[addr(_param1)]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
