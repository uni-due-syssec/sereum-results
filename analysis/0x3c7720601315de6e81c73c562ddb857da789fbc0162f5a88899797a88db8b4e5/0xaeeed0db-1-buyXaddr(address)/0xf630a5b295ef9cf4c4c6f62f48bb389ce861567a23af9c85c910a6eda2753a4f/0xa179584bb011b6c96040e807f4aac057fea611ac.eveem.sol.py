...
def unknown151ac13e(uint256 m_param1, uint256 m_param2, uint256 m_param3): # not payable
  ...
  if munknown926091d9m[m_param1m]m.field_256:
      revert with 0, 'pharse has been set already'
  munknown926091d9m[m_param1m]m.field_256 = m_param2
  munknown926091d9m[m_param1m]m.field_1280 = m_param3
  if 1 == m_param1 % 1000:
      mstor10m[m_param1 / 1000m]m.field_256 = block.timestamp
      if block.timestamp + mstor5 < mstor5:
          revert with 0, 'SafeMath add failed'
      mstor10m[m_param1 / 1000m]m.field_0 = block.timestamp + mstor5
...
def unknown74e7b3a4(uint256 m_param1): # not payable
  return munknown926091d9m[m_param1m]m.field_256, munknown926091d9m[m_param1m]m.field_512
...
def unknown926091d9(uint256 m_param1, uint256 m_param2): # not payable
  return munknown926091d9m[m_param1m]m.field_256, 
         munknown926091d9m[m_param1m]m[4m]m[m_param2m]m.field_0,
...
def unknowndb4feabd(uint256 m_param1): # not payable
  return munknown926091d9m[m_param1m]m.field_256, 
         munknown926091d9m[m_param1m]m.field_512,
         munknown926091d9m[m_param1m]m.field_768,
...
def unknowne8c58763(uint256 m_param1): # not payable
  if not mstor10m[m_param1 / 1000m]m.field_256:
      return mstor5
  if not mstor10m[m_param1 / 1000m]m.field_0:
      return mstor5
  if block.timestamp < mstor10m[m_param1 / 1000m]m.field_0:
      if block.timestamp > mstor10m[m_param1 / 1000m]m.field_256:
          if block.timestamp > mstor10m[m_param1 / 1000m]m.field_0:
              revert with 0, 'SafeMath sub failed'
          return (mstor10m[m_param1 / 1000m]m.field_0 - block.timestamp)
  if not mstor3:
      return 0
