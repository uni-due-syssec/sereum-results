...
def finalize(): # not payable
  mcontractsm[callerm]m.field_1024 = 0
...
def withdraw(address m_payee): # not payable
  ...
  require mcontractsm[callerm]m.field_1024
  if not mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0:
      return 0
  require mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0 <= mcontractsm[callerm]m.field_768
  mcontractsm[callerm]m.field_768 -= mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0
  ...
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  if mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0 > ext_call.return_data[0]:
  ...
  if not mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0:
      ...
      return 0 / 10^ext_call.return_data[0], mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0
  require mcontractsm[callerm]m.field_0 * mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0 / mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0 == mcontractsm[callerm]m.field_0
  require 10^ext_call.return_data[0]
  ...
  return mcontractsm[callerm]m.field_0 * mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0 / 10^ext_call.return_data[0], 
         mcontractsm[callerm]m[2m]m[addr(m_payee)m]m.field_0
...
def freeze(): # not payable
  require not mcontractsm[callerm]m.field_1024
  require ext_code.size(caller)
  ...
  if not mcontractsm[callerm]m.field_768:
      ...
      if 0 / 10^ext_call.return_data[0] <= ext_call.return_data[0]:
          ...
          if not ext_call.return_data[0]:
              require mcontractsm[callerm]m.field_768
              mcontractsm[callerm]m.field_0 = 0 / mcontractsm[callerm]m.field_768
          else:
              require 10^ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] == 10^ext_call.return_data[0]
              require mcontractsm[callerm]m.field_768
              mcontractsm[callerm]m.field_0 = 10^ext_call.return_data[0] * ext_call.return_data[0] / mcontractsm[callerm]m.field_768
  else:
      require ext_call.return_data[0] * mcontractsm[callerm]m.field_768 / mcontractsm[callerm]m.field_768 == ext_call.return_data[0]
      require 10^ext_call.return_data[0]
      if ext_call.return_data[0] * mcontractsm[callerm]m.field_768 / 10^ext_call.return_data[0] <= ext_call.return_data[0]:
          mcontractsm[callerm]m.field_0 = ext_call.return_data[0]
      else:
          require ext_code.size(caller)
          call caller.decimals() with:
          ...
          if not ext_call.return_data[0]:
              ...
              require mcontractsm[callerm]m.field_768
              mcontractsm[callerm]m.field_0 = 10^ext_call.return_data[0] * ext_call.return_data[0] / mcontractsm[callerm]m.field_768
  mcontractsm[callerm]m.field_1024 = 1
...
def contracts(address m_param1): # not payable
  return mcontractsm[m_param1m]m.field_0, mcontractsm[m_param1m]m.field_768, bool(mcontractsm[m_param1m]m.field_1024)
...
def isInProgress(): # not payable
  if not mcontractsm[callerm]m.field_1024:
      return bool(mcontractsm[callerm]m.field_1024)
  return (mcontractsm[callerm]m.field_768 > 0)
...
def unknown74e8ff0e(addr m_param1): # not payable
  return mcontractsm[addr(m_param1)m]m.field_768
...
def unknownc77e7614(): # not payable
  return mcontractsm[callerm]m.field_768
...
def unknownc8c01a55(addr m_param1, uint256 m_param2): # not payable
  require not mcontractsm[callerm]m.field_1024
  require m_param2 + mcontractsm[callerm]m.field_768 >= mcontractsm[callerm]m.field_768
  require ext_code.size(caller)
  ...
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  require ext_call.return_data[0] >= m_param2 + mcontractsm[callerm]m.field_768
  ...
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >= 32
  require ext_call.return_data[0] >= mcontractsm[callerm]m[2m]m[addr(m_param1)m]m.field_0 + m_param2
  ...
  require m_param2 + mcontractsm[callerm]m.field_768 >= mcontractsm[callerm]m.field_768
  mcontractsm[callerm]m.field_768 += m_param2
  log WithdrawRequest(
...
def unknowncd481e51(addr m_param1): # not payable
  if mcontractsm[addr(m_param1)m]m.field_256:
      ...
      mwhile (32 * mcontractsm[addr(m_param1)m]m.field_256) + 96 > [94midxm:
          ...
          [94ms = [94ms + 1
          mcontinue 
  mem[(32 * mcontractsm[addr(m_param1)m]m.field_256) + 288 len floor32(mcontractsm[addr(m_param1)m]m.field_256)] = mem[128 len floor32(mcontractsm[addr(m_param1)m]m.field_256)]
  return mcontractsm[addr(m_param1)m]m.field_0, 
         Array(len=mcontractsm[addr(m_param1)m]m.field_256, data=mem[128 len floor32(mcontractsm[addr(m_param1)m]m.field_256)], mem[(32 * mcontractsm[addr(m_param1)m]m.field_256) + floor32(mcontractsm[addr(m_param1)m]m.field_256) + 288 len (32 * mcontractsm[addr(m_param1)m]m.field_256) - floor32(mcontractsm[addr(m_param1)m]m.field_256)]),
         mcontractsm[addr(m_param1)m]m.field_768,
         bool(mcontractsm[addr(m_param1)m]m.field_1024)
