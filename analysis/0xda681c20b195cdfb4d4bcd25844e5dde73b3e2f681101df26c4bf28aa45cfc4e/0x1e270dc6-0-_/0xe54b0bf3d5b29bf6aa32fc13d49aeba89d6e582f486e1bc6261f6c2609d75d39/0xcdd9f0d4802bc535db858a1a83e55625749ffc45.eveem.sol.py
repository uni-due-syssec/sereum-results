...
#  addr = 0xcDd9f0D4802BC535dB858A1A83E55625749Ffc45 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
# const = None
# payable = False
def unknown27600936(bool m_param1): # not payable
  require calldata.size - 4 >= 32
  require mstor12m[callerm]
  mstor10 = Mask(248, 0, m_param1)
...
# hash = 0xc216a0a9
# getter = ['bool', ['storage', 8, 8, 10]]
# const = None
# payable = False
def unknownc216a0a9(): # not payable
  return bool(munknownc216a0a9)
...
# hash = 0xe2c2f4ac
# getter = ['storage', 256, 0, ['add', ['sha3', 15], ['cd', 4]]]
# const = None
# payable = False
def unknowne2c2f4ac(uint256 m_param1): # not payable
  require calldata.size - 4 >= 32
  require m_param1 < munknowne2c2f4acm.length
  return munknowne2c2f4acm[m_param1m]
