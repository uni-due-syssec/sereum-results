...
#  addr = 0xeF8e5A79C9Fa05ab234A1844e7f4899858932775 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def storage:
    ...
    # storage address 80434052658694211699081360995846900684042199003636033430372610252564422549861366198124
    stor80434052658694211699081360995846900684042199003636033430372610252564422549861366198124
...
# const = None
# payable = True
def unknown09c5a317(uint256 m_param1, addr m_param2) payable: 
  ...
  if not mordersm[m_param1m]m.field_0:
      ...
      static call moraclem[mstor10m[m_param1m]m.field_768m].0x6599aa0 with:
              gas gas_remaining wei
             args mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, addr(m_param2), -1
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      ...
      if not mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280:
          ...
          call mvaultContractAddress.depositToken(address from, address token, uint256 amount) with:
               gas gas_remaining wei
              args addr(m_param2), caller, 0 / ext_call.return_data[32]
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
          ...
          mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 = m_param2
          mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 = 0 / ext_call.return_data[32]
          require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
          call moraclem[mstor10m[m_param1m]m.field_768m].0x7724d39a with:
               gas gas_remaining wei
              args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2560, mstor2
      ...
      require ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 / mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 == ext_call.return_data[0]
      require ext_call.return_data[32]
      if not ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 / ext_call.return_data[32]:
          revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.depositToken new collateral == 0'
      require ext_code.size(mvaultContractAddress)
      call mvaultContractAddress.depositToken(address from, address token, uint256 amount) with:
           gas gas_remaining wei
          args addr(m_param2), caller, ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 / ext_call.return_data[32]
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 32
      if not ext_call.return_data[0]:
      ...
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 > 0:
          ...
          if not ext_call.return_data[0]:
              revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.withdrawToken old collateral failed'
      mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 = m_param2
      mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 = ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 / ext_call.return_data[32]
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      call moraclem[mstor10m[m_param1m]m.field_768m].0x7724d39a with:
           gas gas_remaining wei
          args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2560, mstor2
      ...
      mstor2 = 0
      mstor0 = 1
      return (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 / ext_call.return_data[32])
  if not mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_768:
      require mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 <= 0:
          mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 = m_param2
  ...
  if not ext_call.return_data[0]:
      require ext_call.return_data[96] + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
      if ext_call.return_data[96] + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 <= 0:
          if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 > 0:
              require ext_code.size(mvaultContractAddress)
              call mvaultContractAddress.withdrawToken(address token, address to, uint256 value) with:
                   gas gas_remaining wei
          ...
          mstor2 = 0
          mstor0 = 1
          return (ext_call.return_data[96] + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280)
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      static call moraclem[mstor10m[m_param1m]m.field_768m].0x6599aa0 with:
              gas gas_remaining wei
             args mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, addr(m_param2), -1
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 96
      if not ext_call.return_data[96] + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280:
          require ext_call.return_data[32]
          if not 0 / ext_call.return_data[32]:
              revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.depositToken new collateral == 0'
          require ext_code.size(mvaultContractAddress)
          ...
          mstor0 = 1
          return (0 / ext_call.return_data[32])
      require (ext_call.return_data[96] * ext_call.return_data[0]) + (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) / ext_call.return_data[96] + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 == ext_call.return_data[0]
      require ext_call.return_data[32]
      if not (ext_call.return_data[96] * ext_call.return_data[0]) + (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) / ext_call.return_data[32]:
          revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.depositToken new collateral == 0'
      require ext_code.size(mvaultContractAddress)
      call mvaultContractAddress.depositToken(address from, address token, uint256 amount) with:
           gas gas_remaining wei
          args addr(m_param2), caller, (ext_call.return_data[96] * ext_call.return_data[0]) + (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) / ext_call.return_data[32]
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 32
      if not ext_call.return_data[0]:
      ...
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 > 0:
          ...
          if not ext_call.return_data[0]:
              revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.withdrawToken old collateral failed'
      mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 = m_param2
      mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 = (ext_call.return_data[96] * ext_call.return_data[0]) + (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) / ext_call.return_data[32]
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      call moraclem[mstor10m[m_param1m]m.field_768m].0x7724d39a with:
           gas gas_remaining wei
          args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2560, mstor2
      ...
      mstor2 = 0
      mstor0 = 1
      return ((ext_call.return_data[96] * ext_call.return_data[0]) + (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) / ext_call.return_data[32])
  if ext_call.return_data[96] >= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280:
      ...
      mstor0 = 1
      return 0
  if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 - ext_call.return_data[96] <= 0:
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 > 0:
          require ext_code.size(mvaultContractAddress)
          call mvaultContractAddress.withdrawToken(address token, address to, uint256 value) with:
               gas gas_remaining wei
      ...
      mstor2 = 0
      mstor0 = 1
      return (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 - ext_call.return_data[96])
  require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
  static call moraclem[mstor10m[m_param1m]m.field_768m].0x6599aa0 with:
          gas gas_remaining wei
         args mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, addr(m_param2), -1
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >=′ 96
  if not mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 - ext_call.return_data[96]:
      require ext_call.return_data[32]
      if not 0 / ext_call.return_data[32]:
          revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.depositToken new collateral == 0'
      require ext_code.size(mvaultContractAddress)
      ...
      mstor0 = 1
      return (0 / ext_call.return_data[32])
  require (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) - (ext_call.return_data[96] * ext_call.return_data[0]) / mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 - ext_call.return_data[96] == ext_call.return_data[0]
  require ext_call.return_data[32]
  if not (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) - (ext_call.return_data[96] * ext_call.return_data[0]) / ext_call.return_data[32]:
      revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.depositToken new collateral == 0'
  require ext_code.size(mvaultContractAddress)
  call mvaultContractAddress.depositToken(address from, address token, uint256 amount) with:
       gas gas_remaining wei
      args addr(m_param2), caller, (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) - (ext_call.return_data[96] * ext_call.return_data[0]) / ext_call.return_data[32]
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >=′ 32
  if not ext_call.return_data[0]:
  ...
  if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 > 0:
      ...
      if not ext_call.return_data[0]:
          revert with 0, ')BZxLoanHealth::changeCollateral BZxVault.withdrawToken old collateral failed'
  mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 = m_param2
  mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 = (mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) - (ext_call.return_data[96] * ext_call.return_data[0]) / ext_call.return_data[32]
  require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
  call moraclem[mstor10m[m_param1m]m.field_768m].0x7724d39a with:
       gas gas_remaining wei
      args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2560, mstor2
  ...
  mstor2 = 0
  mstor0 = 1
  return ((mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 * ext_call.return_data[0]) - (ext_call.return_data[96] * ext_call.return_data[0]) / ext_call.return_data[32])
...
# const = None
# payable = True
def unknown9dcf71d9(uint256 m_param1, addr m_param2, bool m_param3) payable: 
  require calldata.size - 4 >=′ 96
  if not mordersm[m_param1m]m.field_0:
      return 0
  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
  ...
  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512 == mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256:
      if mordersm[m_param1m]m.field_0 == mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256:
          ...
          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 <= 0:
              ...
              if m_param3:
                  ...
                  static call moraclem[mstor10m[m_param1m]m.field_768m].0x6599aa0 with:
                          gas gas_remaining wei
                         args mordersm[m_param1m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, -1
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              require return_data.size >=′ 96
              if m_param3:
                  ...
                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                      if ext_call.return_data[32]:
                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 > 0 / ext_call.return_data[32]:
                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                      return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                             0,
                                             mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                  if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                              ...
                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (0 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536:
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                      return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                  if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  if (0 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536, 
                                                 0,
                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                      ...
                      if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 == ext_call.return_data[0]:
                          if ext_call.return_data[32]:
                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 > ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]:
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                 0,
                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536, 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
      ...
      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 <= 0:
                      ...
                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                          if ext_call.return_data[32]:
                              if 0 > 0 / ext_call.return_data[32]:
                                  if -(0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return -(0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                 0,
                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= 0 / ext_call.return_data[32]:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if 0 / ext_call.return_data[32] <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (0 / ext_call.return_data[32]), 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                          ...
                          if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 == ext_call.return_data[0]:
                              if ext_call.return_data[32]:
                                  if 0 > ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]:
                                      if -(ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return -(ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32] <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]), 
                                                         0,
                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
          ...
          if m_param3:
              ...
              static call moraclem[mstor10m[m_param1m]m.field_768m].0x6599aa0 with:
                      gas gas_remaining wei
                     args mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, -1
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >=′ 96
          if m_param3:
              if mordersm[m_param1m]m.field_0 == mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256:
                  ...
                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 <= 0:
                      ...
                      if m_param3:
                          ...
                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                              if ext_call.return_data[32]:
                                  if ext_call.return_data[64] > 0 / ext_call.return_data[32]:
                                      if ext_call.return_data[64] - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return ext_call.return_data[64] - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (0 / ext_call.return_data[32]) - ext_call.return_data[64]:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if (0 / ext_call.return_data[32]) - ext_call.return_data[64] <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (0 / ext_call.return_data[32]) + ext_call.return_data[64], 
                                                         0,
                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                              ...
                              if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 == ext_call.return_data[0]:
                                  if ext_call.return_data[32]:
                                      if ext_call.return_data[64] > ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]:
                                          if ext_call.return_data[64] - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return ext_call.return_data[64] - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                         0,
                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - ext_call.return_data[64]:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                              ...
                                              if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - ext_call.return_data[64] <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                      return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + ext_call.return_data[64], 
                                                             0,
                                                             mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                  if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
              ...
              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536:
                  if ext_call.return_data[32]:
                      if mordersm[m_param1m]m.field_0 == mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256:
                          if 0 / ext_call.return_data[32] > mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                              if (0 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                      return (0 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                             0,
                                             mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                  if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                              ...
                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 - (0 / ext_call.return_data[32]):
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                      return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                  if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 - (0 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 + (0 / ext_call.return_data[32]), 
                                                 0,
                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                          ...
                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 <= 0:
                              ...
                              require return_data.size >=′ 96
                              if m_param3:
                                  if 0 / ext_call.return_data[32] > ext_call.return_data[64]:
                                      if (0 / ext_call.return_data[32]) - ext_call.return_data[64] + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return (0 / ext_call.return_data[32]) - ext_call.return_data[64] + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= ext_call.return_data[64] - (0 / ext_call.return_data[32]):
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if ext_call.return_data[64] - (0 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - ext_call.return_data[64] + (0 / ext_call.return_data[32]), 
                                                         0,
                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                                      ...
                                      if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 == ext_call.return_data[0]:
                                          if ext_call.return_data[32]:
                                              if 0 / ext_call.return_data[32] > ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]:
                                                  if (0 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                          return (0 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                                 0,
                                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                                  ...
                                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - (0 / ext_call.return_data[32]):
                                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                          return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                                      ...
                                                      if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - (0 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                              return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + (0 / ext_call.return_data[32]), 
                                                                     0,
                                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                  ...
                  if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 == ext_call.return_data[0]:
                      if ext_call.return_data[32]:
                          if mordersm[m_param1m]m.field_0 == mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256:
                              if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32] > mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                                  if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                 0,
                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]):
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                          return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 + (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]), 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                              ...
                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 <= 0:
                                  if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32] > 0:
                                      if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                     0,
                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= -ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]:
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                              return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if -ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32] <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 + (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]), 
                                                         0,
                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                  ...
                                  require return_data.size >=′ 96
                                  if m_param3:
                                      if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32] > ext_call.return_data[64]:
                                          if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - ext_call.return_data[64] + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - ext_call.return_data[64] + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                         0,
                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= ext_call.return_data[64] - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]):
                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                  return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                              ...
                                              if ext_call.return_data[64] - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                      return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - ext_call.return_data[64] + (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]), 
                                                             0,
                                                             mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                  if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                      ...
                                      if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768:
                                          if ext_call.return_data[32]:
                                              if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32] > 0 / ext_call.return_data[32]:
                                                  if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                          return (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - (0 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                                 0,
                                                                 mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                                  ...
                                                  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (0 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]):
                                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                          return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                      if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                          if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                                      ...
                                                      if (0 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                              return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (0 / ext_call.return_data[32]) + (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]), 
                                                                     0,
                                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                          ...
                                          if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 == ext_call.return_data[0]:
                                              if ext_call.return_data[32]:
                                                  if ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32] > ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]:
                                                      if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                              return (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, 
                                                                     0,
                                                                     mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                                      ...
                                                      if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 <= (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]):
                                                          if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                              return 0, 0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                          if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                              if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
                                                          ...
                                                          if (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]) <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280:
                                                              if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 <= block.timestamp:
                                                                  return mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 - (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768 / ext_call.return_data[32]) + (ext_call.return_data[0] * mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 / ext_call.return_data[32]), 
                                                                         0,
                                                                         mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768
                                                              if block.timestamp <= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048:
                                                                  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048 - block.timestamp:
...
def unknowna1e93482(uint256 m_param1, uint256 m_param2) payable: 
  ...
  if m_param2 < ext_call.return_data[96]:
      if m_param2 <= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280:
          ...
          mstor0 = 1
          return m_param2
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 > 0:
          if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 == mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512:
              require m_param2 - mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 <= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536
              mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 = mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 - m_param2 + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
              require m_param2 >= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
              mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 = m_param2
          else:
              require ext_code.size(mvaultContractAddress)
              call mvaultContractAddress.withdrawToken(address token, address to, uint256 value) with:
                   gas gas_remaining wei
                  args mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, moraclem[mstor10m[m_param1m]m.field_768m], mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              require return_data.size >=′ 32
              if not ext_call.return_data[0]:
              ...
              call moraclem[mstor10m[m_param1m]m.field_768m].0x4849b6c8 with:
                   gas gas_remaining wei
                  args mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536, m_param2 - mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              require return_data.size >=′ 64
              if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 < ext_call.return_data[32]:
      ...
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 > 0:
          if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 == mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512:
              require ext_call.return_data[96] - mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 <= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536
              mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 = mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 - ext_call.return_data[96] + mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
              require ext_call.return_data[96] >= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
              mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 = ext_call.return_data[96]
          else:
              require ext_code.size(mvaultContractAddress)
              ...
              call moraclem[mstor10m[m_param1m]m.field_768m].0x4849b6c8 with:
                   gas gas_remaining wei
                  args mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536, ext_call.return_data[96] - mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280
              if not ext_call.success:
                  revert with ext_call.return_data[0 len return_data.size]
              require return_data.size >=′ 64
              if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 < ext_call.return_data[32]:
...
def initialize(address m_sender) payable: 
  ...
  mstor39m[Mask(32, 224, ('name', 'stor6167', 2887321634239590173202952427458392614084464846611674846609868523121592145258312563))m] = m_sender
  mstor39m[Mask(32, 224, ('name', 'stor2967', 80434052658694211699081360995846900684042199003636033430372610252564422549861366198124))m] = m_sender
