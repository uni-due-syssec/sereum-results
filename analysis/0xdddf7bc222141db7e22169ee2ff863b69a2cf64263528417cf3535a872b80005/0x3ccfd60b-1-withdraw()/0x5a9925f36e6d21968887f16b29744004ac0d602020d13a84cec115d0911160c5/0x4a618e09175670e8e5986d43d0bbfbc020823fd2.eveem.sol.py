...
#  addr = 0x4a618e09175670E8e5986D43d0BBfBC020823fD2 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def unknown3c98d189(uint256 m_param1, array m_param2, array m_param3, array m_param4): # not payable
  ...
  if caller == mowner:
      ...
      call munknown2156e6c6m[0x45786368616e676550726f7669646572000000000000000000000000000000m].0x15cdc529 with:
           gas gas_remaining wei
          args mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 196 len (32 * mem[(32 * m_param3.length) + (32 * m_param2.length) + 160]) + (32 * m_param3.length) + (32 * m_param2.length) + 256]
      mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 192] = ext_call.return_data[0]
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >= 32
      ...
      if not m_param2.length:
          ...
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (32 * m_param2.length) + 224 len 32 * m_param2.length] = code.data[24497 len 32 * m_param2.length]
          mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
          mem[32] = 4
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 224] = 0x674f23ba00000000000000000000000000000000000000000000000000000000
          mem[(32 * m_param4.length) + (32 * m_param3.length) + (64 * m_param2.length) + 228] = 32
...
# const = None
# payable = True
def requestWithdraw(uint256 m_value) payable: 
  mem[64] = 96
          ...
          if ext_call.return_data[0] != m_value:
              ...
              if munknown07b08870m.length != 0:
                  ...
                  if not munknown07b08870m.length:
                      ...
                      [94midx = mem[64] + 100
                      [94ms = 0
                      mwhile mem[64] + (32 * munknown07b08870m.length) + 100 > [94midx + 32m:
                          mem[[94midx + 32] = addr(munknown07b08870m[[94msm]m.field_256)
                          [94midx = [94midx + 32
                          [94ms = [94ms + 1
                          mcontinue 
                      require ext_code.size(munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m])
                      call munknown2156e6c6m[0x546f6b656e42726f6b656e0000000000000000000000000000000000000000m].mem[mem[64] len 4] with:
                           gas gas_remaining wei
                          args mem[mem[64] + 4 len (32 * munknown07b08870m.length) + -mem[64] + 192]
                      if not ext_call.success:
                          revert with ext_call.return_data[0 len return_data.size]
                      [94m_1891 = mem[64]
                      mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                      ...
                      mwhile [94midx < munknown07b08870m.lengthm:
                          ...
                          if 0 == mem[(32 * [94midx) + [94m_1891 + [94m_1895 + 32]:
                              ...
                              mcontinue 
                          require [94midx < munknown07b08870m.length
                          mem[mem[64] + 4] = addr(munknown07b08870m[[94midxm]m.field_0)
                          ...
                          mem[0] = 24
                          addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                          require munknown07b08870m.length - 1 < mem[[94m_1891 + [94m_1895]
                          require [94midx < mem[[94m_1891 + [94m_1895]
                          mem[[94m_1891 + [94m_1895 + (32 * [94midx) + 32] = mem[(32 * munknown07b08870m.length - 1) + [94m_1891 + [94m_1895 + 32]
                          require munknown07b08870m.length - 1 < munknown07b08870m.length
                          mem[0] = 24
                          addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                          munknown07b08870m.length--
                          ...
                          mcontinue 
                      [94m_2300 = mem[64]
                      mem[64] = mem[64] + (32 * mstor19m.length) + 32
                      mem[[94m_2300] = mstor19m.length
                      if not mstor19m.length:
                          [94midx = 0
                          mwhile [94midx < mstor19m.lengthm:
                          ...
                          mem[0] = 19
                          mem[[94m_2300 + 32] = addr(mstor19m.field_0)
                          [94midx = [94m_2300 + 32
                          [94ms = 0
                          mwhile [94m_2300 + (32 * mstor19m.length) > [94midxm:
                              mem[[94midx + 32] = addr(mstor19m[[94msm]m.field_256)
                              [94midx = [94midx + 32
                              [94ms = [94ms + 1
                              mcontinue 
                  ...
                  if munknown07b08870m.length != 0:
                      ...
                      if not munknown07b08870m.length:
                          ...
                          mwhile [94midx < munknown07b08870m.lengthm:
                              ...
                              mem[0] = 24
                              addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                              require munknown07b08870m.length - 1 < mem[[94m_2304 + [94m_2313]
                              require [94midx < mem[[94m_2304 + [94m_2313]
                              mem[[94m_2304 + [94m_2313 + (32 * [94midx) + 32] = mem[(32 * munknown07b08870m.length - 1) + [94m_2304 + [94m_2313 + 32]
                              require munknown07b08870m.length - 1 < munknown07b08870m.length
                              mem[0] = 24
                              addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                              munknown07b08870m.length--
                          ...
                          if not mstor19m.length:
                              ...
                              mem[0] = 19
                              mem[[94m_2921 + 32] = addr(mstor19m.field_0)
                              [94midx = [94m_2921 + 32
                              [94ms = 0
                              mwhile [94m_2921 + (32 * mstor19m.length) > [94midxm:
                                  mem[[94midx + 32] = addr(mstor19m[[94msm]m.field_256)
                                  [94midx = [94midx + 32
                                  [94ms = [94ms + 1
                                  mcontinue 
                  ...
                  if munknown07b08870m.length != 0:
                      ...
                      if not munknown07b08870m.length:
                          ...
                          mwhile [94midx < munknown07b08870m.lengthm:
                              ...
                              mem[0] = 24
                              addr(munknown07b08870m[[94midxm]m.field_0) = addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0)
                              require munknown07b08870m.length - 1 < mem[[94m_2302 + [94m_2311]
                              require [94midx < mem[[94m_2302 + [94m_2311]
                              mem[[94m_2302 + [94m_2311 + (32 * [94midx) + 32] = mem[(32 * munknown07b08870m.length - 1) + [94m_2302 + [94m_2311 + 32]
                              require munknown07b08870m.length - 1 < munknown07b08870m.length
                              mem[0] = 24
                              addr(munknown07b08870m[munknown07b08870m.lengthm]m.field_0) = 0
                              munknown07b08870m.length--
                          ...
                          if not mstor19m.length:
                              ...
                              mem[0] = 19
                              mem[[94m_2920 + 32] = addr(mstor19m.field_0)
                              [94midx = [94m_2920 + 32
                              [94ms = 0
                              mwhile [94m_2920 + (32 * mstor19m.length) > [94midxm:
                                  mem[[94midx + 32] = addr(mstor19m[[94msm]m.field_256)
                                  [94midx = [94midx + 32
                                  [94ms = [94ms + 1
                                  mcontinue 
