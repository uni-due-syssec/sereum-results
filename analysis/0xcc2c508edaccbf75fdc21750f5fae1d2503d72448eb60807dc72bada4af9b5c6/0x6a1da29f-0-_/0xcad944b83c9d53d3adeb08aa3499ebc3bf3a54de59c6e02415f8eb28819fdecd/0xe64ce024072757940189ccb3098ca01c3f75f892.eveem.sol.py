...
#  addr = 0xe64ce024072757940189cCB3098CA01c3f75f892 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def cancel(address _tag): # not payable
  require ext_code.size(0x5d6a021b779fe74c71b18ea951ed355e0b147e34)
  [93mdelegate 0x5d6a021b779fe74c71b18ea951ed355e0b147e34.0xe0c703dc with:
...
def unknown5a0cf9f3(addr _param1) payable: 
  require ext_code.size(0x5d6a021b779fe74c71b18ea951ed355e0b147e34)
  [93mdelegate 0x5d6a021b779fe74c71b18ea951ed355e0b147e34.0x29f2e907 with:
       gas gas_remaining - 710 wei
...
def unknown79599f96(): # not payable
  require ext_code.size(0x5d6a021b779fe74c71b18ea951ed355e0b147e34)
  [93mdelegate 0x5d6a021b779fe74c71b18ea951ed355e0b147e34.0xd30d447d with:
       gas gas_remaining - 710 wei
      args 0
  require delegate.return_code
...
def unknown7e102b2a(bool _param1): # not payable
  require ext_code.size(0x5d6a021b779fe74c71b18ea951ed355e0b147e34)
  [93mdelegate 0x5d6a021b779fe74c71b18ea951ed355e0b147e34.0xf5471307 with:
       gas gas_remaining - 710 wei
      args 0, _param1
  require delegate.return_code
...
def unknownb82a0978(addr _param1, uint256 _param2): # not payable
  require ext_code.size(0x5d6a021b779fe74c71b18ea951ed355e0b147e34)
  [93mdelegate 0x5d6a021b779fe74c71b18ea951ed355e0b147e34.0xfe7a0fb9 with:
       gas gas_remaining - 710 wei
...
def unknownd9a96852(addr _param1, uint32 _param2): # not payable
  require ext_code.size(0x5d6a021b779fe74c71b18ea951ed355e0b147e34)
  [93mdelegate 0x5d6a021b779fe74c71b18ea951ed355e0b147e34.0xa8b7983 with:
       gas gas_remaining - 710 wei
