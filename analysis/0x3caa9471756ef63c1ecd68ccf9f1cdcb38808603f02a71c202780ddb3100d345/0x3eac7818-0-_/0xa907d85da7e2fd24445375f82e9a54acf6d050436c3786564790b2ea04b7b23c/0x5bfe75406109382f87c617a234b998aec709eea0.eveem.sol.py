...
#  addr = 0x5bFe75406109382f87c617A234b998aeC709eEa0 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {} 
...
def cancel(address m_tag): # not payable
  require ext_code.size(0xe3b04f4836f1dc06fe124606223557feb50ca8e2)
  [93mdelegate 0xe3b04f4836f1dc06fe124606223557feb50ca8e2.0xe0c703dc with:
...
def unknown5a0cf9f3(addr m_param1) payable: 
  require ext_code.size(0xe3b04f4836f1dc06fe124606223557feb50ca8e2)
  [93mdelegate 0xe3b04f4836f1dc06fe124606223557feb50ca8e2.0x29f2e907 with:
       gas gas_remaining - 710 wei
...
def unknown79599f96(): # not payable
  require ext_code.size(0xe3b04f4836f1dc06fe124606223557feb50ca8e2)
  [93mdelegate 0xe3b04f4836f1dc06fe124606223557feb50ca8e2.0xd30d447d with:
       gas gas_remaining - 710 wei
      args 0
  require delegate.return_code
...
def unknown7e102b2a(bool m_param1): # not payable
  require ext_code.size(0xe3b04f4836f1dc06fe124606223557feb50ca8e2)
  [93mdelegate 0xe3b04f4836f1dc06fe124606223557feb50ca8e2.0xf5471307 with:
       gas gas_remaining - 710 wei
      args 0, m_param1
  require delegate.return_code
...
def unknownb82a0978(addr m_param1, uint256 m_param2): # not payable
  require ext_code.size(0xe3b04f4836f1dc06fe124606223557feb50ca8e2)
  [93mdelegate 0xe3b04f4836f1dc06fe124606223557feb50ca8e2.0xfe7a0fb9 with:
       gas gas_remaining - 710 wei
...
def unknownd9a96852(addr m_param1, uint32 m_param2): # not payable
  require ext_code.size(0xe3b04f4836f1dc06fe124606223557feb50ca8e2)
  [93mdelegate 0xe3b04f4836f1dc06fe124606223557feb50ca8e2.0xa8b7983 with:
       gas gas_remaining - 710 wei
