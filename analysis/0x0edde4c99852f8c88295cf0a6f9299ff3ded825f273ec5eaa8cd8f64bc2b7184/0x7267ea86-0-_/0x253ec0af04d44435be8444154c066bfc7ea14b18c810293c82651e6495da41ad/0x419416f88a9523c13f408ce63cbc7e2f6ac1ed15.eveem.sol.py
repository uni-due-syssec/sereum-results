...
#  addr = 0x419416F88A9523C13f408CE63cbC7e2F6aC1ed15 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {'0xb1fd9e05': 'unknownb1fd9e05(?)', '0xf7a8c508': 'unknownf7a8c508(?)'} 
...
def storage:
    ...
    # storage address 22633765010811032616524777558989429671281496764437014791890801863487600440028455452742096010871977270
    stor22633765010811032616524777558989429671281496764437014791890801863487600440028455452742096010871977270
    # storage address 
...
def unknown09c5a317(uint256 m_param1, addr m_param2) payable: 
  ...
  if not mordersm[m_param1m]m.field_0:
      revert with 0, 'changeCollateral: loanOrder.loanTokenAddress == address(0)'
  if not mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_768:
      revert with 0, 'changeCollateral: loanPosition.loanTokenAmountFilled == 0 || !loanPosition.active'
  ...
  if block.timestamp >= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2048:
      revert with 0, 'changeCollateral: block.timestamp >= loanPosition.loanEndUnixTimestampSec'
  if not m_param2:
      revert with 0, 
                  'changeCollateral: collateralTokenFilled == address(0) || collateralTokenFilled == loanPosition.collateralTokenAddressFilled'
  ...
  if not mordersm[m_param1m]m.field_0:
      ...
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 <= 0:
          ...
          if not ext_call.return_data[0]:
              revert with 0, 'changeCollateral: OracleInterface.didChangeCollateral failed'
          mstor2 = 0
          mstor0 = 1
      ...
      if not mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280:
          ...
          if not 0 / ext_call.return_data[32]:
              revert with 0, 'changeCollateral: BZxVault.depositToken new collateral == 0'
          ...
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
              revert with 0, 'changeCollateral: BZxVault.depositToken new collateral failed'
          if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280 > 0:
              require ext_code.size(mvaultContractAddress)
              ...
              require return_data.size >=′ 32
              if not ext_call.return_data[0]:
                  revert with 0, 'changeCollateral: BZxVault.withdrawToken old collateral failed'
          mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 = m_param2
...
def unknown52cccdb3(uint256 m_param1, addr m_param2, uint256 m_param3) payable: 
  ...
  if not mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_2304:
      revert with 0, 'loanPosition.loanTokenAmountFilled == 0 || !loanPosition.active'
  if mordersm[m_param1m]m.field_0 != mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512:
      if caller != caller:
...
# const = None
# payable = True
def unknown99a8548a(uint256 m_param1, addr m_param2, addr m_param3, uint256 m_param4) payable: 
  ...
  if not mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2304:
      revert with 0, 'loanPosition.loanTokenAmountFilled == 0 || !loanPosition.active'
  if mordersm[m_param1m]m.field_0 != mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512:
      if m_param2 != caller:
          revert with 0, 'unauthorized'
  require ext_code.size(mvaultContractAddress)
  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256 == m_param3:
      call mvaultContractAddress.depositToken(address from, address token, uint256 amount) with:
           gas gas_remaining wei
          args addr(m_param3), caller, m_param4
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 32
      if not ext_call.return_data[0]:
          revert with 0, 'BZxVault.depositToken position failed'
      require m_param4 + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280
      mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 += m_param4
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      call moraclem[mstor10m[m_param1m]m.field_768m].0x33ac22b4 with:
           gas gas_remaining wei
          args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2560, m_param4, mstor2
  else:
      call mvaultContractAddress.transferTokenFrom(address tokenContract, address transferTo, address transferFrom, uint256 value) with:
           gas gas_remaining wei
          args addr(m_param3), caller, moraclem[mstor10m[m_param1m]m.field_768m], m_param4
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 32
      if not ext_call.return_data[0]:
      ...
      call moraclem[mstor10m[m_param1m]m.field_768m].0x4849b6c8 with:
           gas gas_remaining wei
          args addr(m_param3), mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, m_param4, -1
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 64
      if not ext_call.return_data[0]:
      ...
      if ext_call.return_data[32] < m_param4:
          require ext_call.return_data[32] <= m_param4
          require ext_code.size(mvaultContractAddress)
          call mvaultContractAddress.withdrawToken(address token, address to, uint256 value) with:
               gas gas_remaining wei
              args addr(m_param3), caller, m_param4 - ext_call.return_data[32]
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
              revert with 0, 'BZxVault.withdrawToken deposit failed'
      require ext_call.return_data[0] + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280
      mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280 += ext_call.return_data[0]
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      call moraclem[mstor10m[m_param1m]m.field_768m].0x33ac22b4 with:
           gas gas_remaining wei
          args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2560, ext_call.return_data[0], mstor2
  if not ext_call.success:
      revert with ext_call.return_data[0 len return_data.size]
  require return_data.size >=′ 32
  if not ext_call.return_data[0]:
...
def unknowna1e93482(uint256 m_param1, uint256 m_param2) payable: 
  ...
  if m_param2 < ext_call.return_data[96]:
      if m_param2 <= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1280:
          ...
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
              revert with 0, 'withdrawCollateral: BZxVault.withdrawToken collateral failed'
          ...
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
              revert with 0, 'withdrawCollateral: OracleInterface.didWithdrawCollateral failed'
          mstor2 = 0
          mstor0 = 1
          return m_param2
      if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536 > 0:
          if mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_256 == mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_512:
              ...
              require return_data.size >=′ 32
              if not ext_call.return_data[0]:
                  revert with 0, 'withdrawCollateral: BZxVault.withdrawToken (position) failed'
              require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
              call moraclem[mstor10m[m_param1m]m.field_768m].0x4849b6c8 with:
                   gas gas_remaining wei
...
# const = None
# payable = True
def unknownbab7d1a3(uint256 m_param1, addr m_param2, addr m_param3, uint256 m_param4) payable: 
  require calldata.size - 4 >=′ 128
  require 1 == mstor0
  mstor0 = 2
  mstor2 = gas_remaining + 21000
  ...
  if mordersm[m_param1m]m.field_0 != mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512:
      if m_param2 != caller:
          revert with 0, 'unauthorized'
  require ext_code.size(mvaultContractAddress)
  if mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512 == m_param3:
      call mvaultContractAddress.depositToken(address from, address token, uint256 amount) with:
           gas gas_remaining wei
          args addr(m_param3), caller, m_param4
      if not ext_call.success:
      ...
      if not ext_call.return_data[0]:
          revert with 0, 'BZxVault.depositToken position failed'
      require m_param4 + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536
      mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 += m_param4
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      call moraclem[mstor10m[m_param1m]m.field_768m].0xfd670cbd with:
           gas gas_remaining wei
          args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2560, m_param4, mstor2
      ...
      call moraclem[mstor10m[m_param1m]m.field_768m].0x4849b6c8 with:
           gas gas_remaining wei
          args addr(m_param3), mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512, m_param4, -1
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 64
      if not ext_call.return_data[0]:
      ...
      if ext_call.return_data[32] < m_param4:
          ...
          if not ext_call.return_data[0]:
              revert with 0, 'BZxVault.withdrawToken deposit failed'
      require ext_call.return_data[0] + mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 >= mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536
      mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536 += ext_call.return_data[0]
      require ext_code.size(moraclem[mstor10m[m_param1m]m.field_768m])
      call moraclem[mstor10m[m_param1m]m.field_768m].0xfd670cbd with:
           gas gas_remaining wei
          args mordersm[m_param1m]m.field_0, mordersm[m_param1m]m.field_256, mordersm[m_param1m]m.field_512, mordersm[m_param1m]m.field_768, mordersm[m_param1m]m.field_1024, mordersm[m_param1m]m.field_1280, mordersm[m_param1m]m.field_1536, mordersm[m_param1m]m.field_1792, mordersm[m_param1m]m.field_2048, mordersm[m_param1m]m.field_2304, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_0, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_256, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_512, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_768, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1024, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1280, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1536, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_1792, mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2048, bool(mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2304), mloanPositionsm[mstor16m[m_param1m]m[addr(m_param2)m]m]m.field_2560, ext_call.return_data[0], mstor2
...
def initialize(address m_sender) payable: 
  ...
  mstor39m[Mask(32, 224, ('name', 'stor2964', 22633765010811032616524777558989429671281496764437014791890801863487600440028455452742096010871977270))m] = m_sender
  mstor39m[Mask(32, 224, ('name', 'stor2964', 129215955555715725620020244269108767008651120148380956293515326643303427904161733263736194045240448676845477670197311821194978314666604319848150326))m] = m_sender
  ...
  mstor39m[Mask(32, 224, ('name', 'stor2977', 4801487210070163406695185129569382613135035780967894086459536802062928083825974))m] = m_sender
  ...
  mstor39m[Mask(32, 224, ('name', 'stor2964', 1971679009334041223483585458060883655714374740470832198349128243053021680524270936327331864041374659825331620859095085510606293073765233472822))m] = m_sender
  ...
  mstor39m[Mask(32, 224, ('name', 'stor2967', 459197264288443966516963788175909319903611140026771318354986139260599046041598712459817303624343299484576733920793245750082508305718))m] = m_sender
...
def unknowne53599c3(uint256 m_param1, uint256 m_param2) payable: 
  ...
  if m_param2 < ext_call.return_data[32]:
      if m_param2 <= mloanPositionsm[mstor16m[m_param1m]m[callerm]m]m.field_1536:
          ...
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
              revert with 0, 'withdrawPosition: BZxVault.withdrawToken loan failed'
          ...
          require return_data.size >=′ 32
          if not ext_call.return_data[0]:
              revert with 0, 'withdrawPosition: OracleInterface.didWithdrawPosition failed'
