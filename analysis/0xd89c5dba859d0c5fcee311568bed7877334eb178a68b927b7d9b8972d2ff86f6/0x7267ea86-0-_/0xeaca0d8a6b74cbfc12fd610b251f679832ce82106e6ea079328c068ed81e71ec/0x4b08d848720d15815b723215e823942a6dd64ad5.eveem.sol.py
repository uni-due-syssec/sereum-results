...
#  addr = 0x4b08d848720d15815b723215E823942a6Dd64AD5 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def initialize(address m_sender) payable: 
  ...
  mstor39m[Mask(32, 224, ('name', 'stor2963', 314077755436407835579166785924651578029017063492875439391122844475994613090633266486))m] = m_sender
  mstor39m[Mask(32, 224, ('name', 'storFE63', 9116240346629778611544642497426355420922274765357132336487647104597442812329491707313637076434203893183798))m] = m_sender
  mstor39m[Mask(32, 224, ('name', 'stor636C', 15302688835956636895082872600760033051118199715947966345941300693962120731031717322773901573417949012419731812136246))m] = m_sender
