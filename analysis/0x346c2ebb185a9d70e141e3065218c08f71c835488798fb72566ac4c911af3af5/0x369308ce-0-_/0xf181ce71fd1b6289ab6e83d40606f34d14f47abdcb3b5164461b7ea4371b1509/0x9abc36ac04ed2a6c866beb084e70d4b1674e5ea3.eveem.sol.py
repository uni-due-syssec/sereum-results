...
def unknown06599aa0(addr m_param1, addr m_param2, uint256 m_param3): # not payable
  ...
  if mdecimalsm[addr(m_param1)m]m.field_0:
      ...
      if mdecimalsm[addr(m_param1)m]m.field_0 >= 2:
          if not 10^(mdecimalsm[addr(m_param1)m]m.field_0 - 2):
              if m_param1 == m_param2:
                  return 0, 10^18, 0
              if mdecimalsm[addr(m_param1)m]m.field_0:
                  if mdecimalsm[addr(m_param2)m]m.field_0:
          ...
          if not 10^mdecimalsm[addr(m_param1)m]m.field_0:
              if m_param1 == m_param2:
                  return 0, 10^18, 0
              if mdecimalsm[addr(m_param1)m]m.field_0:
                  if mdecimalsm[addr(m_param2)m]m.field_0:
          ...
          if not return_data.size:
              if not ext_call.success:
                  ...
                  if mdecimalsm[addr(m_param1)m]m.field_0:
                      if mdecimalsm[addr(m_param2)m]m.field_0:
                          ...
                          if ext_call.return_data[31 len 1] < mdecimalsm[addr(m_param1)m]m.field_0:
                              if mdecimalsm[addr(m_param1)m]m.field_0 + -ext_call.return_data[31 len 1] + 18 >= 18:
                                  return mem[128], 10^(mdecimalsm[addr(m_param1)m]m.field_0 + -uint8(ext_call.return_data[0]) + 18), 0
                          else:
                              if ext_call.return_data[31 len 1] - mdecimalsm[addr(m_param1)m]m.field_0 <= 18:
                                  return mem[128], 10^(-uint8(ext_call.return_data[0]) + mdecimalsm[addr(m_param1)m]m.field_0 + 18), 0
                  else:
                      require ext_code.size(m_param1)
                      static call m_param1.decimals() with:
                              gas gas_remaining wei
                      ...
                      if mdecimalsm[addr(m_param2)m]m.field_0:
                          if mdecimalsm[addr(m_param2)m]m.field_0 < ext_call.return_data[31 len 1]:
                              if ext_call.return_data[31 len 1] + -mdecimalsm[addr(m_param2)m]m.field_0 + 18 >= 18:
                                  return mem[128], 10^(uint8(ext_call.return_data[0]) + -mdecimalsm[addr(m_param2)m]m.field_0 + 18), 0
                          else:
                              if mdecimalsm[addr(m_param2)m]m.field_0 - ext_call.return_data[31 len 1] <= 18:
                                  return mem[128], 10^(-mdecimalsm[addr(m_param2)m]m.field_0 + uint8(ext_call.return_data[0]) + 18), 0
                      else:
                          require ext_code.size(m_param2)
                          static call m_param2.decimals() with:
                                  gas gas_remaining wei
              ...
              if not ext_call.success:
                  ...
                  if mdecimalsm[addr(m_param1)m]m.field_0:
                      ...
                      if ext_call.return_data[31 len 1] < mdecimalsm[addr(m_param1)m]m.field_0:
                          if mdecimalsm[addr(m_param1)m]m.field_0 + -ext_call.return_data[31 len 1] + 18 >= 18:
                              return mem[ceil32(return_data.size) + 260], 10^(mdecimalsm[addr(m_param1)m]m.field_0 + -uint8(ext_call.return_data[0]) + 18), 0
                      else:
                          if ext_call.return_data[31 len 1] - mdecimalsm[addr(m_param1)m]m.field_0 <= 18:
                              return mem[ceil32(return_data.size) + 260], 10^(-uint8(ext_call.return_data[0]) + mdecimalsm[addr(m_param1)m]m.field_0 + 18), 0
                  else:
                      require ext_code.size(m_param1)
                      static call m_param1.decimals() with:
                              gas gas_remaining wei
                      ...
                      if mdecimalsm[addr(m_param2)m]m.field_0:
                          if mdecimalsm[addr(m_param2)m]m.field_0 < ext_call.return_data[31 len 1]:
                              if ext_call.return_data[31 len 1] + -mdecimalsm[addr(m_param2)m]m.field_0 + 18 >= 18:
                                  return mem[ceil32(return_data.size) + 260], 10^(uint8(ext_call.return_data[0]) + -mdecimalsm[addr(m_param2)m]m.field_0 + 18), 0
                          else:
                              if mdecimalsm[addr(m_param2)m]m.field_0 - ext_call.return_data[31 len 1] <= 18:
                                  return mem[ceil32(return_data.size) + 260], 10^(-mdecimalsm[addr(m_param2)m]m.field_0 + uint8(ext_call.return_data[0]) + 18), 0
                      else:
                          require ext_code.size(m_param2)
                          static call m_param2.decimals() with:
                                  gas gas_remaining wei
...
# const = None
# payable = False
def unknown4e8440a5(addr m_param1, addr m_param2, uint256 m_param3, uint256 m_param4): # not payable
  require calldata.size - 4 >=′ 128
  require caller == mowner
  if not m_param3:
      revert with 0, 'destTokenAmountReceived == 0'
  if m_param1 == m_param2:
      if 10000000000 * 10^18 < m_param3:
          if this.address == this.address:
              if this.address != this.address:
                  require ext_code.size(m_param2)
                  call m_param2.transfer(address to, uint256 value) with:
                       gas gas_remaining wei
                      args addr(this.address), m_param3
                  if not ext_call.success:
                      revert with ext_call.return_data[0 len return_data.size]
                  if return_data.size:
                      require return_data.size == 32
              ...
              if this.address != this.address:
                  ...
                  if this.address != this.address:
                      if 10000000000 * 10^18 < m_param3:
                          ...
                          call m_param1.transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args addr(this.address), m_param3 - 10000000000 * 10^18
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if return_data.size:
                              require return_data.size == 32
      ...
      return m_param3
  if munknown38a56582:
      mem[552] = mkyberContractAddress
      require ext_code.size(m_param1)
      static call m_param1.allowance(address owner, address spender) with:
              gas gas_remaining wei
             args addr(this.address), mkyberContractAddress
      if not ext_call.success:
          revert with ext_call.return_data[0 len return_data.size]
      require return_data.size >=′ 32
      if ext_call.return_data[0] < m_param3:
          ...
          call m_param1.approve(address spender, uint256 value) with:
               gas gas_remaining wei
              args mkyberContractAddress, 10000000000 * 10^18
          if not ext_call.success:
              revert with ext_call.return_data[0 len return_data.size]
          if return_data.size:
              require return_data.size == 32
...
def isTradeSupported(address m_sourceTokenAddress, address m_destTokenAddress, uint256 m_sourceTokenAmount): # not payable
  ...
  if m_sourceTokenAddress != m_destTokenAddress:
      ...
      if not return_data.size:
          if not ext_call.success:
              return 0
          if 0 == getExpectedRate(address srcToken, address destToken, uint256 srcTokenValue), addr(m_sourceTokenAddress) << 64:
              return 0
          if not 0, addr(m_destTokenAddress) << 64:
              return 0
      else:
          mem[260 len return_data.size] = ext_call.return_data[0 len return_data.size]
          if not ext_call.success:
