...
#  addr = 0x7C5c74DA7a30Fe304B2d1deaD1C0f718E132ED6c 
#  network = mainnet 
#  ver = 26 Apr 2019 
...
def unknown3c98d189(uint256 _param1, array _param2, array _param3, array _param4): # not payable
  ...
  if caller == owner:
      ...
      if not _param2.length:
          ...
          mem[(32 * _param4.length) + (32 * _param3.length) + (32 * _param2.length) + 224 len 32 * _param2.length] = code.data[24399 len 32 * _param2.length]
          mem[0] = 0x45786368616e676550726f7669646572000000000000000000000000000000
          mem[32] = 4
          mem[(32 * _param4.length) + (32 * _param3.length) + (64 * _param2.length) + 224] = 0x674f23ba00000000000000000000000000000000000000000000000000000000
          mem[(32 * _param4.length) + (32 * _param3.length) + (64 * _param2.length) + 228] = 32
...
def tokensWithAmount(): # not payable
  ...
  while [94midx < tokens.length:
      ...
      continue 
  if [94ms:
      mem[128 len 32 * [94ms] = code.data[24399 len 32 * [94ms]
  [94midx = 0
  [94mt = 0
  while [94midx < tokens.length:
      mem[0] = addr(tokens[[94midx].field_0)
          ...
          if unknown07b08870.length != 0:
              ...
              if not unknown07b08870.length:
                  ...
                  while [94midx < unknown07b08870.length:
                      ...
                      require [94midx < mem[[94m_510 + 96]
                      if 0 == mem[(32 * [94midx) + [94m_510 + 128]:
                          [94midx = [94midx + 1
                          continue 
                      ...
                      mem[0] = 22
                      require [94midx < mem[[94m_510 + 96]
                      [94m_998 = mem[(32 * [94midx) + [94m_510 + 128]
                      ...
                      mem[ceil32(return_data.size) + 132] = [94m_998
                      ...
                      require unknown07b08870.length - 1 < mem[[94m_510 + 96]
                      require [94midx < mem[[94m_510 + 96]
                      mem[[94m_510 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_510 + 128]
                      require unknown07b08870.length - 1 < unknown07b08870.length
                      mem[0] = 22
                  ...
                  if not stor18.length:
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                              require [94midx < stor18.length
                              [94m_1356 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                              require ext_code.size(addr([94m_1356))
                              call addr([94m_1356).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              ...
                              mem[0] = addr([94m_1356)
                              mem[32] = 20
                              amounts[addr([94m_1356)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_1356)
                                  mem[32] = 21
                                  if not stor21[addr([94m_1356)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_1356)
                                      mem[0] = addr([94m_1356)
                                      mem[32] = 21
                                      stor21[addr([94m_1356)] = 1
                          [94midx = [94midx + 1
                          continue 
                  else:
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                              require [94midx < stor18.length
                              [94m_2145 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                              require ext_code.size(addr([94m_2145))
                              call addr([94m_2145).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                              if not ext_call.success:
                              ...
                              mem[0] = addr([94m_2145)
                              mem[32] = 20
                              amounts[addr([94m_2145)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_2145)
                                  mem[32] = 21
                                  if not stor21[addr([94m_2145)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_2145)
                                      mem[0] = addr([94m_2145)
                                      mem[32] = 21
                                      stor21[addr([94m_2145)] = 1
                          [94midx = [94midx + 1
                          continue 
              else:
                  mem[0] = 22
                  ...
                  while [94midx < unknown07b08870.length:
                      ...
                      mem[0] = 18
                      addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                      require [94midx < mem[[94m_1344 + 96]
                      if 0 == mem[(32 * [94midx) + [94m_1344 + 128]:
                          [94midx = [94midx + 1
                          continue 
                      require [94midx < unknown07b08870.length
                      mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                      ...
                      mem[0] = 22
                      require [94midx < mem[[94m_1344 + 96]
                      [94m_1741 = mem[(32 * [94midx) + [94m_1344 + 128]
                      mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                      mem[ceil32(return_data.size) + 100] = caller
                      mem[ceil32(return_data.size) + 132] = [94m_1741
                      require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                      call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                           gas gas_remaining wei
                          args caller, [94m_1741
                      if not ext_call.success:
                          revert with ext_call.return_data[0 len return_data.size]
                      if ext_call.return_data[0]:
                          [94midx = [94midx + 1
                      ...
                      require [94midx < unknown07b08870.length
                      addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                      require unknown07b08870.length - 1 < mem[[94m_1344 + 96]
                      require [94midx < mem[[94m_1344 + 96]
                      mem[[94m_1344 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1344 + 128]
                      require unknown07b08870.length - 1 < unknown07b08870.length
                      mem[0] = 22
                      addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                      unknown07b08870.length--
                  ...
                  if not stor18.length:
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                              require [94midx < stor18.length
                              [94m_2149 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                              require ext_code.size(addr([94m_2149))
                              call addr([94m_2149).balanceOf(address owner) with:
                                   gas gas_remaining wei
                                  args this.address
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                              if not ext_call.success:
                              ...
                              mem[0] = addr([94m_2149)
                              mem[32] = 20
                              amounts[addr([94m_2149)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_2149)
                                  mem[32] = 21
                                  if not stor21[addr([94m_2149)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_2149)
                                      mem[0] = addr([94m_2149)
                                      mem[32] = 21
                                      stor21[addr([94m_2149)] = 1
                          [94midx = [94midx + 1
                          continue 
                  else:
                      mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                      ...
                      while [94midx < stor18.length:
                          ...
                          if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                              require [94midx < stor18.length
                              [94m_3022 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                              mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                              ...
                              mem[0] = addr([94m_3022)
                              mem[32] = 20
                              amounts[addr([94m_3022)] = ext_call.return_data[0]
                              if 0 < ext_call.return_data[0]:
                                  mem[0] = addr([94m_3022)
                                  mem[32] = 21
                                  if not stor21[addr([94m_3022)]:
                                      tokens.length++
                                      addr(tokens[tokens.length].field_0) = addr([94m_3022)
                                      mem[0] = addr([94m_3022)
                                      mem[32] = 21
                                      stor21[addr([94m_3022)] = 1
                          [94midx = [94midx + 1
                          continue 
              stor18.length = 0
              [94midx = 0
              ...
              if unknown07b08870.length != 0:
                  ...
                  if not unknown07b08870.length:
                      ...
                      while [94midx < unknown07b08870.length:
                          ...
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1030 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1030 + 128]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1030 + 96]
                          [94m_1412 = mem[(32 * [94midx) + [94m_1030 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          mem[ceil32(return_data.size) + 132] = [94m_1412
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_1412
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          require [94midx < unknown07b08870.length
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1030 + 96]
                          require [94midx < mem[[94m_1030 + 96]
                          mem[[94m_1030 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1030 + 128]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      if not stor18.length:
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_1674 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_1674))
                                  call addr([94m_1674).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_1674)
                                  mem[32] = 20
                                  amounts[addr([94m_1674)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_1674)
                                      mem[32] = 21
                                      if not stor21[addr([94m_1674)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_1674)
                                          mem[0] = addr([94m_1674)
                                          mem[32] = 21
                                          stor21[addr([94m_1674)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_2635 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_2635))
                                  call addr([94m_2635).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2635)
                                  mem[32] = 20
                                  amounts[addr([94m_2635)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2635)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2635)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2635)
                                          mem[0] = addr([94m_2635)
                                          mem[32] = 21
                                          stor21[addr([94m_2635)] = 1
                              [94midx = [94midx + 1
                              continue 
                  else:
                      mem[0] = 22
                      ...
                      while [94midx < unknown07b08870.length:
                          ...
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1666 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1666 + 128]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1666 + 96]
                          [94m_2225 = mem[(32 * [94midx) + [94m_1666 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          mem[ceil32(return_data.size) + 132] = [94m_2225
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_2225
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          require [94midx < unknown07b08870.length
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1666 + 96]
                          require [94midx < mem[[94m_1666 + 96]
                          mem[[94m_1666 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1666 + 128]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      if not stor18.length:
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_2639 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  ...
                                  mem[0] = addr([94m_2639)
                                  mem[32] = 20
                                  amounts[addr([94m_2639)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2639)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2639)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2639)
                                          mem[0] = addr([94m_2639)
                                          mem[32] = 21
                                          stor21[addr([94m_2639)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_3429 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_3429))
                                  call addr([94m_3429).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_3429)
                                  mem[32] = 20
                                  amounts[addr([94m_3429)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_3429)
                                      mem[32] = 21
                                      if not stor21[addr([94m_3429)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_3429)
                                          mem[0] = addr([94m_3429)
                                          mem[32] = 21
                                          stor21[addr([94m_3429)] = 1
                              [94midx = [94midx + 1
                              continue 
                  stor18.length = 0
                  [94midx = 0
              ...
              if unknown07b08870.length != 0:
                  ...
                  if not unknown07b08870.length:
                      ...
                      while [94midx < unknown07b08870.length:
                          ...
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1029 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1029 + 128]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1029 + 96]
                          [94m_1410 = mem[(32 * [94midx) + [94m_1029 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          ...
                          require [94midx < unknown07b08870.length
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1029 + 96]
                          require [94midx < mem[[94m_1029 + 96]
                          mem[[94m_1029 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1029 + 128]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      if not stor18.length:
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_1670 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_1670))
                                  call addr([94m_1670).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_1670)
                                  mem[32] = 20
                                  amounts[addr([94m_1670)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_1670)
                                      mem[32] = 21
                                      if not stor21[addr([94m_1670)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_1670)
                                          mem[0] = addr([94m_1670)
                                          mem[32] = 21
                                          stor21[addr([94m_1670)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_2623 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_2623))
                                  call addr([94m_2623).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2623)
                                  mem[32] = 20
                                  amounts[addr([94m_2623)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2623)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2623)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2623)
                                          mem[0] = addr([94m_2623)
                                          mem[32] = 21
                                          stor21[addr([94m_2623)] = 1
                              [94midx = [94midx + 1
                              continue 
                  else:
                      mem[0] = 22
                      ...
                      while [94midx < unknown07b08870.length:
                          ...
                          mem[0] = 18
                          addr(stor18[stor18.length].field_0) = addr(unknown07b08870[[94midx].field_0)
                          require [94midx < mem[[94m_1664 + 96]
                          if 0 == mem[(32 * [94midx) + [94m_1664 + 128]:
                              [94midx = [94midx + 1
                              continue 
                          require [94midx < unknown07b08870.length
                          mem[ceil32(return_data.size) + 100] = addr(unknown07b08870[[94midx].field_0)
                          ...
                          mem[0] = 22
                          require [94midx < mem[[94m_1664 + 96]
                          [94m_2221 = mem[(32 * [94midx) + [94m_1664 + 128]
                          mem[ceil32(return_data.size) + 96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                          mem[ceil32(return_data.size) + 100] = caller
                          mem[ceil32(return_data.size) + 132] = [94m_2221
                          require ext_code.size(addr(unknown07b08870[[94midx].field_0))
                          call addr(unknown07b08870[[94midx].field_0).transfer(address to, uint256 value) with:
                               gas gas_remaining wei
                              args caller, [94m_2221
                          if not ext_call.success:
                              revert with ext_call.return_data[0 len return_data.size]
                          if ext_call.return_data[0]:
                              [94midx = [94midx + 1
                          ...
                          require [94midx < unknown07b08870.length
                          addr(unknown07b08870[[94midx].field_0) = addr(unknown07b08870[unknown07b08870.length].field_0)
                          require unknown07b08870.length - 1 < mem[[94m_1664 + 96]
                          require [94midx < mem[[94m_1664 + 96]
                          mem[[94m_1664 + (32 * [94midx) + 128] = mem[(32 * unknown07b08870.length - 1) + [94m_1664 + 128]
                          require unknown07b08870.length - 1 < unknown07b08870.length
                          mem[0] = 22
                          addr(unknown07b08870[unknown07b08870.length].field_0) = 0
                          unknown07b08870.length--
                      ...
                      if not stor18.length:
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_2627 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_2627))
                                  call addr([94m_2627).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_2627)
                                  mem[32] = 20
                                  amounts[addr([94m_2627)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_2627)
                                      mem[32] = 21
                                      if not stor21[addr([94m_2627)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_2627)
                                          mem[0] = addr([94m_2627)
                                          mem[32] = 21
                                          stor21[addr([94m_2627)] = 1
                              [94midx = [94midx + 1
                              continue 
                      else:
                          mem[ceil32(return_data.size) + 128] = addr(stor18.field_0)
                          ...
                          while [94midx < stor18.length:
                              ...
                              if mem[(32 * [94midx) + ceil32(return_data.size) + 140 len 20]:
                                  require [94midx < stor18.length
                                  [94m_3417 = mem[ceil32(return_data.size) + (32 * [94midx) + 128]
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 132] = this.address
                                  require ext_code.size(addr([94m_3417))
                                  call addr([94m_3417).balanceOf(address owner) with:
                                       gas gas_remaining wei
                                      args this.address
                                  mem[ceil32(return_data.size) + (32 * stor18.length) + 128] = ext_call.return_data[0]
                                  if not ext_call.success:
                                  ...
                                  mem[0] = addr([94m_3417)
                                  mem[32] = 20
                                  amounts[addr([94m_3417)] = ext_call.return_data[0]
                                  if 0 < ext_call.return_data[0]:
                                      mem[0] = addr([94m_3417)
                                      mem[32] = 21
                                      if not stor21[addr([94m_3417)]:
                                          tokens.length++
                                          addr(tokens[tokens.length].field_0) = addr([94m_3417)
                                          mem[0] = addr([94m_3417)
                                          mem[32] = 21
                                          stor21[addr([94m_3417)] = 1
                              [94midx = [94midx + 1
                              continue 
                  stor18.length = 0
                  [94midx = 0
