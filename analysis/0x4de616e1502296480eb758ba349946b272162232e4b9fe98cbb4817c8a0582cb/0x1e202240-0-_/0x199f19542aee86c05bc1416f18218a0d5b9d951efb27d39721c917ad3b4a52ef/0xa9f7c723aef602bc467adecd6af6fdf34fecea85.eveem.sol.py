...
#  addr = 0xA9F7C723aeF602BC467AdECd6Af6fdf34feCea85 
#  network = mainnet 
#  ver = 26 Apr 2019 
#  problems = {'0x1e202240': 'unknown1e202240(?)'} 
...
def storage:
    ...
    # storage address 40
    stor40
    # storage address 139121987409942702158277237958732081445263841141218374590311197251856903001578308805654081630704383286
    stor139121987409942702158277237958732081445263841141218374590311197251856903001578308805654081630704383286
# hash = 0x093983bd
...
def initialize(address m_sender) payable: 
  ...
  mstor39m[Mask(32, 224, ('name', 'storFE6C', 139121987409942702158277237958732081445263841141218374590311197251856903001578308805654081630704383286))m] = m_sender
